...
namespace dbtoaster {
  ...
  struct QUERY3_entry {
    long ORDERS_ORDERKEY; date ORDERS_ORDERDATE; long ORDERS_SHIPPRIORITY; DOUBLE_TYPE __av;  QUERY3_entry* nxt; QUERY3_entry* prv;
    explicit QUERY3_entry() : nxt(nullptr), prv(nullptr) { /*ORDERS_ORDERKEY = 0L; ORDERS_ORDERDATE = 00000000; ORDERS_SHIPPRIORITY = 0L; __av = 0.0; */ }
    ...
    QUERY3_entry(const QUERY3_entry& other) : ORDERS_ORDERKEY( other.ORDERS_ORDERKEY ), ORDERS_ORDERDATE( other.ORDERS_ORDERDATE ), ORDERS_SHIPPRIORITY( other.ORDERS_SHIPPRIORITY ), __av( other.__av ), nxt( nullptr ), prv( nullptr ) {}
  ...
  struct QUERY3_mLINEITEM1_entry {
    long QUERY3_mLINEITEMLINEITEM_ORDERKEY; date ORDERS_ORDERDATE; long ORDERS_SHIPPRIORITY; long __av;  QUERY3_mLINEITEM1_entry* nxt; QUERY3_mLINEITEM1_entry* prv;
    explicit QUERY3_mLINEITEM1_entry() : nxt(nullptr), prv(nullptr) { /*QUERY3_mLINEITEMLINEITEM_ORDERKEY = 0L; ORDERS_ORDERDATE = 00000000; ORDERS_SHIPPRIORITY = 0L; __av = 0L; */ }
    ...
    QUERY3_mLINEITEM1_entry(const QUERY3_mLINEITEM1_entry& other) : QUERY3_mLINEITEMLINEITEM_ORDERKEY( other.QUERY3_mLINEITEMLINEITEM_ORDERKEY ), ORDERS_ORDERDATE( other.ORDERS_ORDERDATE ), ORDERS_SHIPPRIORITY( other.ORDERS_SHIPPRIORITY ), __av( other.__av ), nxt( nullptr ), prv( nullptr ) {}
  ...
  struct QUERY3_mLINEITEM1_mCUSTOMER2_entry {
    long QUERY3_mLINEITEMLINEITEM_ORDERKEY; long QUERY3_mLINEITEM1_mCUSTOMERCUSTOMER_CUSTKEY; date ORDERS_ORDERDATE; long ORDERS_SHIPPRIORITY; long __av;  QUERY3_mLINEITEM1_mCUSTOMER2_entry* nxt; QUERY3_mLINEITEM1_mCUSTOMER2_entry* prv;
    explicit QUERY3_mLINEITEM1_mCUSTOMER2_entry() : nxt(nullptr), prv(nullptr) { /*QUERY3_mLINEITEMLINEITEM_ORDERKEY = 0L; QUERY3_mLINEITEM1_mCUSTOMERCUSTOMER_CUSTKEY = 0L; ORDERS_ORDERDATE = 00000000; ORDERS_SHIPPRIORITY = 0L; __av = 0L; */ }
  ...
  struct QUERY3_mORDERS1_entry {
    long QUERY3_mORDERSORDERS_CUSTKEY; long __av;  QUERY3_mORDERS1_entry* nxt; QUERY3_mORDERS1_entry* prv;
    explicit QUERY3_mORDERS1_entry() : nxt(nullptr), prv(nullptr) { /*QUERY3_mORDERSORDERS_CUSTKEY = 0L; __av = 0L; */ }
    explicit QUERY3_mORDERS1_entry(const long c0, const long c1) { QUERY3_mORDERSORDERS_CUSTKEY = c0; __av = c1; }
    QUERY3_mORDERS1_entry(const QUERY3_mORDERS1_entry& other) : QUERY3_mORDERSORDERS_CUSTKEY( other.QUERY3_mORDERSORDERS_CUSTKEY ), __av( other.__av ), nxt( nullptr ), prv( nullptr ) {}
  ...
  struct QUERY3_mORDERS3_entry {
    long QUERY3_mORDERSORDERS_ORDERKEY; DOUBLE_TYPE __av;  QUERY3_mORDERS3_entry* nxt; QUERY3_mORDERS3_entry* prv;
    explicit QUERY3_mORDERS3_entry() : nxt(nullptr), prv(nullptr) { /*QUERY3_mORDERSORDERS_ORDERKEY = 0L; __av = 0.0; */ }
    explicit QUERY3_mORDERS3_entry(const long c0, const DOUBLE_TYPE c1) { QUERY3_mORDERSORDERS_ORDERKEY = c0; __av = c1; }
    QUERY3_mORDERS3_entry(const QUERY3_mORDERS3_entry& other) : QUERY3_mORDERSORDERS_ORDERKEY( other.QUERY3_mORDERSORDERS_ORDERKEY ), __av( other.__av ), nxt( nullptr ), prv( nullptr ) {}
  ...
  struct QUERY3_mCUSTOMER2_entry {
    long ORDERS_ORDERKEY; long QUERY3_mCUSTOMERCUSTOMER_CUSTKEY; date ORDERS_ORDERDATE; long ORDERS_SHIPPRIORITY; DOUBLE_TYPE __av;  QUERY3_mCUSTOMER2_entry* nxt; QUERY3_mCUSTOMER2_entry* prv;
    explicit QUERY3_mCUSTOMER2_entry() : nxt(nullptr), prv(nullptr) { /*ORDERS_ORDERKEY = 0L; QUERY3_mCUSTOMERCUSTOMER_CUSTKEY = 0L; ORDERS_ORDERDATE = 00000000; ORDERS_SHIPPRIORITY = 0L; __av = 0.0; */ }
    ...
    QUERY3_mCUSTOMER2_entry(const QUERY3_mCUSTOMER2_entry& other) : ORDERS_ORDERKEY( other.ORDERS_ORDERKEY ), QUERY3_mCUSTOMERCUSTOMER_CUSTKEY( other.QUERY3_mCUSTOMERCUSTOMER_CUSTKEY ), ORDERS_ORDERDATE( other.ORDERS_ORDERDATE ), ORDERS_SHIPPRIORITY( other.ORDERS_SHIPPRIORITY ), __av( other.__av ), nxt( nullptr ), prv( nullptr ) {}
    ...
    void on_insert_LINEITEM(const long lineitem_orderkey, const long lineitem_partkey, const long lineitem_suppkey, const long lineitem_linenumber, const DOUBLE_TYPE lineitem_quantity, const DOUBLE_TYPE lineitem_extendedprice, const DOUBLE_TYPE lineitem_discount, const DOUBLE_TYPE lineitem_tax, const STRING_TYPE& lineitem_returnflag, const STRING_TYPE& lineitem_linestatus, const date lineitem_shipdate, const date lineitem_commitdate, const date lineitem_receiptdate, const STRING_TYPE& lineitem_shipinstruct, const STRING_TYPE& lineitem_shipmode, const STRING_TYPE& lineitem_comment) {
      ...
      {  ++tN;
        { //slice
          ...
          HashIndex_QUERY3_mLINEITEM1_map_0::IdxNode* n1 = &(i1->buckets_[h1 & i1->index_mask_]);
          QUERY3_mLINEITEM1_entry* e1;
          do if ((e1=n1->obj) && h1 == n1->hash && QUERY3_mLINEITEM1_mapkey0_idxfn::equals(se2, *e1)) {
        ...
        { //slice
          ...
          HashIndex_QUERY3_mLINEITEM1_mCUSTOMER2_map_0::IdxNode* n2 = &(i2->buckets_[h2 & i2->index_mask_]);
          QUERY3_mLINEITEM1_mCUSTOMER2_entry* e2;
          do if ((e2=n2->obj) && h2 == n2->hash && QUERY3_mLINEITEM1_mCUSTOMER2_mapkey0_idxfn::equals(se5, *e2)) {
    ...
    void on_insert_CUSTOMER(const long customer_custkey, const STRING_TYPE& customer_name, const STRING_TYPE& customer_address, const long customer_nationkey, const STRING_TYPE& customer_phone, const DOUBLE_TYPE customer_acctbal, const STRING_TYPE& customer_mktsegment, const STRING_TYPE& customer_comment) {
      ...
      {  ++tN;
        { //slice
          ...
          HashIndex_QUERY3_mCUSTOMER2_map_1::IdxNode* n5 = &(i5->buckets_[h5 & i5->index_mask_]);
          QUERY3_mCUSTOMER2_entry* e5;
          do if ((e5=n5->obj) && h5 == n5->hash && QUERY3_mCUSTOMER2_mapkey1_idxfn::equals(se28, *e5)) {
        ...
        { //slice
          ...
          HashIndex_QUERY3_mLINEITEM1_mCUSTOMER2_map_1::IdxNode* n6 = &(i6->buckets_[h6 & i6->index_mask_]);
          QUERY3_mLINEITEM1_mCUSTOMER2_entry* e6;
          do if ((e6=n6->obj) && h6 == n6->hash && QUERY3_mLINEITEM1_mCUSTOMER2_mapkey1_idxfn::equals(se30, *e6)) {
