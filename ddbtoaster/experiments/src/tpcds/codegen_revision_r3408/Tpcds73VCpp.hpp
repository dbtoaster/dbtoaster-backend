...
namespace dbtoaster {
  ...
  struct COUNTCUSTOMER1_E1_1_entry {
    long COUNTCUSTOMERCUSTOMER_C_CUSTOMER_SK; long DJ_SS_TICKET_NUMBER; long __av; 
    explicit COUNTCUSTOMER1_E1_1_entry() { /*COUNTCUSTOMERCUSTOMER_C_CUSTOMER_SK = 0L; DJ_SS_TICKET_NUMBER = 0L; __av = 0L; */ }
    explicit COUNTCUSTOMER1_E1_1_entry(const long c0, const long c1, const long c2) { COUNTCUSTOMERCUSTOMER_C_CUSTOMER_SK = c0; DJ_SS_TICKET_NUMBER = c1; __av = c2; }
    COUNTCUSTOMER1_E1_1_entry(const COUNTCUSTOMER1_E1_1_entry& other) : COUNTCUSTOMERCUSTOMER_C_CUSTOMER_SK( other.COUNTCUSTOMERCUSTOMER_C_CUSTOMER_SK ), DJ_SS_TICKET_NUMBER( other.DJ_SS_TICKET_NUMBER ), __av( other.__av ) {}
    FORCE_INLINE COUNTCUSTOMER1_E1_1_entry& modify(const long c0, const long c1) { COUNTCUSTOMERCUSTOMER_C_CUSTOMER_SK = c0; DJ_SS_TICKET_NUMBER = c1;  return *this; }
  ...
  struct COUNTCUSTOMER1_E1_1_mapkey01_idxfn {
    ...
    FORCE_INLINE static bool equals(const COUNTCUSTOMER1_E1_1_entry& x, const COUNTCUSTOMER1_E1_1_entry& y) {
      return x.COUNTCUSTOMERCUSTOMER_C_CUSTOMER_SK == y.COUNTCUSTOMERCUSTOMER_C_CUSTOMER_SK && x.DJ_SS_TICKET_NUMBER == y.DJ_SS_TICKET_NUMBER;
    }
  };
  ...
  struct COUNTCUSTOMER1_E1_1STORE2_entry {
    long COUNTCUSTOMERCUSTOMER_C_CUSTOMER_SK; long COUNTCUSTOMER1_E1_1STORESTORE_S_STORE_SK; long DJ_SS_TICKET_NUMBER; long __av; 
    explicit COUNTCUSTOMER1_E1_1STORE2_entry() { /*COUNTCUSTOMERCUSTOMER_C_CUSTOMER_SK = 0L; COUNTCUSTOMER1_E1_1STORESTORE_S_STORE_SK = 0L; DJ_SS_TICKET_NUMBER = 0L; __av = 0L; */ }
    explicit COUNTCUSTOMER1_E1_1STORE2_entry(const long c0, const long c1, const long c2, const long c3) { COUNTCUSTOMERCUSTOMER_C_CUSTOMER_SK = c0; COUNTCUSTOMER1_E1_1STORESTORE_S_STORE_SK = c1; DJ_SS_TICKET_NUMBER = c2; __av = c3; }
    COUNTCUSTOMER1_E1_1STORE2_entry(const COUNTCUSTOMER1_E1_1STORE2_entry& other) : COUNTCUSTOMERCUSTOMER_C_CUSTOMER_SK( other.COUNTCUSTOMERCUSTOMER_C_CUSTOMER_SK ), COUNTCUSTOMER1_E1_1STORESTORE_S_STORE_SK( other.COUNTCUSTOMER1_E1_1STORESTORE_S_STORE_SK ), DJ_SS_TICKET_NUMBER( other.DJ_SS_TICKET_NUMBER ), __av( other.__av ) {}
    FORCE_INLINE COUNTCUSTOMER1_E1_1STORE2_entry& modify(const long c0, const long c1, const long c2) { COUNTCUSTOMERCUSTOMER_C_CUSTOMER_SK = c0; COUNTCUSTOMER1_E1_1STORESTORE_S_STORE_SK = c1; DJ_SS_TICKET_NUMBER = c2;  return *this; }
  ...
  struct COUNTCUSTOMER1_E1_1STORE2_mapkey012_idxfn {
    ...
    FORCE_INLINE static bool equals(const COUNTCUSTOMER1_E1_1STORE2_entry& x, const COUNTCUSTOMER1_E1_1STORE2_entry& y) {
      return x.COUNTCUSTOMERCUSTOMER_C_CUSTOMER_SK == y.COUNTCUSTOMERCUSTOMER_C_CUSTOMER_SK && x.COUNTCUSTOMER1_E1_1STORESTORE_S_STORE_SK == y.COUNTCUSTOMER1_E1_1STORESTORE_S_STORE_SK && x.DJ_SS_TICKET_NUMBER == y.DJ_SS_TICKET_NUMBER;
    }
  };
  ...
  struct data_t : tlq_t{
        ...
        { //slice 
              ...
              { //slice 
                ...
                if (n2 && (e2 = n2->obj)) {
                  do {                
                    ...
                    long v3 = e2->__av;
                    (/*if */(5L >= l1 && l1 >= 1L) ? _c1.addOrDelOnZero(st1.modify(l1,customer_c_salutation,customer_c_first_name,customer_c_last_name,customer_c_preferred_cust_flag,(((v2 != 0 ? 1L : 0L) * v3) * -1L)), (((v2 != 0 ? 1L : 0L) * v3) * -1L)) : (void)0);
                    n2 = n2->nxt;
          ...
          for (size_t i = 0; i < i4->size_; i++)
          {
            ...
            while (n4 && (e4 = n4->obj))
            {
              ...
              long v5 = e4->__av; 
            COUNT.addOrDelOnZero(se1.modify(customer_c_last_name,customer_c_first_name,customer_c_salutation,customer_c_preferred_cust_flag,store_sales_ss_ticket_number,dj_cnt),v5);      
              n4 = n4->nxt;
            }
          }
    ...
    void on_insert_CUSTOMER(const long customer_c_customer_sk, const STRING_TYPE& customer_c_customer_id, const long customer_c_current_cdemo_sk, const long customer_c_current_hdemo_sk, const long customer_c_current_addr_sk, const long customer_c_first_shipto_date_sk, const long customer_c_first_sales_date_sk, const STRING_TYPE& customer_c_salutation, const STRING_TYPE& customer_c_first_name, const STRING_TYPE& customer_c_last_name, const STRING_TYPE& customer_c_preferred_cust_flag, const long customer_c_birth_day, const long customer_c_birth_month, const long customer_c_birth_year, const STRING_TYPE& customer_c_birth_country, const STRING_TYPE& customer_c_login, const STRING_TYPE& customer_c_email_address, const STRING_TYPE& customer_c_last_review_date) {
      {  if (tS>0) { ++tS; return; } if ((tN&127)==0) { gettimeofday(&(t),NULL); tT=((t).tv_sec-(t0).tv_sec)*1000000L+((t).tv_usec-(t0).tv_usec); if (tT>3600000000L) { tS=1; return; } } ++tN;
        { //slice 
          ...
          if (n5 && (e5 = n5->obj)) {
            do {                
              long dj_ss_ticket_number = e5->DJ_SS_TICKET_NUMBER;
              long v6 = e5->__av;
              long l3 = COUNTCUSTOMER1_E1_1.getValueOrDefault(se21.modify(customer_c_customer_sk,dj_ss_ticket_number));
              (/*if */(l3 >= 1L && 5L >= l3) ? COUNT.addOrDelOnZero(se20.modify(customer_c_last_name,customer_c_first_name,customer_c_salutation,customer_c_preferred_cust_flag,dj_ss_ticket_number,l3),(v6 != 0 ? 1L : 0L)) : (void)0);
              n5 = n5->nxt;
    ...
    void on_insert_STORE(const long store_s_store_sk, const STRING_TYPE& store_s_store_id, const date store_s_rec_start_date, const date store_s_rec_end_date, const long store_s_closed_date_sk, const STRING_TYPE& store_s_store_name, const long store_s_number_employees, const long store_s_floor_space, const STRING_TYPE& store_s_hours, const STRING_TYPE& store_s_manager, const long store_s_market_id, const STRING_TYPE& store_s_geography_class, const STRING_TYPE& store_s_market_desc, const STRING_TYPE& store_s_market_manager, const long store_s_division_id, const STRING_TYPE& store_s_division_name, const long store_s_company_id, const STRING_TYPE& store_s_company_name, const STRING_TYPE& store_s_street_number, const STRING_TYPE& store_s_street_name, const STRING_TYPE& store_s_street_type, const STRING_TYPE& store_s_suite_number, const STRING_TYPE& store_s_city, const STRING_TYPE& store_s_county, const STRING_TYPE& store_s_state, const STRING_TYPE& store_s_zip, const STRING_TYPE& store_s_country, const DOUBLE_TYPE store_s_gmt_offset, const DOUBLE_TYPE store_s_tax_precentage) {
      {  if (tS>0) { ++tS; return; } if ((tN&127)==0) { gettimeofday(&(t),NULL); tT=((t).tv_sec-(t0).tv_sec)*1000000L+((t).tv_usec-(t0).tv_usec); if (tT>3600000000L) { tS=1; return; } } ++tN;
        (/*if */(((store_s_county == c1) || (store_s_county == c2) || (store_s_county == c3) || (store_s_county == c4))) ? COUNTSTORE_SALES3_L1_4.addOrDelOnZero(se24.modify(store_s_store_sk),1L) : (void)0);
        { //slice 
          ...
          if (n6 && (e6 = n6->obj)) {
            do {                
              ...
              long dj_ss_ticket_number = e6->DJ_SS_TICKET_NUMBER;
              long v7 = e6->__av;
              (/*if */(((store_s_county == c1) || (store_s_county == c2) || (store_s_county == c3) || (store_s_county == c4))) ? COUNTCUSTOMER1_E1_1.addOrDelOnZero(se25.modify(countcustomercustomer_c_customer_sk,dj_ss_ticket_number),v7) : (void)0);
              n6 = n6->nxt;
          ...
          for (size_t i = 0; i < i7->size_; i++)
          {
            ...
            while (n7 && (e7 = n7->obj))
            {
                ...
                { //slice 
                  ...
                  if (n8 && (e8 = n8->obj)) {
                    do {                
                      long dj_ss_ticket_number = e8->DJ_SS_TICKET_NUMBER;
                      long v9 = e8->__av;
                      long l4 = COUNTCUSTOMER1_E1_1.getValueOrDefault(se28.modify(customer_c_customer_sk,dj_ss_ticket_number));
                      (/*if */(5L >= l4 && l4 >= 1L) ? COUNT.addOrDelOnZero(se27.modify(customer_c_last_name,customer_c_first_name,customer_c_salutation,customer_c_preferred_cust_flag,dj_ss_ticket_number,l4),(v8 * (v9 != 0 ? 1L : 0L))) : (void)0);
                      n8 = n8->nxt;
        ...
        {  // foreach
          ...
          for (size_t i = 0; i < i9->size_; i++)
          {
            ...
            while (n9 && (e9 = n9->obj))
            {
                ...
                long v10 = e9->__av;
                (/*if */(date_dim_d_dom >= 1L && 2L >= date_dim_d_dom && ((date_dim_d_year == 1998L) || (date_dim_d_year == 1999L) || (date_dim_d_year == 2000L))) ? COUNTSTORE_SALES3_L1_3.addOrDelOnZero(se30.modify(countstore_salesstore_sales_ss_sold_date_sk),v10) : (void)0);
              n9 = n9->nxt;
            }
          }
        ...
        {  // foreach
          ...
          for (size_t i = 0; i < i10->size_; i++)
          {
            ...
            while (n10 && (e10 = n10->obj))
            {
                ...
                (/*if */(household_demographics_hd_vehicle_count > 0L && l5 > 0L && l6 > 1L) ? COUNTSTORE_SALES3_L1_5.addOrDelOnZero(se31.modify(countstore_salesstore_sales_ss_hdemo_sk),v11) : (void)0);
              n10 = n10->nxt;
            }
          }
        }
