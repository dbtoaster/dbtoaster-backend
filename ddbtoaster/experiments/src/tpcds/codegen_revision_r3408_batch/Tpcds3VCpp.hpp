...
namespace dbtoaster {
  ...
  struct SUM_AGGITEM1_DELTA_entry {
    long STORE_SALES_SS_ITEM_SK; STRING_TYPE BRAND; long BRAND_ID; long __av; 
    explicit SUM_AGGITEM1_DELTA_entry() { /*STORE_SALES_SS_ITEM_SK = 0L; BRAND = ""; BRAND_ID = 0L; __av = 0L; */ }
    explicit SUM_AGGITEM1_DELTA_entry(const long c0, const STRING_TYPE& c1, const long c2, const long c3) { STORE_SALES_SS_ITEM_SK = c0; BRAND = c1; BRAND_ID = c2; __av = c3; }
    SUM_AGGITEM1_DELTA_entry(const SUM_AGGITEM1_DELTA_entry& other) : STORE_SALES_SS_ITEM_SK( other.STORE_SALES_SS_ITEM_SK ), BRAND( other.BRAND ), BRAND_ID( other.BRAND_ID ), __av( other.__av ) {}
    FORCE_INLINE SUM_AGGITEM1_DELTA_entry& modify(const long c0, const STRING_TYPE& c1, const long c2) { STORE_SALES_SS_ITEM_SK = c0; BRAND = c1; BRAND_ID = c2;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct SUM_AGGITEM1_DELTA_mapkey012_idxfn {
    FORCE_INLINE static size_t hash(const SUM_AGGITEM1_DELTA_entry& e) {
      size_t h = 0;
      hash_combine(h, e.STORE_SALES_SS_ITEM_SK);
      hash_combine(h, e.BRAND);
      hash_combine(h, e.BRAND_ID);
    ...
    FORCE_INLINE static bool equals(const SUM_AGGITEM1_DELTA_entry& x, const SUM_AGGITEM1_DELTA_entry& y) {
      return x.STORE_SALES_SS_ITEM_SK == y.STORE_SALES_SS_ITEM_SK && x.BRAND == y.BRAND && x.BRAND_ID == y.BRAND_ID;
    }
  };
  
  typedef MultiHashMap<SUM_AGGITEM1_DELTA_entry,long,
    HashIndex<SUM_AGGITEM1_DELTA_entry,long,SUM_AGGITEM1_DELTA_mapkey012_idxfn,true>
  > SUM_AGGITEM1_DELTA_map;
  typedef HashIndex<SUM_AGGITEM1_DELTA_entry,long,SUM_AGGITEM1_DELTA_mapkey012_idxfn,true> HashIndex_SUM_AGGITEM1_DELTA_map_012;
  
  struct SUM_AGGITEM1_entry {
    long DT_D_YEAR; long STORE_SALES_SS_ITEM_SK; DOUBLE_TYPE __av; 
    explicit SUM_AGGITEM1_entry() { /*DT_D_YEAR = 0L; STORE_SALES_SS_ITEM_SK = 0L; __av = 0.0; */ }
    explicit SUM_AGGITEM1_entry(const long c0, const long c1, const DOUBLE_TYPE c2) { DT_D_YEAR = c0; STORE_SALES_SS_ITEM_SK = c1; __av = c2; }
    SUM_AGGITEM1_entry(const SUM_AGGITEM1_entry& other) : DT_D_YEAR( other.DT_D_YEAR ), STORE_SALES_SS_ITEM_SK( other.STORE_SALES_SS_ITEM_SK ), __av( other.__av ) {}
    FORCE_INLINE SUM_AGGITEM1_entry& modify(const long c0, const long c1) { DT_D_YEAR = c0; STORE_SALES_SS_ITEM_SK = c1;  return *this; }
    FORCE_INLINE SUM_AGGITEM1_entry& modify1(const long c1) { STORE_SALES_SS_ITEM_SK = c1;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct SUM_AGGITEM1_mapkey01_idxfn {
    FORCE_INLINE static size_t hash(const SUM_AGGITEM1_entry& e) {
      size_t h = 0;
      hash_combine(h, e.DT_D_YEAR);
      hash_combine(h, e.STORE_SALES_SS_ITEM_SK);
      return h;
    }
    FORCE_INLINE static bool equals(const SUM_AGGITEM1_entry& x, const SUM_AGGITEM1_entry& y) {
      return x.DT_D_YEAR == y.DT_D_YEAR && x.STORE_SALES_SS_ITEM_SK == y.STORE_SALES_SS_ITEM_SK;
    }
  };
  
  struct SUM_AGGITEM1_mapkey1_idxfn {
    FORCE_INLINE static size_t hash(const SUM_AGGITEM1_entry& e) {
      size_t h = 0;
      hash_combine(h, e.STORE_SALES_SS_ITEM_SK);
      return h;
  ...
  typedef MultiHashMap<SUM_AGGITEM1_entry,DOUBLE_TYPE,
    HashIndex<SUM_AGGITEM1_entry,DOUBLE_TYPE,SUM_AGGITEM1_mapkey01_idxfn,true>,
    HashIndex<SUM_AGGITEM1_entry,DOUBLE_TYPE,SUM_AGGITEM1_mapkey1_idxfn,false>
  > SUM_AGGITEM1_map;
  typedef HashIndex<SUM_AGGITEM1_entry,DOUBLE_TYPE,SUM_AGGITEM1_mapkey01_idxfn,true> HashIndex_SUM_AGGITEM1_map_01;
  typedef HashIndex<SUM_AGGITEM1_entry,DOUBLE_TYPE,SUM_AGGITEM1_mapkey1_idxfn,false> HashIndex_SUM_AGGITEM1_map_1;
  
  struct SUM_AGGSTORE_SALES1_DELTA_entry {
    long DT_D_DATE_SK; long STORE_SALES_SS_ITEM_SK; DOUBLE_TYPE __av; 
    explicit SUM_AGGSTORE_SALES1_DELTA_entry() { /*DT_D_DATE_SK = 0L; STORE_SALES_SS_ITEM_SK = 0L; __av = 0.0; */ }
    explicit SUM_AGGSTORE_SALES1_DELTA_entry(const long c0, const long c1, const DOUBLE_TYPE c2) { DT_D_DATE_SK = c0; STORE_SALES_SS_ITEM_SK = c1; __av = c2; }
    SUM_AGGSTORE_SALES1_DELTA_entry(const SUM_AGGSTORE_SALES1_DELTA_entry& other) : DT_D_DATE_SK( other.DT_D_DATE_SK ), STORE_SALES_SS_ITEM_SK( other.STORE_SALES_SS_ITEM_SK ), __av( other.__av ) {}
    FORCE_INLINE SUM_AGGSTORE_SALES1_DELTA_entry& modify(const long c0, const long c1) { DT_D_DATE_SK = c0; STORE_SALES_SS_ITEM_SK = c1;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct SUM_AGGSTORE_SALES1_DELTA_mapkey01_idxfn {
    FORCE_INLINE static size_t hash(const SUM_AGGSTORE_SALES1_DELTA_entry& e) {
      size_t h = 0;
      hash_combine(h, e.DT_D_DATE_SK);
      hash_combine(h, e.STORE_SALES_SS_ITEM_SK);
      return h;
    }
    FORCE_INLINE static bool equals(const SUM_AGGSTORE_SALES1_DELTA_entry& x, const SUM_AGGSTORE_SALES1_DELTA_entry& y) {
      return x.DT_D_DATE_SK == y.DT_D_DATE_SK && x.STORE_SALES_SS_ITEM_SK == y.STORE_SALES_SS_ITEM_SK;
    }
  };
  
  typedef MultiHashMap<SUM_AGGSTORE_SALES1_DELTA_entry,DOUBLE_TYPE,
    HashIndex<SUM_AGGSTORE_SALES1_DELTA_entry,DOUBLE_TYPE,SUM_AGGSTORE_SALES1_DELTA_mapkey01_idxfn,true>
  > SUM_AGGSTORE_SALES1_DELTA_map;
  typedef HashIndex<SUM_AGGSTORE_SALES1_DELTA_entry,DOUBLE_TYPE,SUM_AGGSTORE_SALES1_DELTA_mapkey01_idxfn,true> HashIndex_SUM_AGGSTORE_SALES1_DELTA_map_01;
  
  struct SUM_AGGSTORE_SALES1_P_1_entry {
    long STORE_SALES_SS_ITEM_SK; STRING_TYPE BRAND; long BRAND_ID; long __av; 
    explicit SUM_AGGSTORE_SALES1_P_1_entry() { /*STORE_SALES_SS_ITEM_SK = 0L; BRAND = ""; BRAND_ID = 0L; __av = 0L; */ }
    explicit SUM_AGGSTORE_SALES1_P_1_entry(const long c0, const STRING_TYPE& c1, const long c2, const long c3) { STORE_SALES_SS_ITEM_SK = c0; BRAND = c1; BRAND_ID = c2; __av = c3; }
    SUM_AGGSTORE_SALES1_P_1_entry(const SUM_AGGSTORE_SALES1_P_1_entry& other) : STORE_SALES_SS_ITEM_SK( other.STORE_SALES_SS_ITEM_SK ), BRAND( other.BRAND ), BRAND_ID( other.BRAND_ID ), __av( other.__av ) {}
    FORCE_INLINE SUM_AGGSTORE_SALES1_P_1_entry& modify(const long c0, const STRING_TYPE& c1, const long c2) { STORE_SALES_SS_ITEM_SK = c0; BRAND = c1; BRAND_ID = c2;  return *this; }
    FORCE_INLINE SUM_AGGSTORE_SALES1_P_1_entry& modify0(const long c0) { STORE_SALES_SS_ITEM_SK = c0;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct SUM_AGGSTORE_SALES1_P_1_mapkey012_idxfn {
    FORCE_INLINE static size_t hash(const SUM_AGGSTORE_SALES1_P_1_entry& e) {
      size_t h = 0;
      hash_combine(h, e.STORE_SALES_SS_ITEM_SK);
      hash_combine(h, e.BRAND);
      hash_combine(h, e.BRAND_ID);
    ...
    FORCE_INLINE static bool equals(const SUM_AGGSTORE_SALES1_P_1_entry& x, const SUM_AGGSTORE_SALES1_P_1_entry& y) {
      return x.STORE_SALES_SS_ITEM_SK == y.STORE_SALES_SS_ITEM_SK && x.BRAND == y.BRAND && x.BRAND_ID == y.BRAND_ID;
    }
  };
  
  struct SUM_AGGSTORE_SALES1_P_1_mapkey0_idxfn {
    FORCE_INLINE static size_t hash(const SUM_AGGSTORE_SALES1_P_1_entry& e) {
      size_t h = 0;
      hash_combine(h, e.STORE_SALES_SS_ITEM_SK);
      return h;
  ...
  typedef MultiHashMap<SUM_AGGSTORE_SALES1_P_1_entry,long,
    HashIndex<SUM_AGGSTORE_SALES1_P_1_entry,long,SUM_AGGSTORE_SALES1_P_1_mapkey012_idxfn,true>,
    HashIndex<SUM_AGGSTORE_SALES1_P_1_entry,long,SUM_AGGSTORE_SALES1_P_1_mapkey0_idxfn,false>
  > SUM_AGGSTORE_SALES1_P_1_map;
  typedef HashIndex<SUM_AGGSTORE_SALES1_P_1_entry,long,SUM_AGGSTORE_SALES1_P_1_mapkey012_idxfn,true> HashIndex_SUM_AGGSTORE_SALES1_P_1_map_012;
  typedef HashIndex<SUM_AGGSTORE_SALES1_P_1_entry,long,SUM_AGGSTORE_SALES1_P_1_mapkey0_idxfn,false> HashIndex_SUM_AGGSTORE_SALES1_P_1_map_0;
  
  struct SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_entry {
    long STORE_SALES_SS_ITEM_SK; long BRAND_ID; STRING_TYPE BRAND; long __av; 
    explicit SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_entry() { /*STORE_SALES_SS_ITEM_SK = 0L; BRAND_ID = 0L; BRAND = ""; __av = 0L; */ }
    explicit SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_entry(const long c0, const long c1, const STRING_TYPE& c2, const long c3) { STORE_SALES_SS_ITEM_SK = c0; BRAND_ID = c1; BRAND = c2; __av = c3; }
    SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_entry(const SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_entry& other) : STORE_SALES_SS_ITEM_SK( other.STORE_SALES_SS_ITEM_SK ), BRAND_ID( other.BRAND_ID ), BRAND( other.BRAND ), __av( other.__av ) {}
    FORCE_INLINE SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_entry& modify(const long c0, const long c1, const STRING_TYPE& c2) { STORE_SALES_SS_ITEM_SK = c0; BRAND_ID = c1; BRAND = c2;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_mapkey012_idxfn {
    FORCE_INLINE static size_t hash(const SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_entry& e) {
      size_t h = 0;
      hash_combine(h, e.STORE_SALES_SS_ITEM_SK);
      hash_combine(h, e.BRAND_ID);
      hash_combine(h, e.BRAND);
    ...
    FORCE_INLINE static bool equals(const SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_entry& x, const SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_entry& y) {
      return x.STORE_SALES_SS_ITEM_SK == y.STORE_SALES_SS_ITEM_SK && x.BRAND_ID == y.BRAND_ID && x.BRAND == y.BRAND;
    }
  };
  
  typedef MultiHashMap<SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_entry,long,
    HashIndex<SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_entry,long,SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_mapkey012_idxfn,true>
  > SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_map;
  typedef HashIndex<SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_entry,long,SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_mapkey012_idxfn,true> HashIndex_SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_map_012;
  
  struct SUM_AGGSTORE_SALES1_P_2_entry {
    long DT_D_DATE_SK; long DT_D_YEAR; long __av; 
    explicit SUM_AGGSTORE_SALES1_P_2_entry() { /*DT_D_DATE_SK = 0L; DT_D_YEAR = 0L; __av = 0L; */ }
    explicit SUM_AGGSTORE_SALES1_P_2_entry(const long c0, const long c1, const long c2) { DT_D_DATE_SK = c0; DT_D_YEAR = c1; __av = c2; }
    SUM_AGGSTORE_SALES1_P_2_entry(const SUM_AGGSTORE_SALES1_P_2_entry& other) : DT_D_DATE_SK( other.DT_D_DATE_SK ), DT_D_YEAR( other.DT_D_YEAR ), __av( other.__av ) {}
    FORCE_INLINE SUM_AGGSTORE_SALES1_P_2_entry& modify(const long c0, const long c1) { DT_D_DATE_SK = c0; DT_D_YEAR = c1;  return *this; }
    FORCE_INLINE SUM_AGGSTORE_SALES1_P_2_entry& modify0(const long c0) { DT_D_DATE_SK = c0;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct SUM_AGGSTORE_SALES1_P_2_mapkey01_idxfn {
    FORCE_INLINE static size_t hash(const SUM_AGGSTORE_SALES1_P_2_entry& e) {
      size_t h = 0;
      hash_combine(h, e.DT_D_DATE_SK);
      hash_combine(h, e.DT_D_YEAR);
      return h;
    }
    FORCE_INLINE static bool equals(const SUM_AGGSTORE_SALES1_P_2_entry& x, const SUM_AGGSTORE_SALES1_P_2_entry& y) {
      return x.DT_D_DATE_SK == y.DT_D_DATE_SK && x.DT_D_YEAR == y.DT_D_YEAR;
    }
  };
  
  struct SUM_AGGSTORE_SALES1_P_2_mapkey0_idxfn {
    FORCE_INLINE static size_t hash(const SUM_AGGSTORE_SALES1_P_2_entry& e) {
      size_t h = 0;
      hash_combine(h, e.DT_D_DATE_SK);
      return h;
  ...
  typedef MultiHashMap<SUM_AGGSTORE_SALES1_P_2_entry,long,
    HashIndex<SUM_AGGSTORE_SALES1_P_2_entry,long,SUM_AGGSTORE_SALES1_P_2_mapkey01_idxfn,true>,
    HashIndex<SUM_AGGSTORE_SALES1_P_2_entry,long,SUM_AGGSTORE_SALES1_P_2_mapkey0_idxfn,false>
  > SUM_AGGSTORE_SALES1_P_2_map;
  typedef HashIndex<SUM_AGGSTORE_SALES1_P_2_entry,long,SUM_AGGSTORE_SALES1_P_2_mapkey01_idxfn,true> HashIndex_SUM_AGGSTORE_SALES1_P_2_map_01;
  typedef HashIndex<SUM_AGGSTORE_SALES1_P_2_entry,long,SUM_AGGSTORE_SALES1_P_2_mapkey0_idxfn,false> HashIndex_SUM_AGGSTORE_SALES1_P_2_map_0;
  ...
  struct data_t : tlq_t{
    ...
    void on_batch_update_STORE_SALES(TPCDSStoreSalesBatch& DELTA_STORE_SALES) {
      { 
        ...
        SUM_AGGSTORE_SALES1_DELTA.clear();
        {  
          for (size_t i = 0; i < DELTA_STORE_SALES.size; i++) 
          {
                ...
                long v1 = 1L;
                SUM_AGGSTORE_SALES1_DELTA.addOrDelOnZero(se1.modify(dt_d_date_sk,store_sales_ss_item_sk),(v1 * store_sales_ss_ext_sales_price));
          }
        }

        {  // foreach
          const HashIndex_SUM_AGGSTORE_SALES1_DELTA_map_01* i2 = static_cast<HashIndex_SUM_AGGSTORE_SALES1_DELTA_map_01*>(SUM_AGGSTORE_SALES1_DELTA.index[0]);
          HashIndex_SUM_AGGSTORE_SALES1_DELTA_map_01::IdxNode* n2; 
          SUM_AGGSTORE_SALES1_DELTA_entry* e2;
          ...
          for (size_t i = 0; i < i2->size_; i++)
          {
            ...
            while (n2 && (e2 = n2->obj))
            {
                ...
                { //slice 
                  const HashIndex_SUM_AGGSTORE_SALES1_P_1_map_0* i3 = static_cast<HashIndex_SUM_AGGSTORE_SALES1_P_1_map_0*>(SUM_AGGSTORE_SALES1_P_1.index[1]);
                  const HASH_RES_t h2 = SUM_AGGSTORE_SALES1_P_1_mapkey0_idxfn::hash(se4.modify0(store_sales_ss_item_sk));
                  HashIndex_SUM_AGGSTORE_SALES1_P_1_map_0::IdxNode* n3 = static_cast<HashIndex_SUM_AGGSTORE_SALES1_P_1_map_0::IdxNode*>(i3->slice(se4, h2));
                  SUM_AGGSTORE_SALES1_P_1_entry* e3;
                  ...
                  if (n3 && (e3 = n3->obj)) {
                    do {                
                      ...
                      long v3 = e3->__av;
                      { //slice 
                        const HashIndex_SUM_AGGSTORE_SALES1_P_2_map_0* i4 = static_cast<HashIndex_SUM_AGGSTORE_SALES1_P_2_map_0*>(SUM_AGGSTORE_SALES1_P_2.index[1]);
                        const HASH_RES_t h1 = SUM_AGGSTORE_SALES1_P_2_mapkey0_idxfn::hash(se3.modify0(dt_d_date_sk));
                        HashIndex_SUM_AGGSTORE_SALES1_P_2_map_0::IdxNode* n4 = static_cast<HashIndex_SUM_AGGSTORE_SALES1_P_2_map_0::IdxNode*>(i4->slice(se3, h1));
                        SUM_AGGSTORE_SALES1_P_2_entry* e4;
                       
                        if (n4 && (e4 = n4->obj)) {
                          do {                
                            long dt_d_year = e4->DT_D_YEAR;
                            long v4 = e4->__av;
                            SUM_AGG.addOrDelOnZero(se2.modify(dt_d_year,brand_id,brand),(v2 * (v3 * v4)));
                            n4 = n4->nxt;
                          } while (n4 && (e4 = n4->obj) && h1 == n4->hash &&  SUM_AGGSTORE_SALES1_P_2_mapkey0_idxfn::equals(se3, *e4)); 
                        }
                      }
                      n3 = n3->nxt;
                    } while (n3 && (e3 = n3->obj) && h2 == n3->hash &&  SUM_AGGSTORE_SALES1_P_1_mapkey0_idxfn::equals(se4, *e3)); 
                  }
                }
              n2 = n2->nxt;
            }
          ...
          const HashIndex_SUM_AGGSTORE_SALES1_DELTA_map_01* i5 = static_cast<HashIndex_SUM_AGGSTORE_SALES1_DELTA_map_01*>(SUM_AGGSTORE_SALES1_DELTA.index[0]);
          HashIndex_SUM_AGGSTORE_SALES1_DELTA_map_01::IdxNode* n5; 
          SUM_AGGSTORE_SALES1_DELTA_entry* e5;
          ...
          for (size_t i = 0; i < i5->size_; i++)
          {
            ...
            while (n5 && (e5 = n5->obj))
            {
                ...
                { //slice 
                  const HashIndex_SUM_AGGSTORE_SALES1_P_2_map_0* i6 = static_cast<HashIndex_SUM_AGGSTORE_SALES1_P_2_map_0*>(SUM_AGGSTORE_SALES1_P_2.index[1]);
                  const HASH_RES_t h3 = SUM_AGGSTORE_SALES1_P_2_mapkey0_idxfn::hash(se6.modify0(dt_d_date_sk));
                  HashIndex_SUM_AGGSTORE_SALES1_P_2_map_0::IdxNode* n6 = static_cast<HashIndex_SUM_AGGSTORE_SALES1_P_2_map_0::IdxNode*>(i6->slice(se6, h3));
                  SUM_AGGSTORE_SALES1_P_2_entry* e6;
                 
                  if (n6 && (e6 = n6->obj)) {
                    do {                
                      long dt_d_year = e6->DT_D_YEAR;
                      long v6 = e6->__av;
                      SUM_AGGITEM1.addOrDelOnZero(se5.modify(dt_d_year,store_sales_ss_item_sk),(v5 * v6));
                      n6 = n6->nxt;
                    } while (n6 && (e6 = n6->obj) && h3 == n6->hash &&  SUM_AGGSTORE_SALES1_P_2_mapkey0_idxfn::equals(se6, *e6)); 
                  }
                }
              n5 = n5->nxt;
            }
    ...
    void on_batch_update_ITEM(TPCDSItemBatch& DELTA_ITEM) {
      { 
        ...
        SUM_AGGITEM1_DELTA.clear();
        SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA.clear();
        {  
          for (size_t i = 0; i < DELTA_ITEM.size; i++) 
          {
                ...
                long lift1 = DELTA_ITEM.i_manufact_id[i];
                ...
                long v7 = 1L;
                (/*if */(lift1 == 436L) ? SUM_AGGITEM1_DELTA.addOrDelOnZero(se7.modify(store_sales_ss_item_sk,item_i_brand,item_i_brand_id),v7) : (void)0);            
                long v8 = 1L;
                (/*if */(lift1 == 436L) ? SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA.addOrDelOnZero(se8.modify(store_sales_ss_item_sk,item_i_brand_id,item_i_brand),v8) : (void)0);
          }
        }

        {  // foreach
          const HashIndex_SUM_AGGITEM1_DELTA_map_012* i9 = static_cast<HashIndex_SUM_AGGITEM1_DELTA_map_012*>(SUM_AGGITEM1_DELTA.index[0]);
          HashIndex_SUM_AGGITEM1_DELTA_map_012::IdxNode* n9; 
          SUM_AGGITEM1_DELTA_entry* e9;
          ...
          for (size_t i = 0; i < i9->size_; i++)
          {
            ...
            while (n9 && (e9 = n9->obj))
            {
                ...
                long v9 = e9->__av;
                { //slice 
                  const HashIndex_SUM_AGGITEM1_map_1* i10 = static_cast<HashIndex_SUM_AGGITEM1_map_1*>(SUM_AGGITEM1.index[1]);
                  const HASH_RES_t h4 = SUM_AGGITEM1_mapkey1_idxfn::hash(se10.modify1(store_sales_ss_item_sk));
                  HashIndex_SUM_AGGITEM1_map_1::IdxNode* n10 = static_cast<HashIndex_SUM_AGGITEM1_map_1::IdxNode*>(i10->slice(se10, h4));
                  SUM_AGGITEM1_entry* e10;
                 
                  if (n10 && (e10 = n10->obj)) {
                    do {                
                      long dt_d_year = e10->DT_D_YEAR;
                      DOUBLE_TYPE v10 = e10->__av;
                      SUM_AGG.addOrDelOnZero(se9.modify(dt_d_year,brand_id,brand),(v9 * v10));
                      n10 = n10->nxt;
                    } while (n10 && (e10 = n10->obj) && h4 == n10->hash &&  SUM_AGGITEM1_mapkey1_idxfn::equals(se10, *e10)); 
                  }
                }
              n9 = n9->nxt;
            }
          ...
          const HashIndex_SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_map_012* i11 = static_cast<HashIndex_SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_map_012*>(SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA.index[0]);
          HashIndex_SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_map_012::IdxNode* n11; 
          SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_entry* e11;
          ...
          for (size_t i = 0; i < i11->size_; i++)
          {
            ...
            while (n11 && (e11 = n11->obj))
            {
                ...
                long v11 = e11->__av;
                SUM_AGGSTORE_SALES1_P_1.addOrDelOnZero(se11.modify(store_sales_ss_item_sk,brand,brand_id),v11);
              n11 = n11->nxt;
            }
          }
        }
    ...
    void on_system_ready_event() {
      {  
        SUM_AGGSTORE_SALES1_P_2.clear();
        long l1 = 12L;
        { //slice 
          const HashIndex_DATE_DIM_map_8* i12 = static_cast<HashIndex_DATE_DIM_map_8*>(DATE_DIM.index[1]);
          const HASH_RES_t h5 = DATE_DIM_mapkey8_idxfn::hash(se13.modify8(l1));
          HashIndex_DATE_DIM_map_8::IdxNode* n12 = static_cast<HashIndex_DATE_DIM_map_8::IdxNode*>(i12->slice(se13, h5));
          DATE_DIM_entry* e12;
          ...
          if (n12 && (e12 = n12->obj)) {
            do {                
              ...
              long dt_d_year = e12->DATE_DIM_D_YEAR;
              ...
              long v12 = e12->__av;
              SUM_AGGSTORE_SALES1_P_2.addOrDelOnZero(se12.modify(dt_d_date_sk,dt_d_year),v12);
              n12 = n12->nxt;
            } while (n12 && (e12 = n12->obj) && h5 == n12->hash &&  DATE_DIM_mapkey8_idxfn::equals(se13, *e12)); 
          }
        }
      }
    }
  ...
  private:
    ...
    SUM_AGGSTORE_SALES1_DELTA_entry se1;
    SUM_AGG_entry se2;
    SUM_AGGSTORE_SALES1_P_2_entry se3;
    SUM_AGGSTORE_SALES1_P_1_entry se4;
    SUM_AGGITEM1_entry se5;
    SUM_AGGSTORE_SALES1_P_2_entry se6;
    SUM_AGGITEM1_DELTA_entry se7;
    SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_entry se8;
    SUM_AGG_entry se9;
    SUM_AGGITEM1_entry se10;
    SUM_AGGSTORE_SALES1_P_1_entry se11;
    SUM_AGGSTORE_SALES1_P_2_entry se12;
    DATE_DIM_entry se13;
  
    /* Data structures used for storing materialized views */
    DATE_DIM_map DATE_DIM;
    SUM_AGGITEM1_DELTA_map SUM_AGGITEM1_DELTA;
    SUM_AGGITEM1_map SUM_AGGITEM1;
    SUM_AGGSTORE_SALES1_DELTA_map SUM_AGGSTORE_SALES1_DELTA;
    SUM_AGGSTORE_SALES1_P_1_map SUM_AGGSTORE_SALES1_P_1;
    SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA_map SUM_AGGSTORE_SALES1_P_1ITEM1_DELTA;
    SUM_AGGSTORE_SALES1_P_2_map SUM_AGGSTORE_SALES1_P_2;
