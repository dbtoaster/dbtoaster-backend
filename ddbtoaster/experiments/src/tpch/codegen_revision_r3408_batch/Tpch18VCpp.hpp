...
namespace dbtoaster {
  ...
  struct QUERY18LINEITEM1_DELTA_entry {
    long O_ORDERKEY; DOUBLE_TYPE __av; 
    explicit QUERY18LINEITEM1_DELTA_entry() { /*O_ORDERKEY = 0L; __av = 0.0; */ }
    explicit QUERY18LINEITEM1_DELTA_entry(const long c0, const DOUBLE_TYPE c1) { O_ORDERKEY = c0; __av = c1; }
    QUERY18LINEITEM1_DELTA_entry(const QUERY18LINEITEM1_DELTA_entry& other) : O_ORDERKEY( other.O_ORDERKEY ), __av( other.__av ) {}
    FORCE_INLINE QUERY18LINEITEM1_DELTA_entry& modify(const long c0) { O_ORDERKEY = c0;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct QUERY18LINEITEM1_DELTA_mapkey0_idxfn {
    FORCE_INLINE static size_t hash(const QUERY18LINEITEM1_DELTA_entry& e) {
      size_t h = 0;
      hash_combine(h, e.O_ORDERKEY);
      return h;
    }
    FORCE_INLINE static bool equals(const QUERY18LINEITEM1_DELTA_entry& x, const QUERY18LINEITEM1_DELTA_entry& y) {
      return x.O_ORDERKEY == y.O_ORDERKEY;
    }
  };
  
  typedef MultiHashMap<QUERY18LINEITEM1_DELTA_entry,DOUBLE_TYPE,
    HashIndex<QUERY18LINEITEM1_DELTA_entry,DOUBLE_TYPE,QUERY18LINEITEM1_DELTA_mapkey0_idxfn,true>
  > QUERY18LINEITEM1_DELTA_map;
  typedef HashIndex<QUERY18LINEITEM1_DELTA_entry,DOUBLE_TYPE,QUERY18LINEITEM1_DELTA_mapkey0_idxfn,true> HashIndex_QUERY18LINEITEM1_DELTA_map_0;
  
  struct QUERY18LINEITEM1_entry {
    long O_ORDERKEY; long C_CUSTKEY; DOUBLE_TYPE O_TOTALPRICE; date O_ORDERDATE; STRING_TYPE C_NAME; long __av; 
    explicit QUERY18LINEITEM1_entry() { /*O_ORDERKEY = 0L; C_CUSTKEY = 0L; O_TOTALPRICE = 0.0; O_ORDERDATE = 00000000; C_NAME = ""; __av = 0L; */ }
    explicit QUERY18LINEITEM1_entry(const long c0, const long c1, const DOUBLE_TYPE c2, const date c3, const STRING_TYPE& c4, const long c5) { O_ORDERKEY = c0; C_CUSTKEY = c1; O_TOTALPRICE = c2; O_ORDERDATE = c3; C_NAME = c4; __av = c5; }
    QUERY18LINEITEM1_entry(const QUERY18LINEITEM1_entry& other) : O_ORDERKEY( other.O_ORDERKEY ), C_CUSTKEY( other.C_CUSTKEY ), O_TOTALPRICE( other.O_TOTALPRICE ), O_ORDERDATE( other.O_ORDERDATE ), C_NAME( other.C_NAME ), __av( other.__av ) {}
    FORCE_INLINE QUERY18LINEITEM1_entry& modify(const long c0, const long c1, const DOUBLE_TYPE c2, const date c3, const STRING_TYPE& c4) { O_ORDERKEY = c0; C_CUSTKEY = c1; O_TOTALPRICE = c2; O_ORDERDATE = c3; C_NAME = c4;  return *this; }
    FORCE_INLINE QUERY18LINEITEM1_entry& modify0(const long c0) { O_ORDERKEY = c0;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct QUERY18LINEITEM1_mapkey01234_idxfn {
    FORCE_INLINE static size_t hash(const QUERY18LINEITEM1_entry& e) {
      size_t h = 0;
      hash_combine(h, e.O_ORDERKEY);
      hash_combine(h, e.C_CUSTKEY);
      hash_combine(h, e.O_TOTALPRICE);
    ...
    FORCE_INLINE static bool equals(const QUERY18LINEITEM1_entry& x, const QUERY18LINEITEM1_entry& y) {
      return x.O_ORDERKEY == y.O_ORDERKEY && x.C_CUSTKEY == y.C_CUSTKEY && x.O_TOTALPRICE == y.O_TOTALPRICE && x.O_ORDERDATE == y.O_ORDERDATE && x.C_NAME == y.C_NAME;
    }
  };
  
  struct QUERY18LINEITEM1_mapkey0_idxfn {
    FORCE_INLINE static size_t hash(const QUERY18LINEITEM1_entry& e) {
      size_t h = 0;
      hash_combine(h, e.O_ORDERKEY);
      return h;
  ...
  typedef MultiHashMap<QUERY18LINEITEM1_entry,long,
    HashIndex<QUERY18LINEITEM1_entry,long,QUERY18LINEITEM1_mapkey01234_idxfn,true>,
    HashIndex<QUERY18LINEITEM1_entry,long,QUERY18LINEITEM1_mapkey0_idxfn,false>
  > QUERY18LINEITEM1_map;
  typedef HashIndex<QUERY18LINEITEM1_entry,long,QUERY18LINEITEM1_mapkey01234_idxfn,true> HashIndex_QUERY18LINEITEM1_map_01234;
  typedef HashIndex<QUERY18LINEITEM1_entry,long,QUERY18LINEITEM1_mapkey0_idxfn,false> HashIndex_QUERY18LINEITEM1_map_0;
  
  struct QUERY18LINEITEM1CUSTOMER1_entry {
    long O_ORDERKEY; long C_CUSTKEY; DOUBLE_TYPE O_TOTALPRICE; date O_ORDERDATE; long __av; 
    explicit QUERY18LINEITEM1CUSTOMER1_entry() { /*O_ORDERKEY = 0L; C_CUSTKEY = 0L; O_TOTALPRICE = 0.0; O_ORDERDATE = 00000000; __av = 0L; */ }
    explicit QUERY18LINEITEM1CUSTOMER1_entry(const long c0, const long c1, const DOUBLE_TYPE c2, const date c3, const long c4) { O_ORDERKEY = c0; C_CUSTKEY = c1; O_TOTALPRICE = c2; O_ORDERDATE = c3; __av = c4; }
    QUERY18LINEITEM1CUSTOMER1_entry(const QUERY18LINEITEM1CUSTOMER1_entry& other) : O_ORDERKEY( other.O_ORDERKEY ), C_CUSTKEY( other.C_CUSTKEY ), O_TOTALPRICE( other.O_TOTALPRICE ), O_ORDERDATE( other.O_ORDERDATE ), __av( other.__av ) {}
    FORCE_INLINE QUERY18LINEITEM1CUSTOMER1_entry& modify(const long c0, const long c1, const DOUBLE_TYPE c2, const date c3) { O_ORDERKEY = c0; C_CUSTKEY = c1; O_TOTALPRICE = c2; O_ORDERDATE = c3;  return *this; }
    FORCE_INLINE QUERY18LINEITEM1CUSTOMER1_entry& modify0(const long c0) { O_ORDERKEY = c0;  return *this; }
    FORCE_INLINE QUERY18LINEITEM1CUSTOMER1_entry& modify1(const long c1) { C_CUSTKEY = c1;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct QUERY18LINEITEM1CUSTOMER1_mapkey0123_idxfn {
    FORCE_INLINE static size_t hash(const QUERY18LINEITEM1CUSTOMER1_entry& e) {
      size_t h = 0;
      hash_combine(h, e.O_ORDERKEY);
      hash_combine(h, e.C_CUSTKEY);
      hash_combine(h, e.O_TOTALPRICE);
    ...
    FORCE_INLINE static bool equals(const QUERY18LINEITEM1CUSTOMER1_entry& x, const QUERY18LINEITEM1CUSTOMER1_entry& y) {
      return x.O_ORDERKEY == y.O_ORDERKEY && x.C_CUSTKEY == y.C_CUSTKEY && x.O_TOTALPRICE == y.O_TOTALPRICE && x.O_ORDERDATE == y.O_ORDERDATE;
    }
  };
  
  struct QUERY18LINEITEM1CUSTOMER1_mapkey0_idxfn {
    FORCE_INLINE static size_t hash(const QUERY18LINEITEM1CUSTOMER1_entry& e) {
      size_t h = 0;
      hash_combine(h, e.O_ORDERKEY);
      return h;
  ...
  struct QUERY18LINEITEM1CUSTOMER1_mapkey1_idxfn {
    FORCE_INLINE static size_t hash(const QUERY18LINEITEM1CUSTOMER1_entry& e) {
      size_t h = 0;
      hash_combine(h, e.C_CUSTKEY);
      return h;
  ...
  typedef MultiHashMap<QUERY18LINEITEM1CUSTOMER1_entry,long,
    HashIndex<QUERY18LINEITEM1CUSTOMER1_entry,long,QUERY18LINEITEM1CUSTOMER1_mapkey0123_idxfn,true>,
    HashIndex<QUERY18LINEITEM1CUSTOMER1_entry,long,QUERY18LINEITEM1CUSTOMER1_mapkey0_idxfn,false>,
    HashIndex<QUERY18LINEITEM1CUSTOMER1_entry,long,QUERY18LINEITEM1CUSTOMER1_mapkey1_idxfn,false>
  > QUERY18LINEITEM1CUSTOMER1_map;
  typedef HashIndex<QUERY18LINEITEM1CUSTOMER1_entry,long,QUERY18LINEITEM1CUSTOMER1_mapkey0123_idxfn,true> HashIndex_QUERY18LINEITEM1CUSTOMER1_map_0123;
  typedef HashIndex<QUERY18LINEITEM1CUSTOMER1_entry,long,QUERY18LINEITEM1CUSTOMER1_mapkey0_idxfn,false> HashIndex_QUERY18LINEITEM1CUSTOMER1_map_0;
  typedef HashIndex<QUERY18LINEITEM1CUSTOMER1_entry,long,QUERY18LINEITEM1CUSTOMER1_mapkey1_idxfn,false> HashIndex_QUERY18LINEITEM1CUSTOMER1_map_1;
  
  struct QUERY18LINEITEM2_DOMAIN1_entry {
    long O_ORDERKEY; long __av; 
    explicit QUERY18LINEITEM2_DOMAIN1_entry() { /*O_ORDERKEY = 0L; __av = 0L; */ }
    explicit QUERY18LINEITEM2_DOMAIN1_entry(const long c0, const long c1) { O_ORDERKEY = c0; __av = c1; }
    QUERY18LINEITEM2_DOMAIN1_entry(const QUERY18LINEITEM2_DOMAIN1_entry& other) : O_ORDERKEY( other.O_ORDERKEY ), __av( other.__av ) {}
    FORCE_INLINE QUERY18LINEITEM2_DOMAIN1_entry& modify(const long c0) { O_ORDERKEY = c0;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct QUERY18LINEITEM2_DOMAIN1_mapkey0_idxfn {
    FORCE_INLINE static size_t hash(const QUERY18LINEITEM2_DOMAIN1_entry& e) {
      size_t h = 0;
      hash_combine(h, e.O_ORDERKEY);
      return h;
    }
    FORCE_INLINE static bool equals(const QUERY18LINEITEM2_DOMAIN1_entry& x, const QUERY18LINEITEM2_DOMAIN1_entry& y) {
      return x.O_ORDERKEY == y.O_ORDERKEY;
    }
  };
  
  typedef MultiHashMap<QUERY18LINEITEM2_DOMAIN1_entry,long,
    HashIndex<QUERY18LINEITEM2_DOMAIN1_entry,long,QUERY18LINEITEM2_DOMAIN1_mapkey0_idxfn,true>
  > QUERY18LINEITEM2_DOMAIN1_map;
  typedef HashIndex<QUERY18LINEITEM2_DOMAIN1_entry,long,QUERY18LINEITEM2_DOMAIN1_mapkey0_idxfn,true> HashIndex_QUERY18LINEITEM2_DOMAIN1_map_0;
  ...
  struct data_t : tlq_t{
    ...
    void on_batch_update_LINEITEM(TPCHLineitemBatch& DELTA_LINEITEM) {
      { 
        ...
        QUERY18LINEITEM2_DOMAIN1.clear();
        QUERY18LINEITEM1_DELTA.clear();
        {  
          for (size_t i = 0; i < DELTA_LINEITEM.size; i++) 
          {
                ...
                long v1 = 1L;
                QUERY18LINEITEM2_DOMAIN1.addOrDelOnZero(se1.modify(o_orderkey),(v1 != 0 ? 1L : 0L));            
                long v2 = 1L;
                QUERY18LINEITEM1_DELTA.addOrDelOnZero(se2.modify(o_orderkey),(v2 * l2_quantity));

          }
        }

        {  // foreach
          const HashIndex_QUERY18LINEITEM2_DOMAIN1_map_0* i3 = static_cast<HashIndex_QUERY18LINEITEM2_DOMAIN1_map_0*>(QUERY18LINEITEM2_DOMAIN1.index[0]);
          HashIndex_QUERY18LINEITEM2_DOMAIN1_map_0::IdxNode* n3; 
          QUERY18LINEITEM2_DOMAIN1_entry* e3;
          ...
          for (size_t i = 0; i < i3->size_; i++)
          {
            ...
            while (n3 && (e3 = n3->obj))
            {
                ...
                long v3 = e3->__av;
                { //slice 
                  const HashIndex_QUERY18LINEITEM1_map_0* i4 = static_cast<HashIndex_QUERY18LINEITEM1_map_0*>(QUERY18LINEITEM1.index[1]);
                  const HASH_RES_t h1 = QUERY18LINEITEM1_mapkey0_idxfn::hash(se8.modify0(o_orderkey));
                  HashIndex_QUERY18LINEITEM1_map_0::IdxNode* n4 = static_cast<HashIndex_QUERY18LINEITEM1_map_0::IdxNode*>(i4->slice(se8, h1));
                  QUERY18LINEITEM1_entry* e4;
                  ...
                  if (n4 && (e4 = n4->obj)) {
                    do {                
                      ...
                      long v4 = e4->__av;
                      long agg1 = 0L;
                      DOUBLE_TYPE l1 = (QUERY18CUSTOMER1_L1_1.getValueOrDefault(se5.modify(o_orderkey)) + QUERY18LINEITEM1_DELTA.getValueOrDefault(se6.modify(o_orderkey)));
                      (/*if */(l1 > 100L) ? agg1 += 1L : 0L);
                      long agg2 = 0L;
                      DOUBLE_TYPE l2 = QUERY18CUSTOMER1_L1_1.getValueOrDefault(se7.modify(o_orderkey));
                      (/*if */(l2 > 100L) ? agg2 += 1L : 0L);
                      QUERY18.addOrDelOnZero(se3.modify(c_name,c_custkey,o_orderkey,o_orderdate,o_totalprice),((v3 != 0 ? 1L : 0L) * (QUERY18CUSTOMER1_L1_1.getValueOrDefault(se4.modify(o_orderkey)) * (v4 * (agg1 + (agg2 * -1L))))));
                      n4 = n4->nxt;
                    } while (n4 && (e4 = n4->obj) && h1 == n4->hash &&  QUERY18LINEITEM1_mapkey0_idxfn::equals(se8, *e4)); 
                  }
                }
              n3 = n3->nxt;
            }
          ...
          const HashIndex_QUERY18LINEITEM1_DELTA_map_0* i5 = static_cast<HashIndex_QUERY18LINEITEM1_DELTA_map_0*>(QUERY18LINEITEM1_DELTA.index[0]);
          HashIndex_QUERY18LINEITEM1_DELTA_map_0::IdxNode* n5; 
          QUERY18LINEITEM1_DELTA_entry* e5;
          ...
          for (size_t i = 0; i < i5->size_; i++)
          {
            ...
            while (n5 && (e5 = n5->obj))
            {
                ...
                { //slice 
                  const HashIndex_QUERY18LINEITEM1_map_0* i6 = static_cast<HashIndex_QUERY18LINEITEM1_map_0*>(QUERY18LINEITEM1.index[1]);
                  const HASH_RES_t h2 = QUERY18LINEITEM1_mapkey0_idxfn::hash(se11.modify0(o_orderkey));
                  HashIndex_QUERY18LINEITEM1_map_0::IdxNode* n6 = static_cast<HashIndex_QUERY18LINEITEM1_map_0::IdxNode*>(i6->slice(se11, h2));
                  QUERY18LINEITEM1_entry* e6;
                  ...
                  if (n6 && (e6 = n6->obj)) {
                    do {                
                      ...
                      long v6 = e6->__av;
                      long agg3 = 0L;
                      DOUBLE_TYPE l3 = (QUERY18CUSTOMER1_L1_1.getValueOrDefault(se9.modify(o_orderkey)) + QUERY18LINEITEM1_DELTA.getValueOrDefault(se10.modify(o_orderkey)));
                      (/*if */(l3 > 100L) ? agg3 += 1L : 0L);
                      QUERY18.addOrDelOnZero(se3.modify(c_name,c_custkey,o_orderkey,o_orderdate,o_totalprice),(v5 * (v6 * agg3)));
                      n6 = n6->nxt;
                    } while (n6 && (e6 = n6->obj) && h2 == n6->hash &&  QUERY18LINEITEM1_mapkey0_idxfn::equals(se11, *e6)); 
                  }
                }
              n5 = n5->nxt;
            }
          ...
          const HashIndex_QUERY18LINEITEM1_DELTA_map_0* i7 = static_cast<HashIndex_QUERY18LINEITEM1_DELTA_map_0*>(QUERY18LINEITEM1_DELTA.index[0]);
          HashIndex_QUERY18LINEITEM1_DELTA_map_0::IdxNode* n7; 
          QUERY18LINEITEM1_DELTA_entry* e7;
          ...
          for (size_t i = 0; i < i7->size_; i++)
          {
            ...
            while (n7 && (e7 = n7->obj))
            {
                ...
                { //slice 
                  const HashIndex_QUERY18LINEITEM1CUSTOMER1_map_0* i8 = static_cast<HashIndex_QUERY18LINEITEM1CUSTOMER1_map_0*>(QUERY18LINEITEM1CUSTOMER1.index[1]);
                  const HASH_RES_t h3 = QUERY18LINEITEM1CUSTOMER1_mapkey0_idxfn::hash(se13.modify0(o_orderkey));
                  HashIndex_QUERY18LINEITEM1CUSTOMER1_map_0::IdxNode* n8 = static_cast<HashIndex_QUERY18LINEITEM1CUSTOMER1_map_0::IdxNode*>(i8->slice(se13, h3));
                  QUERY18LINEITEM1CUSTOMER1_entry* e8;
                  ...
                  if (n8 && (e8 = n8->obj)) {
                    do {                
                      ...
                      long v8 = e8->__av;
                      QUERY18CUSTOMER1.addOrDelOnZero(se12.modify(o_orderkey,c_custkey,o_totalprice,o_orderdate),(v7 * v8));
                      n8 = n8->nxt;
                    } while (n8 && (e8 = n8->obj) && h3 == n8->hash &&  QUERY18LINEITEM1CUSTOMER1_mapkey0_idxfn::equals(se13, *e8)); 
                  }
                }
              n7 = n7->nxt;
            }
          ...
          const HashIndex_QUERY18LINEITEM1_DELTA_map_0* i9 = static_cast<HashIndex_QUERY18LINEITEM1_DELTA_map_0*>(QUERY18LINEITEM1_DELTA.index[0]);
          HashIndex_QUERY18LINEITEM1_DELTA_map_0::IdxNode* n9; 
          QUERY18LINEITEM1_DELTA_entry* e9;
          ...
          for (size_t i = 0; i < i9->size_; i++)
          {
            ...
            while (n9 && (e9 = n9->obj))
            {
                ...
                QUERY18CUSTOMER1_L1_1.addOrDelOnZero(se14.modify(o_orderkey),v9);
              n9 = n9->nxt;
            }
          }
        }
      ...
      { 
        ...
        {  
          for (size_t i = 0; i < DELTA_ORDERS.size; i++) 
          {
                ...
                long v10 = 1L;
                QUERY18ORDERS1_DELTA.addOrDelOnZero(se15.modify(o_orderkey,c_custkey,o_totalprice,o_orderdate),v10);            
          }
        }
        ...
        {  // foreach
          ...
          for (size_t i = 0; i < i11->size_; i++)
          {
            ...
            while (n11 && (e11 = n11->obj))
            {
                ...
                { //slice 
                  ...
                  const HASH_RES_t h4 = QUERY18ORDERS1_P_1_mapkey0_idxfn::hash(se19.modify0(c_custkey));
                  HashIndex_QUERY18ORDERS1_P_1_map_0::IdxNode* n12 = static_cast<HashIndex_QUERY18ORDERS1_P_1_map_0::IdxNode*>(i12->slice(se19, h4));
                  ...
                  if (n12 && (e12 = n12->obj)) {
                    do {                
                      ...
                      long v12 = e12->__av;
                      long agg4 = 0L;
                      DOUBLE_TYPE l4 = QUERY18CUSTOMER1_L1_1.getValueOrDefault(se18.modify(o_orderkey));
                      (/*if */(l4 > 100L) ? agg4 += 1L : 0L);
                      QUERY18.addOrDelOnZero(se16.modify(c_name,c_custkey,o_orderkey,o_orderdate,o_totalprice),(v11 * (QUERY18CUSTOMER1_L1_1.getValueOrDefault(se17.modify(o_orderkey)) * (v12 * agg4))));
                      n12 = n12->nxt;
                    } while (n12 && (e12 = n12->obj) && h4 == n12->hash &&  QUERY18ORDERS1_P_1_mapkey0_idxfn::equals(se19, *e12)); 
                  }
                }
              n11 = n11->nxt;
            }
          ...
          for (size_t i = 0; i < i13->size_; i++)
          {
            ...
            while (n13 && (e13 = n13->obj))
            {
                ...
                { //slice 
                  ...
                  const HASH_RES_t h5 = QUERY18ORDERS1_P_1_mapkey0_idxfn::hash(se21.modify0(c_custkey));
                  HashIndex_QUERY18ORDERS1_P_1_map_0::IdxNode* n14 = static_cast<HashIndex_QUERY18ORDERS1_P_1_map_0::IdxNode*>(i14->slice(se21, h5));
                  ...
                  if (n14 && (e14 = n14->obj)) {
                    do {                
                      ...
                      long v14 = e14->__av;
                      QUERY18LINEITEM1.addOrDelOnZero(se20.modify(o_orderkey,c_custkey,o_totalprice,o_orderdate,c_name),(v13 * v14));
                      n14 = n14->nxt;
                    } while (n14 && (e14 = n14->obj) && h5 == n14->hash &&  QUERY18ORDERS1_P_1_mapkey0_idxfn::equals(se21, *e14)); 
                  }
                }
              n13 = n13->nxt;
            }
          ...
          for (size_t i = 0; i < i15->size_; i++)
          {
            ...
            while (n15 && (e15 = n15->obj))
            {
                ...
                long v15 = e15->__av;
                QUERY18LINEITEM1CUSTOMER1.addOrDelOnZero(se22.modify(o_orderkey,c_custkey,o_totalprice,o_orderdate),v15);
              n15 = n15->nxt;
            }
          }
        }{  // foreach
          ...
          for (size_t i = 0; i < i16->size_; i++)
          {
            ...
            while (n16 && (e16 = n16->obj))
            {
                ...
                long v16 = e16->__av;
                QUERY18CUSTOMER1.addOrDelOnZero(se23.modify(o_orderkey,c_custkey,o_totalprice,o_orderdate),(v16 * QUERY18CUSTOMER1_L1_1.getValueOrDefault(se24.modify(o_orderkey))));
              n16 = n16->nxt;
            }
          }
        }
      ...
      { 
        ...
        {  
          for (size_t i = 0; i < DELTA_CUSTOMER.size; i++) 
          {
                ...
                long v17 = 1L;
                QUERY18CUSTOMER1_DELTA.addOrDelOnZero(se25.modify(c_custkey,c_name),v17);
          }
        }
        ...
        {  // foreach
          ...
          for (size_t i = 0; i < i18->size_; i++)
          {
            ...
            while (n18 && (e18 = n18->obj))
            {
                ...
                { //slice 
                  ...
                  const HASH_RES_t h6 = QUERY18CUSTOMER1_mapkey1_idxfn::hash(se28.modify1(c_custkey));
                  HashIndex_QUERY18CUSTOMER1_map_1::IdxNode* n19 = static_cast<HashIndex_QUERY18CUSTOMER1_map_1::IdxNode*>(i19->slice(se28, h6));
                  ...
                  if (n19 && (e19 = n19->obj)) {
                    do {                
                      ...
                      long agg5 = 0L;
                      DOUBLE_TYPE l5 = QUERY18CUSTOMER1_L1_1.getValueOrDefault(se27.modify(o_orderkey));
                      (/*if */(l5 > 100L) ? agg5 += 1L : 0L);
                      QUERY18.addOrDelOnZero(se26.modify(c_name,c_custkey,o_orderkey,o_orderdate,o_totalprice),(v18 * (v19 * agg5)));
                      n19 = n19->nxt;
                    } while (n19 && (e19 = n19->obj) && h6 == n19->hash &&  QUERY18CUSTOMER1_mapkey1_idxfn::equals(se28, *e19)); 
                  }
                }
              n18 = n18->nxt;
            }
          ...
          for (size_t i = 0; i < i20->size_; i++)
          {
            ...
            while (n20 && (e20 = n20->obj))
            {
                ...
                long v20 = e20->__av;
                { //slice 
                  const HashIndex_QUERY18LINEITEM1CUSTOMER1_map_1* i21 = static_cast<HashIndex_QUERY18LINEITEM1CUSTOMER1_map_1*>(QUERY18LINEITEM1CUSTOMER1.index[2]);
                  const HASH_RES_t h7 = QUERY18LINEITEM1CUSTOMER1_mapkey1_idxfn::hash(se30.modify1(c_custkey));
                  HashIndex_QUERY18LINEITEM1CUSTOMER1_map_1::IdxNode* n21 = static_cast<HashIndex_QUERY18LINEITEM1CUSTOMER1_map_1::IdxNode*>(i21->slice(se30, h7));
                  QUERY18LINEITEM1CUSTOMER1_entry* e21;
                  ...
                  if (n21 && (e21 = n21->obj)) {
                    do {                
                      ...
                      long v21 = e21->__av;
                      QUERY18LINEITEM1.addOrDelOnZero(se29.modify(o_orderkey,c_custkey,o_totalprice,o_orderdate,c_name),(v20 * v21));
                      n21 = n21->nxt;
                    } while (n21 && (e21 = n21->obj) && h7 == n21->hash &&  QUERY18LINEITEM1CUSTOMER1_mapkey1_idxfn::equals(se30, *e21)); 
                  }
                }
              n20 = n20->nxt;
            }
          ...
          for (size_t i = 0; i < i22->size_; i++)
          {
            ...
            while (n22 && (e22 = n22->obj))
            {
                ...
                long v22 = e22->__av;
                QUERY18ORDERS1_P_1.addOrDelOnZero(se31.modify(c_custkey,c_name),v22);
              n22 = n22->nxt;
            }
          }
        }
  ...
  private:
    ...
    QUERY18LINEITEM2_DOMAIN1_entry se1;
    QUERY18LINEITEM1_DELTA_entry se2;
    QUERY18_entry se3;
    QUERY18CUSTOMER1_L1_1_entry se4;
    QUERY18CUSTOMER1_L1_1_entry se5;
    QUERY18LINEITEM1_DELTA_entry se6;
    QUERY18CUSTOMER1_L1_1_entry se7;
    QUERY18LINEITEM1_entry se8;
    QUERY18CUSTOMER1_L1_1_entry se9;
    QUERY18LINEITEM1_DELTA_entry se10;
    QUERY18LINEITEM1_entry se11;
    QUERY18CUSTOMER1_entry se12;
    QUERY18LINEITEM1CUSTOMER1_entry se13;
    QUERY18CUSTOMER1_L1_1_entry se14;
    QUERY18ORDERS1_DELTA_entry se15;
    QUERY18_entry se16;
    QUERY18CUSTOMER1_L1_1_entry se17;
    QUERY18CUSTOMER1_L1_1_entry se18;
    QUERY18ORDERS1_P_1_entry se19;
    QUERY18LINEITEM1_entry se20;
    QUERY18ORDERS1_P_1_entry se21;
    QUERY18LINEITEM1CUSTOMER1_entry se22;
    QUERY18CUSTOMER1_entry se23;
    QUERY18CUSTOMER1_L1_1_entry se24;
    QUERY18CUSTOMER1_DELTA_entry se25;
    QUERY18_entry se26;
    QUERY18CUSTOMER1_L1_1_entry se27;
    QUERY18CUSTOMER1_entry se28;
    QUERY18LINEITEM1_entry se29;
    QUERY18LINEITEM1CUSTOMER1_entry se30;
    QUERY18ORDERS1_P_1_entry se31;
  
    /* Data structures used for storing materialized views */
    QUERY18LINEITEM1_DELTA_map QUERY18LINEITEM1_DELTA;
    QUERY18LINEITEM1_map QUERY18LINEITEM1;
    QUERY18LINEITEM1CUSTOMER1_map QUERY18LINEITEM1CUSTOMER1;
    QUERY18LINEITEM2_DOMAIN1_map QUERY18LINEITEM2_DOMAIN1;
