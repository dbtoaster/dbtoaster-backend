...
object TpccXactGenerator_SC {
  ...
  class Prog(val Context: StoreDSL, val numWare: Int) extends DBToasterSquidBinding(Context) {
    ...
    val xactCnt = Sym.freshNamed[Array[Int]]("xactCounts")
    ...
    def newOrderTxParallel(showOutput: Rep[Boolean], datetime: Rep[Date], t_num: Rep[Int], w_id: Rep[Int], d_id: Rep[Int], c_id: Rep[Int], o_ol_count: Rep[Int], o_all_local: Rep[Int], itemid: Rep[Array[Int]], supware: Rep[Array[Int]], quantity: Rep[Array[Int]], price: Rep[Array[Double]], iname: Rep[Array[String]], stock: Rep[Array[Int]], bg: Rep[Array[String]], amt: Rep[Array[Double]]): Rep[Int] = {
      if (codeForOutput) {
        ir"""
                    if($showOutput) println("Started NewOrder transaction for warehouse=%d, district=%d, customer=%d".format($w_id, $d_id, $c_id))
                  """
    ...
    def paymentTxParallel(showOutput: Rep[Boolean], datetime: Rep[Date], t_num: Rep[Int], w_id: Rep[Int], d_id: Rep[Int], c_by_name: Rep[Int], c_w_id: Rep[Int], c_d_id: Rep[Int], c_id: Rep[Int], c_last_input: Rep[String], h_amount: Rep[Double]): Rep[Int] = {
      ir {
        var local_c_id = 0
