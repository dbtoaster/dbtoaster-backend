...
object Rid {
  ...
  def execute(args:Array[String],f:List[Any]=>Unit) = bench(args,(d:String,p:Int,t:Long,b:Int,no_output:Boolean)=>runLocal[RidMaster,RidWorker](args)(streams(d),p,t),f)
