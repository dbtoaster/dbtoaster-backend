...
Runtime: it is possible to collect statistics to optimize triggers according to map loads at runtime. The runtime engine needs to bundle the code generator and compiler. This should be a long-term optimization.
