...
\subsubsection*{Iterative computations (and unstratified programs)}
...
\item Remotely: ensure all messages of that step have been processed (have a step-specific distributed acknowledgement counter?), see distribution model
\ole
