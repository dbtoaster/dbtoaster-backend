...
namespace dbtoaster {
  ...
  struct INVENTORY_entry {
    ...
    explicit INVENTORY_entry() : nxt(nullptr), prv(nullptr) { /*locn = 0L; dateid = 0L; ksn = 0.0; inventoryunits = 0.0; __av = 0L; */ }
  ...
  typedef MultiHashMap<INVENTORY_entry, long, 
    HashIndex<INVENTORY_entry, long, INVENTORY_mapkey0123_idxfn, true>
  > INVENTORY_map;
  typedef HashIndex<INVENTORY_entry, long, INVENTORY_mapkey0123_idxfn, true> HashIndex_INVENTORY_map_0123;
  ...
  struct AGG_Inventory_entry {
    long locn; long dateid; DOUBLE_TYPE ksn; long Deg_inventoryunits; DOUBLE_TYPE __av;  AGG_Inventory_entry* nxt; AGG_Inventory_entry* prv;
    explicit AGG_Inventory_entry() : nxt(nullptr), prv(nullptr) { /*locn = 0L; dateid = 0L; ksn = 0.0; Deg_inventoryunits = 0L; __av = 0.0; */ }
    explicit AGG_Inventory_entry(const long c0, const long c1, const DOUBLE_TYPE c2, const long c3, const DOUBLE_TYPE c4) { locn = c0; dateid = c1; ksn = c2; Deg_inventoryunits = c3; __av = c4; }
    AGG_Inventory_entry(const AGG_Inventory_entry& other) : locn( other.locn ), dateid( other.dateid ), ksn( other.ksn ), Deg_inventoryunits( other.Deg_inventoryunits ), __av( other.__av ), nxt( nullptr ), prv( nullptr ) {}
    FORCE_INLINE AGG_Inventory_entry& modify(const long c0, const long c1, const DOUBLE_TYPE c2, const long c3) { locn = c0; dateid = c1; ksn = c2; Deg_inventoryunits = c3;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct AGG_Inventory_mapkey0123_idxfn {
  ...
  typedef MultiHashMap<AGG_Inventory_entry, DOUBLE_TYPE, 
    HashIndex<AGG_Inventory_entry, DOUBLE_TYPE, AGG_Inventory_mapkey0123_idxfn, true>
  > AGG_Inventory_map;
  typedef HashIndex<AGG_Inventory_entry, DOUBLE_TYPE, AGG_Inventory_mapkey0123_idxfn, true> HashIndex_AGG_Inventory_map_0123;
  ...
  struct AGG_InIt_entry {
    long locn; long dateid; long Deg_ksn; long Deg_inventoryunits; long Deg_subcategory; long Deg_category; long Deg_categoryCluster; long Deg_prize; DOUBLE_TYPE __av;  AGG_InIt_entry* nxt; AGG_InIt_entry* prv;
    explicit AGG_InIt_entry() : nxt(nullptr), prv(nullptr) { /*locn = 0L; dateid = 0L; Deg_ksn = 0L; Deg_inventoryunits = 0L; Deg_subcategory = 0L; Deg_category = 0L; Deg_categoryCluster = 0L; Deg_prize = 0L; __av = 0.0; */ }
    explicit AGG_InIt_entry(const long c0, const long c1, const long c2, const long c3, const long c4, const long c5, const long c6, const long c7, const DOUBLE_TYPE c8) { locn = c0; dateid = c1; Deg_ksn = c2; Deg_inventoryunits = c3; Deg_subcategory = c4; Deg_category = c5; Deg_categoryCluster = c6; Deg_prize = c7; __av = c8; }
    AGG_InIt_entry(const AGG_InIt_entry& other) : locn( other.locn ), dateid( other.dateid ), Deg_ksn( other.Deg_ksn ), Deg_inventoryunits( other.Deg_inventoryunits ), Deg_subcategory( other.Deg_subcategory ), Deg_category( other.Deg_category ), Deg_categoryCluster( other.Deg_categoryCluster ), Deg_prize( other.Deg_prize ), __av( other.__av ), nxt( nullptr ), prv( nullptr ) {}
    FORCE_INLINE AGG_InIt_entry& modify(const long c0, const long c1, const long c2, const long c3, const long c4, const long c5, const long c6, const long c7) { locn = c0; dateid = c1; Deg_ksn = c2; Deg_inventoryunits = c3; Deg_subcategory = c4; Deg_category = c5; Deg_categoryCluster = c6; Deg_prize = c7;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct AGG_InIt_mapkey01234567_idxfn {
    FORCE_INLINE static size_t hash(const AGG_InIt_entry& e) {
      size_t h = 0;
      hash_combine(h, e.locn);
      hash_combine(h, e.dateid);
    ...
    FORCE_INLINE static bool equals(const AGG_InIt_entry& x, const AGG_InIt_entry& y) {
  ...
  typedef MultiHashMap<AGG_InIt_entry, DOUBLE_TYPE, 
    HashIndex<AGG_InIt_entry, DOUBLE_TYPE, AGG_InIt_mapkey01234567_idxfn, true>
  > AGG_InIt_map;
  typedef HashIndex<AGG_InIt_entry, DOUBLE_TYPE, AGG_InIt_mapkey01234567_idxfn, true> HashIndex_AGG_InIt_map_01234567;
  
  struct AGG_InItW_entry {
    long locn; long Deg_dateid; long Deg_ksn; long Deg_inventoryunits; long Deg_subcategory; long Deg_category; long Deg_categoryCluster; long Deg_prize; long Deg_rain; long Deg_snow; long Deg_maxtemp; long Deg_mintemp; long Deg_meanwind; long Deg_thunder; DOUBLE_TYPE __av;  AGG_InItW_entry* nxt; AGG_InItW_entry* prv;
    explicit AGG_InItW_entry() : nxt(nullptr), prv(nullptr) { /*locn = 0L; Deg_dateid = 0L; Deg_ksn = 0L; Deg_inventoryunits = 0L; Deg_subcategory = 0L; Deg_category = 0L; Deg_categoryCluster = 0L; Deg_prize = 0L; Deg_rain = 0L; Deg_snow = 0L; Deg_maxtemp = 0L; Deg_mintemp = 0L; Deg_meanwind = 0L; Deg_thunder = 0L; __av = 0.0; */ }
    explicit AGG_InItW_entry(const long c0, const long c1, const long c2, const long c3, const long c4, const long c5, const long c6, const long c7, const long c8, const long c9, const long c10, const long c11, const long c12, const long c13, const DOUBLE_TYPE c14) { locn = c0; Deg_dateid = c1; Deg_ksn = c2; Deg_inventoryunits = c3; Deg_subcategory = c4; Deg_category = c5; Deg_categoryCluster = c6; Deg_prize = c7; Deg_rain = c8; Deg_snow = c9; Deg_maxtemp = c10; Deg_mintemp = c11; Deg_meanwind = c12; Deg_thunder = c13; __av = c14; }
    AGG_InItW_entry(const AGG_InItW_entry& other) : locn( other.locn ), Deg_dateid( other.Deg_dateid ), Deg_ksn( other.Deg_ksn ), Deg_inventoryunits( other.Deg_inventoryunits ), Deg_subcategory( other.Deg_subcategory ), Deg_category( other.Deg_category ), Deg_categoryCluster( other.Deg_categoryCluster ), Deg_prize( other.Deg_prize ), Deg_rain( other.Deg_rain ), Deg_snow( other.Deg_snow ), Deg_maxtemp( other.Deg_maxtemp ), Deg_mintemp( other.Deg_mintemp ), Deg_meanwind( other.Deg_meanwind ), Deg_thunder( other.Deg_thunder ), __av( other.__av ), nxt( nullptr ), prv( nullptr ) {}
    FORCE_INLINE AGG_InItW_entry& modify(const long c0, const long c1, const long c2, const long c3, const long c4, const long c5, const long c6, const long c7, const long c8, const long c9, const long c10, const long c11, const long c12, const long c13) { locn = c0; Deg_dateid = c1; Deg_ksn = c2; Deg_inventoryunits = c3; Deg_subcategory = c4; Deg_category = c5; Deg_categoryCluster = c6; Deg_prize = c7; Deg_rain = c8; Deg_snow = c9; Deg_maxtemp = c10; Deg_mintemp = c11; Deg_meanwind = c12; Deg_thunder = c13;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct AGG_InItW_mapkey012345678910111213_idxfn {
    FORCE_INLINE static size_t hash(const AGG_InItW_entry& e) {
      size_t h = 0;
      hash_combine(h, e.locn);
    ...
    FORCE_INLINE static bool equals(const AGG_InItW_entry& x, const AGG_InItW_entry& y) {
  ...
  typedef MultiHashMap<AGG_InItW_entry, DOUBLE_TYPE, 
    HashIndex<AGG_InItW_entry, DOUBLE_TYPE, AGG_InItW_mapkey012345678910111213_idxfn, true>
  > AGG_InItW_map;
  typedef HashIndex<AGG_InItW_entry, DOUBLE_TYPE, AGG_InItW_mapkey012345678910111213_idxfn, true> HashIndex_AGG_InItW_map_012345678910111213;
  ...
  struct data_t : tlq_t{
    ...
    void on_insert_INVENTORY(const long locn, const long dateid, const DOUBLE_TYPE ksn, const DOUBLE_TYPE inventoryunits) {
      INVENTORY_entry e(locn, dateid, ksn, inventoryunits, 1L);
      INVENTORY.addOrDelOnZero(e,1L);
    }
    ...
    void on_system_ready_event() {
      ...
      AGG_Inventory.clear();
      { //foreach
        INVENTORY_entry* e1 = INVENTORY.head;
        while (e1) {
          long locn = e1->locn;
          ...
          { //foreach
            ...
            while (e2) {
              ...
              long v2 = e2->__av;
              AGG_Inventory.addOrDelOnZero(se1.modify(locn, dateid, ksn, deg_inventoryunits), (v1 * (v2 * ((/*if */(deg_inventoryunits == 0L) ? 1L : 0L) + ((/*if */(deg_inventoryunits == 1L) ? inventoryunits : 0.0) + (/*if */(deg_inventoryunits == 2L) ? (inventoryunits * inventoryunits) : 0.0))))));
              e2 = e2->nxt;
            }
          }
          e1 = e1->nxt;
      ...
      { //foreach
        ...
        while (e7) {
          ...
          long v7 = e7->__av;
          { //foreach
            DEGREE4_entry* e8 = DEGREE4.head;
            while (e8) {
              long deg_subcategory = e8->Deg1;
              long deg_category = e8->Deg2;
              long deg_categorycluster = e8->Deg3;
              long deg_prize = e8->Deg4;
              long v8 = e8->__av;
              AGG_Item.addOrDelOnZero(se4.modify(ksn, deg_subcategory, deg_category, deg_categorycluster, deg_prize), (v7 * (v8 * (((/*if */(deg_subcategory == 0L) ? 1L : 0L) + ((/*if */(deg_subcategory == 1L) ? subcategory : 0L) + (/*if */(deg_subcategory == 2L) ? (subcategory * subcategory) : 0L))) * (((/*if */(deg_category == 0L) ? 1L : 0L) + ((/*if */(deg_category == 1L) ? category : 0L) + (/*if */(deg_category == 2L) ? (category * category) : 0L))) * (((/*if */(deg_categorycluster == 0L) ? 1L : 0L) + ((/*if */(deg_categorycluster == 1L) ? categorycluster : 0L) + (/*if */(deg_categorycluster == 2L) ? (categorycluster * categorycluster) : 0L))) * ((/*if */(deg_prize == 0L) ? 1L : 0L) + ((/*if */(deg_prize == 1L) ? prize : 0.0) + (/*if */(deg_prize == 2L) ? (prize * prize) : 0.0)))))))));
              e8 = e8->nxt;
            }
          }
          e7 = e7->nxt;
      ...
      { //foreach
        ...
        while (e9) {
          ...
          long v9 = e9->__av;
          { //foreach
            DEGREE6_entry* e10 = DEGREE6.head;
            while (e10) {
              long deg_rain = e10->Deg1;
              long deg_snow = e10->Deg2;
              long deg_maxtemp = e10->Deg3;
              long deg_mintemp = e10->Deg4;
              long deg_meanwind = e10->Deg5;
              long deg_thunder = e10->Deg6;
              long v10 = e10->__av;
              AGG_Weather.addOrDelOnZero(se5.modify(locn, dateid, deg_rain, deg_snow, deg_maxtemp, deg_mintemp, deg_meanwind, deg_thunder), (v9 * (v10 * (((/*if */(deg_rain == 0L) ? 1L : 0L) + ((/*if */(deg_rain == 1L) ? rain : 0L) + (/*if */(deg_rain == 2L) ? (rain * rain) : 0L))) * (((/*if */(deg_snow == 0L) ? 1L : 0L) + ((/*if */(deg_snow == 1L) ? snow : 0L) + (/*if */(deg_snow == 2L) ? (snow * snow) : 0L))) * (((/*if */(deg_maxtemp == 0L) ? 1L : 0L) + ((/*if */(deg_maxtemp == 1L) ? maxtemp : 0L) + (/*if */(deg_maxtemp == 2L) ? (maxtemp * maxtemp) : 0L))) * (((/*if */(deg_mintemp == 0L) ? 1L : 0L) + ((/*if */(deg_mintemp == 1L) ? mintemp : 0L) + (/*if */(deg_mintemp == 2L) ? (mintemp * mintemp) : 0L))) * (((/*if */(deg_meanwind == 0L) ? 1L : 0L) + ((/*if */(deg_meanwind == 1L) ? meanwind : 0.0) + (/*if */(deg_meanwind == 2L) ? (meanwind * meanwind) : 0.0))) * ((/*if */(deg_thunder == 0L) ? 1L : 0L) + ((/*if */(deg_thunder == 1L) ? thunder : 0L) + (/*if */(deg_thunder == 2L) ? (thunder * thunder) : 0L)))))))))));
              e10 = e10->nxt;
            }
          }
          e9 = e9->nxt;
      ...
      { //foreach
        ...
        while (e11) {
          long locn = e11->locn;
          long zip = e11->zip;
          long deg_rgn_cd = e11->Deg_rgn_cd;
          long deg_clim_zn_nbr = e11->Deg_clim_zn_nbr;
          long deg_tot_area_sq_ft = e11->Deg_tot_area_sq_ft;
          long deg_sell_area_sq_ft = e11->Deg_sell_area_sq_ft;
          long deg_avghhi = e11->Deg_avghhi;
          long deg_supertargetdistance = e11->Deg_supertargetdistance;
          long deg_supertargetdrivetime = e11->Deg_supertargetdrivetime;
          long deg_targetdistance = e11->Deg_targetdistance;
          long deg_targetdrivetime = e11->Deg_targetdrivetime;
          long deg_walmartdistance = e11->Deg_walmartdistance;
          long deg_walmartdrivetime = e11->Deg_walmartdrivetime;
          long deg_walmartsupercenterdistance = e11->Deg_walmartsupercenterdistance;
          long deg_walmartsupercenterdrivetime = e11->Deg_walmartsupercenterdrivetime;
          DOUBLE_TYPE v11 = e11->__av;
          { //slice
            const HASH_RES_t h1 = AGG_Census_mapkey0_idxfn::hash(se7.modify0(zip));
            const HashIndex_AGG_Census_map_0* i12 = static_cast<HashIndex_AGG_Census_map_0*>(AGG_Census.index[1]);
            HashIndex_AGG_Census_map_0::IdxNode* n12 = &(i12->buckets_[h1 % i12->size_]);
            AGG_Census_entry* e12;
            do if ((e12 = n12->obj) && h1 == n12->hash && AGG_Census_mapkey0_idxfn::equals(se7, *e12)) {
              long deg_population = e12->Deg_population;
              long deg_white = e12->Deg_white;
              long deg_asian = e12->Deg_asian;
              long deg_pacific = e12->Deg_pacific;
              long deg_blackafrican = e12->Deg_blackafrican;
              long deg_medianage = e12->Deg_medianage;
              long deg_occupiedhouseunits = e12->Deg_occupiedhouseunits;
              long deg_houseunits = e12->Deg_houseunits;
              long deg_families = e12->Deg_families;
              long deg_households = e12->Deg_households;
              long deg_husbwife = e12->Deg_husbwife;
              long deg_males = e12->Deg_males;
              long deg_females = e12->Deg_females;
              long deg_householdschildren = e12->Deg_householdschildren;
              long deg_hispanic = e12->Deg_hispanic;
              DOUBLE_TYPE v12 = e12->__av;
              { //foreach
                DEGREE1_entry* e13 = DEGREE1.head;
                while (e13) {
                  long deg_zip = e13->Deg;
                  long v13 = e13->__av;
                  (/*if */(2L >= (deg_zip + (deg_rgn_cd + (deg_clim_zn_nbr + (deg_tot_area_sq_ft + (deg_sell_area_sq_ft + (deg_avghhi + (deg_supertargetdistance + (deg_supertargetdrivetime + (deg_targetdistance + (deg_targetdrivetime + (deg_walmartdistance + (deg_walmartdrivetime + (deg_walmartsupercenterdistance + (deg_walmartsupercenterdrivetime + (deg_population + (deg_white + (deg_asian + (deg_pacific + (deg_blackafrican + (deg_medianage + (deg_occupiedhouseunits + (deg_houseunits + (deg_families + (deg_households + (deg_husbwife + (deg_males + (deg_females + (deg_householdschildren + deg_hispanic))))))))))))))))))))))))))))) ? AGG_LC.addOrDelOnZero(se6.modify(locn, deg_zip, deg_rgn_cd, deg_clim_zn_nbr, deg_tot_area_sq_ft, deg_sell_area_sq_ft, deg_avghhi, deg_supertargetdistance, deg_supertargetdrivetime, deg_targetdistance, deg_targetdrivetime, deg_walmartdistance, deg_walmartdrivetime, deg_walmartsupercenterdistance, deg_walmartsupercenterdrivetime, deg_population, deg_white, deg_asian, deg_pacific, deg_blackafrican, deg_medianage, deg_occupiedhouseunits, deg_houseunits, deg_families, deg_households, deg_husbwife, deg_males, deg_females, deg_householdschildren, deg_hispanic), (v11 * (v12 * (v13 * ((/*if */(deg_zip == 0L) ? 1L : 0L) + ((/*if */(deg_zip == 1L) ? zip : 0L) + (/*if */(deg_zip == 2L) ? (zip * zip) : 0L))))))) : (void)0);
                  e13 = e13->nxt;
                }
              }
            } while ((n12 = n12->nxt));
      ...
      AGG_InIt.clear();
      { //foreach
        AGG_Inventory_entry* e14 = AGG_Inventory.head;
        while (e14) {
          long locn = e14->locn;
          long dateid = e14->dateid;
          DOUBLE_TYPE ksn = e14->ksn;
          long deg_inventoryunits = e14->Deg_inventoryunits;
          DOUBLE_TYPE v14 = e14->__av;
          { //slice
            const HASH_RES_t h2 = AGG_Item_mapkey0_idxfn::hash(se9.modify0(ksn));
            const HashIndex_AGG_Item_map_0* i15 = static_cast<HashIndex_AGG_Item_map_0*>(AGG_Item.index[1]);
            HashIndex_AGG_Item_map_0::IdxNode* n15 = &(i15->buckets_[h2 % i15->size_]);
            AGG_Item_entry* e15;
            do if ((e15 = n15->obj) && h2 == n15->hash && AGG_Item_mapkey0_idxfn::equals(se9, *e15)) {
              long deg_subcategory = e15->Deg_subcategory;
              long deg_category = e15->Deg_category;
              long deg_categorycluster = e15->Deg_categoryCluster;
              long deg_prize = e15->Deg_prize;
              DOUBLE_TYPE v15 = e15->__av;
              { //foreach
                DEGREE1_entry* e16 = DEGREE1.head;
                while (e16) {
                  long deg_ksn = e16->Deg;
                  long v16 = e16->__av;
                  (/*if */(2L >= (deg_ksn + (deg_inventoryunits + (deg_subcategory + (deg_category + (deg_categorycluster + deg_prize)))))) ? AGG_InIt.addOrDelOnZero(se8.modify(locn, dateid, deg_ksn, deg_inventoryunits, deg_subcategory, deg_category, deg_categorycluster, deg_prize), (v14 * (v15 * (v16 * ((/*if */(deg_ksn == 0L) ? 1L : 0L) + ((/*if */(deg_ksn == 1L) ? ksn : 0.0) + (/*if */(deg_ksn == 2L) ? (ksn * ksn) : 0.0))))))) : (void)0);
                  e16 = e16->nxt;
                }
              }
            } while ((n15 = n15->nxt));
      ...
      AGG_InItW.clear();
      { //foreach
        AGG_InIt_entry* e17 = AGG_InIt.head;
        while (e17) {
          long locn = e17->locn;
          long dateid = e17->dateid;
          long deg_ksn = e17->Deg_ksn;
          long deg_inventoryunits = e17->Deg_inventoryunits;
          long deg_subcategory = e17->Deg_subcategory;
          long deg_category = e17->Deg_category;
          long deg_categorycluster = e17->Deg_categoryCluster;
          long deg_prize = e17->Deg_prize;
          DOUBLE_TYPE v17 = e17->__av;
          { //slice
            const HASH_RES_t h3 = AGG_Weather_mapkey01_idxfn::hash(se11.modify01(locn, dateid));
            const HashIndex_AGG_Weather_map_01* i18 = static_cast<HashIndex_AGG_Weather_map_01*>(AGG_Weather.index[1]);
            HashIndex_AGG_Weather_map_01::IdxNode* n18 = &(i18->buckets_[h3 % i18->size_]);
            AGG_Weather_entry* e18;
            do if ((e18 = n18->obj) && h3 == n18->hash && AGG_Weather_mapkey01_idxfn::equals(se11, *e18)) {
              long deg_rain = e18->Deg_rain;
              long deg_snow = e18->Deg_snow;
              long deg_maxtemp = e18->Deg_maxtemp;
              long deg_mintemp = e18->Deg_mintemp;
              long deg_meanwind = e18->Deg_meanwind;
              long deg_thunder = e18->Deg_thunder;
              DOUBLE_TYPE v18 = e18->__av;
              { //foreach
                DEGREE1_entry* e19 = DEGREE1.head;
                while (e19) {
                  long deg_dateid = e19->Deg;
                  long v19 = e19->__av;
                  (/*if */(2L >= (deg_dateid + (deg_ksn + (deg_inventoryunits + (deg_subcategory + (deg_category + (deg_categorycluster + (deg_prize + (deg_rain + (deg_snow + (deg_maxtemp + (deg_mintemp + (deg_meanwind + deg_thunder))))))))))))) ? AGG_InItW.addOrDelOnZero(se10.modify(locn, deg_dateid, deg_ksn, deg_inventoryunits, deg_subcategory, deg_category, deg_categorycluster, deg_prize, deg_rain, deg_snow, deg_maxtemp, deg_mintemp, deg_meanwind, deg_thunder), (v17 * (v18 * (v19 * ((/*if */(deg_dateid == 0L) ? 1L : 0L) + ((/*if */(deg_dateid == 1L) ? dateid : 0L) + (/*if */(deg_dateid == 2L) ? (dateid * dateid) : 0L))))))) : (void)0);
                  e19 = e19->nxt;
                }
              }
            } while ((n18 = n18->nxt));
      ...
      AGG.clear();
      { //foreach
        AGG_InItW_entry* e20 = AGG_InItW.head;
        while (e20) {
          long locn = e20->locn;
          long deg_dateid = e20->Deg_dateid;
          long deg_ksn = e20->Deg_ksn;
          long deg_inventoryunits = e20->Deg_inventoryunits;
          long deg_subcategory = e20->Deg_subcategory;
          long deg_category = e20->Deg_category;
          long deg_categorycluster = e20->Deg_categoryCluster;
          long deg_prize = e20->Deg_prize;
          long deg_rain = e20->Deg_rain;
          long deg_snow = e20->Deg_snow;
          long deg_maxtemp = e20->Deg_maxtemp;
          long deg_mintemp = e20->Deg_mintemp;
          long deg_meanwind = e20->Deg_meanwind;
          long deg_thunder = e20->Deg_thunder;
          DOUBLE_TYPE v20 = e20->__av;
          { //slice
            const HASH_RES_t h4 = AGG_LC_mapkey0_idxfn::hash(se13.modify0(locn));
            const HashIndex_AGG_LC_map_0* i21 = static_cast<HashIndex_AGG_LC_map_0*>(AGG_LC.index[1]);
            HashIndex_AGG_LC_map_0::IdxNode* n21 = &(i21->buckets_[h4 % i21->size_]);
            AGG_LC_entry* e21;
            do if ((e21 = n21->obj) && h4 == n21->hash && AGG_LC_mapkey0_idxfn::equals(se13, *e21)) {
              long deg_zip = e21->Deg_zip;
              long deg_rgn_cd = e21->Deg_rgn_cd;
              long deg_clim_zn_nbr = e21->Deg_clim_zn_nbr;
              long deg_tot_area_sq_ft = e21->Deg_tot_area_sq_ft;
              long deg_sell_area_sq_ft = e21->Deg_sell_area_sq_ft;
              long deg_avghhi = e21->Deg_avghhi;
              long deg_supertargetdistance = e21->Deg_supertargetdistance;
              long deg_supertargetdrivetime = e21->Deg_supertargetdrivetime;
              long deg_targetdistance = e21->Deg_targetdistance;
              long deg_targetdrivetime = e21->Deg_targetdrivetime;
              long deg_walmartdistance = e21->Deg_walmartdistance;
              long deg_walmartdrivetime = e21->Deg_walmartdrivetime;
              long deg_walmartsupercenterdistance = e21->Deg_walmartsupercenterdistance;
              long deg_walmartsupercenterdrivetime = e21->Deg_walmartsupercenterdrivetime;
              ...
              { //foreach
                ...
                while (e22) {
                  long deg_locn = e22->Deg;
                  long v22 = e22->__av;
                  (/*if */((deg_locn + (deg_dateid + (deg_ksn + (deg_inventoryunits + (deg_subcategory + (deg_category + (deg_categorycluster + (deg_prize + (deg_rain + (deg_snow + (deg_maxtemp + (deg_mintemp + (deg_meanwind + (deg_thunder + (deg_zip + (deg_rgn_cd + (deg_clim_zn_nbr + (deg_tot_area_sq_ft + (deg_sell_area_sq_ft + (deg_avghhi + (deg_supertargetdistance + (deg_supertargetdrivetime + (deg_targetdistance + (deg_targetdrivetime + (deg_walmartdistance + (deg_walmartdrivetime + (deg_walmartsupercenterdistance + (deg_walmartsupercenterdrivetime + (deg_population + (deg_white + (deg_asian + (deg_pacific + (deg_blackafrican + (deg_medianage + (deg_occupiedhouseunits + (deg_houseunits + (deg_families + (deg_households + (deg_husbwife + (deg_males + (deg_females + (deg_householdschildren + deg_hispanic)))))))))))))))))))))))))))))))))))))))))) == 2L) ? AGG.addOrDelOnZero(se12.modify(deg_locn, deg_dateid, deg_ksn, deg_inventoryunits, deg_subcategory, deg_category, deg_categorycluster, deg_prize, deg_rain, deg_snow, deg_maxtemp, deg_mintemp, deg_meanwind, deg_thunder, deg_zip, deg_rgn_cd, deg_clim_zn_nbr, deg_tot_area_sq_ft, deg_sell_area_sq_ft, deg_avghhi, deg_supertargetdistance, deg_supertargetdrivetime, deg_targetdistance, deg_targetdrivetime, deg_walmartdistance, deg_walmartdrivetime, deg_walmartsupercenterdistance, deg_walmartsupercenterdrivetime, deg_population, deg_white, deg_asian, deg_pacific, deg_blackafrican, deg_medianage, deg_occupiedhouseunits, deg_houseunits, deg_families, deg_households, deg_husbwife, deg_males, deg_females, deg_householdschildren, deg_hispanic), (v20 * (v21 * (v22 * ((/*if */(deg_locn == 0L) ? 1L : 0L) + ((/*if */(deg_locn == 1L) ? locn : 0L) + (/*if */(deg_locn == 2L) ? (locn * locn) : 0L))))))) : (void)0);
                  e22 = e22->nxt;
                }
              }
            } while ((n21 = n21->nxt));
  ...
  private:
    ...
    AGG_Inventory_entry se1;
    AGG_Location_entry se2;
    AGG_Census_entry se3;
    AGG_Item_entry se4;
    AGG_Weather_entry se5;
    AGG_LC_entry se6;
    AGG_Census_entry se7;
    AGG_InIt_entry se8;
    AGG_Item_entry se9;
    AGG_InItW_entry se10;
    ...
    AGG_LC_map AGG_LC;
    AGG_InIt_map AGG_InIt;
    AGG_InItW_map AGG_InItW;
