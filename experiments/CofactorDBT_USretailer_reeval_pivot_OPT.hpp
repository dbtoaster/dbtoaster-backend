...
namespace dbtoaster {
  ...
  typedef CUSTOM_AGG_value<CUSTOM_AGG_INVENTORY_SIZE> CUSTOM_AGG_Inventory_value;
  struct CUSTOM_AGG_Inventory_entry {
    long locn; 
    long dateid; 
    DOUBLE_TYPE ksn; 
    CUSTOM_AGG_Inventory_value __av;
    CUSTOM_AGG_Inventory_entry* nxt; 
    CUSTOM_AGG_Inventory_entry* prv;

    explicit CUSTOM_AGG_Inventory_entry() : nxt(nullptr), prv(nullptr) { }
  ...
  struct CUSTOM_AGG_Inventory_mapkey0123_idxfn {
    FORCE_INLINE static size_t hash(const CUSTOM_AGG_Inventory_entry& e) {
      size_t h = 0;
      hash_combine(h, e.locn);
      hash_combine(h, e.dateid);
      hash_combine(h, e.ksn);
    ...
    FORCE_INLINE static bool equals(const CUSTOM_AGG_Inventory_entry& x, const CUSTOM_AGG_Inventory_entry& y) {
      return x.locn == y.locn && x.dateid == y.dateid && x.ksn == y.ksn;
    }
  };

  typedef MultiHashMap<CUSTOM_AGG_Inventory_entry, CUSTOM_AGG_Inventory_value,
    HashIndex<CUSTOM_AGG_Inventory_entry, CUSTOM_AGG_Inventory_value, CUSTOM_AGG_Inventory_mapkey0123_idxfn, true>
  > CUSTOM_AGG_Inventory_map;
  ...
  typedef CUSTOM_AGG_value<CUSTOM_AGG_INVITEM_SIZE> CUSTOM_AGG_InvItem_value;
  struct CUSTOM_AGG_InvItem_entry {
    long locn; 
    long dateid;
    CUSTOM_AGG_InvItem_value __av;  
    CUSTOM_AGG_InvItem_entry* nxt; 
    CUSTOM_AGG_InvItem_entry* prv;

    explicit CUSTOM_AGG_InvItem_entry() : nxt(nullptr), prv(nullptr) { }
  ...
  struct CUSTOM_AGG_InvItem_mapkey01234567891011121314151617181920212223242526272829_idxfn {
    FORCE_INLINE static size_t hash(const CUSTOM_AGG_InvItem_entry& e) {
      size_t h = 0;
      hash_combine(h, e.locn);
      hash_combine(h, e.dateid);
      return h;
    ...
    FORCE_INLINE static bool equals(const CUSTOM_AGG_InvItem_entry& x, const CUSTOM_AGG_InvItem_entry& y) {
      return x.locn == y.locn && x.dateid == y.dateid;
    }
  };
   
  typedef MultiHashMap<CUSTOM_AGG_InvItem_entry, CUSTOM_AGG_InvItem_value,
    HashIndex<CUSTOM_AGG_InvItem_entry, CUSTOM_AGG_InvItem_value, CUSTOM_AGG_InvItem_mapkey01234567891011121314151617181920212223242526272829_idxfn, true>
  > CUSTOM_AGG_InvItem_map;


  typedef CUSTOM_AGG_value<CUSTOM_AGG_INVITEMWEAT_SIZE> CUSTOM_AGG_InvItemWeat_value;
  struct CUSTOM_AGG_InvItemWeat_entry {
    long locn; 
    CUSTOM_AGG_InvItemWeat_value __av;  
    CUSTOM_AGG_InvItemWeat_entry* nxt; 
    CUSTOM_AGG_InvItemWeat_entry* prv;

    explicit CUSTOM_AGG_InvItemWeat_entry() : nxt(nullptr), prv(nullptr) { }
  ...
  struct CUSTOM_AGG_InvItemWeat_mapkey01234567891011121314151617181920212223242526272829_idxfn {
    FORCE_INLINE static size_t hash(const CUSTOM_AGG_InvItemWeat_entry& e) {
      size_t h = 0;
      hash_combine(h, e.locn);
      return h;
    }

    FORCE_INLINE static bool equals(const CUSTOM_AGG_InvItemWeat_entry& x, const CUSTOM_AGG_InvItemWeat_entry& y) {
      return x.locn == y.locn;
    }
  };
   
  typedef MultiHashMap<CUSTOM_AGG_InvItemWeat_entry, CUSTOM_AGG_InvItemWeat_value,
    HashIndex<CUSTOM_AGG_InvItemWeat_entry, CUSTOM_AGG_InvItemWeat_value, CUSTOM_AGG_InvItemWeat_mapkey01234567891011121314151617181920212223242526272829_idxfn, true>
  > CUSTOM_AGG_InvItemWeat_map;
  ...
  protected:
    ...
    CUSTOM_AGG_Inventory_map CUSTOM_AGG_Inventory;
    ...
    CUSTOM_AGG_InvItem_map CUSTOM_AGG_InvItem;
    CUSTOM_AGG_InvItemWeat_map CUSTOM_AGG_InvItemWeat;
  };
      ...
      {  //
        ...
        { //foreach
          ...
          while(e1){
            ...
            CUSTOM_AGG_Inventory.addOrDelOnZero(custom_se1, custom_sv1);
        ...
        CUSTOM_AGG_InvItem.clear();
        { //foreach
          CUSTOM_AGG_Inventory_entry* e20 = CUSTOM_AGG_Inventory.head;
          while(e20){
            long locn = e20->locn;
            long dateid = e20->dateid;
            long ksn = e20->ksn;            
            const CUSTOM_AGG_Inventory_value &vInventory = e20->__av;
            ...
            CUSTOM_AGG_InvItem.addOrDelOnZero(custom_se7, custom_sv7);

            e20 = e20->nxt;            
          }
        }

        CUSTOM_AGG_InvItemWeat.clear();
        { //foreach
          CUSTOM_AGG_InvItem_entry* e20 = CUSTOM_AGG_InvItem.head;
          while(e20){
            long locn = e20->locn;
            long dateid = e20->dateid;
            const CUSTOM_AGG_InvItem_value &vInvItem = e20->__av;
            ...
            CUSTOM_AGG_InvItemWeat.addOrDelOnZero(custom_se8, custom_sv8);

            e20 = e20->nxt;            
          }
        }

        // CUSTOM_AGG_Output.clear();
        { //foreach
          CUSTOM_AGG_InvItemWeat_entry* e20 = CUSTOM_AGG_InvItemWeat.head;
          while(e20){
            long locn = e20->locn;
            const CUSTOM_AGG_InvItemWeat_value &vInvItemWeat = e20->__av;
        ...
        //     long count1 = e20->__av.count;
        //     long count2 = vItem.count;
        //     long count3 = vWeather.count;
        //     long count4 = vLC.count;

        //     CUSTOM_AGG_Output.count = count1 * count2 * count3 * count4;

        //     size_t indexOutput = 0;
        //     CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count2 * count3 * count4 * locn * locn;
        //     CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count2 * count3 * count4 * locn * dateid;
        //     CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count2 * count3 * count4 * locn * ksn;
        //     for (size_t i = 0; i < CUSTOM_AGG_INVENTORY_SIZE; i++) {
        //       CUSTOM_AGG_Output.cofactors[indexOutput++] += count2 * count3 * count4 * locn * vInventory.sums[i];
        //     }
        //     for (size_t i = 0; i < CUSTOM_AGG_ITEM_SIZE; i++) {
        //       CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count3 * count4 * locn * vItem.sums[i];
        //     }
        //     for (size_t i = 0; i < CUSTOM_AGG_WEATHER_SIZE; i++) {
        //       CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count2 * count4 * locn * vWeather.sums[i];
        //     }
        //     for (size_t i = 0; i < CUSTOM_AGG_LC_SIZE; i++) {
        //       CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count2 * count3 * locn * vLC.sums[i];
        //     }

        //     CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count2 * count3 * count4 * dateid * dateid;
        //     CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count2 * count3 * count4 * dateid * ksn;
        //     for (size_t i = 0; i < CUSTOM_AGG_INVENTORY_SIZE; i++) {
        //       CUSTOM_AGG_Output.cofactors[indexOutput++] += count2 * count3 * count4 * dateid * vInventory.sums[i];
        //     }
        //     for (size_t i = 0; i < CUSTOM_AGG_ITEM_SIZE; i++) {
        //       CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count3 * count4 * dateid * vItem.sums[i];
        //     }
        //     for (size_t i = 0; i < CUSTOM_AGG_WEATHER_SIZE; i++) {
        //       CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count2 * count4 * dateid * vWeather.sums[i];
        //     }
        //     for (size_t i = 0; i < CUSTOM_AGG_LC_SIZE; i++) {
        //       CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count2 * count3 * dateid * vLC.sums[i];
        //     }

        //     CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count2 * count3 * count4 * ksn * ksn;
        //     for (size_t i = 0; i < CUSTOM_AGG_INVENTORY_SIZE; i++) {
        //       CUSTOM_AGG_Output.cofactors[indexOutput++] += count2 * count3 * count4 * ksn * vInventory.sums[i];
        //     }
        //     for (size_t i = 0; i < CUSTOM_AGG_ITEM_SIZE; i++) {
        //       CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count3 * count4 * ksn * vItem.sums[i];
        //     }
        //     for (size_t i = 0; i < CUSTOM_AGG_WEATHER_SIZE; i++) {
        //       CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count2 * count4 * ksn * vWeather.sums[i];
        //     }
        //     for (size_t i = 0; i < CUSTOM_AGG_LC_SIZE; i++) {
        //       CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count2 * count3 * ksn * vLC.sums[i];
        //     }

        //     size_t indexInput = 0;
        //     for (size_t i = 0; i < CUSTOM_AGG_INVENTORY_SIZE; i++) {
        //       for (size_t j = i; j < CUSTOM_AGG_INVENTORY_SIZE; j++) {
        //         CUSTOM_AGG_Output.cofactors[indexOutput++] += count2 * count3 * count4 * vInventory.cofactors[indexInput++];
        //       }
        //       for (size_t j = 0; j < CUSTOM_AGG_ITEM_SIZE; j++) {
        //         CUSTOM_AGG_Output.cofactors[indexOutput++] += count3 * count4 * vInventory.sums[i] * vItem.sums[j]; 
        //       }
        //       for (size_t j = 0; j < CUSTOM_AGG_WEATHER_SIZE; j++) {
        //         CUSTOM_AGG_Output.cofactors[indexOutput++] += count2 * count4 * vInventory.sums[i] * vWeather.sums[j]; 
        //       }
        //       for (size_t j = 0; j < CUSTOM_AGG_LC_SIZE; j++) {
        //         CUSTOM_AGG_Output.cofactors[indexOutput++] += count2 * count3 * vInventory.sums[i] * vLC.sums[j]; 
        //       }
        //     }
        ...
        //     for (size_t i = 0; i < CUSTOM_AGG_ITEM_SIZE; i++) {
        //       for (size_t j = i; j < CUSTOM_AGG_ITEM_SIZE; j++) {
        //         CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count3 * count4 * vItem.cofactors[indexInput++];
        //       }
        //       for (size_t j = 0; j < CUSTOM_AGG_WEATHER_SIZE; j++) {
        //         CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count4 * vItem.sums[i] * vWeather.sums[j]; 
        //       }
        //       for (size_t j = 0; j < CUSTOM_AGG_LC_SIZE; j++) {
        //         CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count3 * vItem.sums[i] * vLC.sums[j]; 
        //       }
        //     }
        ...
        //     for (size_t i = 0; i < CUSTOM_AGG_WEATHER_SIZE; i++) {
        //       for (size_t j = i; j < CUSTOM_AGG_WEATHER_SIZE; j++) {
        //         CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count2 * count4 * vWeather.cofactors[indexInput++];
        //       }
        //       for (size_t j = 0; j < CUSTOM_AGG_LC_SIZE; j++) {
        //         CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count2 * vWeather.sums[i] * vLC.sums[j]; 
        //       }
        //     }

        //     indexInput = 0;
        //     for (size_t i = 0; i < CUSTOM_AGG_LC_SIZE; i++) {
        //       for (size_t j = i; j < CUSTOM_AGG_LC_SIZE; j++) {
        //         CUSTOM_AGG_Output.cofactors[indexOutput++] += count1 * count2 * count3 * vLC.cofactors[indexInput++];
        //       }
        //     }
  ...
  private:  
    ...
    CUSTOM_AGG_Inventory_entry custom_se1;
    ...
    CUSTOM_AGG_InvItem_entry custom_se7;
    CUSTOM_AGG_InvItemWeat_entry custom_se8;

    CUSTOM_AGG_Inventory_value custom_sv1;
    ...
    CUSTOM_AGG_InvItem_value custom_sv7;
    CUSTOM_AGG_InvItemWeat_value custom_sv8;
