...
namespace dbtoaster {
  ...
  struct EXT_PRICEITEM2_entry {
    long EXT_PRICEITEMITEM_I_ITEM_SK; long DT_D_YEAR; DOUBLE_TYPE __av; 
    explicit EXT_PRICEITEM2_entry() { /*EXT_PRICEITEMITEM_I_ITEM_SK = 0L; DT_D_YEAR = 0L; __av = 0.0; */ }
    explicit EXT_PRICEITEM2_entry(const long c0, const long c1, const DOUBLE_TYPE c2) { EXT_PRICEITEMITEM_I_ITEM_SK = c0; DT_D_YEAR = c1; __av = c2; }
    EXT_PRICEITEM2_entry(const EXT_PRICEITEM2_entry& other) : EXT_PRICEITEMITEM_I_ITEM_SK( other.EXT_PRICEITEMITEM_I_ITEM_SK ), DT_D_YEAR( other.DT_D_YEAR ), __av( other.__av ) {}
    FORCE_INLINE EXT_PRICEITEM2_entry& modify(const long c0, const long c1) { EXT_PRICEITEMITEM_I_ITEM_SK = c0; DT_D_YEAR = c1;  return *this; }
    FORCE_INLINE EXT_PRICEITEM2_entry& modify0(const long c0) { EXT_PRICEITEMITEM_I_ITEM_SK = c0;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct EXT_PRICEITEM2_mapkey01_idxfn {
    ...
    FORCE_INLINE static bool equals(const EXT_PRICEITEM2_entry& x, const EXT_PRICEITEM2_entry& y) {
      return x.EXT_PRICEITEMITEM_I_ITEM_SK == y.EXT_PRICEITEMITEM_I_ITEM_SK && x.DT_D_YEAR == y.DT_D_YEAR;
    }
  };
  ...
  typedef MultiHashMap<EXT_PRICEITEM2_entry,DOUBLE_TYPE,
    HashIndex<EXT_PRICEITEM2_entry,DOUBLE_TYPE,EXT_PRICEITEM2_mapkey01_idxfn,true>,
    HashIndex<EXT_PRICEITEM2_entry,DOUBLE_TYPE,EXT_PRICEITEM2_mapkey0_idxfn,false>
  > EXT_PRICEITEM2_map;
  typedef HashIndex<EXT_PRICEITEM2_entry,DOUBLE_TYPE,EXT_PRICEITEM2_mapkey01_idxfn,true> HashIndex_EXT_PRICEITEM2_map_01;
  typedef HashIndex<EXT_PRICEITEM2_entry,DOUBLE_TYPE,EXT_PRICEITEM2_mapkey0_idxfn,false> HashIndex_EXT_PRICEITEM2_map_0;
  
  struct EXT_PRICESTORE_SALES1_entry {
    long EXT_PRICESTORE_SALESSTORE_SALES_SS_SOLD_DATE_SK; long DT_D_YEAR; long __av; 
    explicit EXT_PRICESTORE_SALES1_entry() { /*EXT_PRICESTORE_SALESSTORE_SALES_SS_SOLD_DATE_SK = 0L; DT_D_YEAR = 0L; __av = 0L; */ }
    explicit EXT_PRICESTORE_SALES1_entry(const long c0, const long c1, const long c2) { EXT_PRICESTORE_SALESSTORE_SALES_SS_SOLD_DATE_SK = c0; DT_D_YEAR = c1; __av = c2; }
    EXT_PRICESTORE_SALES1_entry(const EXT_PRICESTORE_SALES1_entry& other) : EXT_PRICESTORE_SALESSTORE_SALES_SS_SOLD_DATE_SK( other.EXT_PRICESTORE_SALESSTORE_SALES_SS_SOLD_DATE_SK ), DT_D_YEAR( other.DT_D_YEAR ), __av( other.__av ) {}
    FORCE_INLINE EXT_PRICESTORE_SALES1_entry& modify(const long c0, const long c1) { EXT_PRICESTORE_SALESSTORE_SALES_SS_SOLD_DATE_SK = c0; DT_D_YEAR = c1;  return *this; }
    FORCE_INLINE EXT_PRICESTORE_SALES1_entry& modify0(const long c0) { EXT_PRICESTORE_SALESSTORE_SALES_SS_SOLD_DATE_SK = c0;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct EXT_PRICESTORE_SALES1_mapkey01_idxfn {
    ...
    FORCE_INLINE static bool equals(const EXT_PRICESTORE_SALES1_entry& x, const EXT_PRICESTORE_SALES1_entry& y) {
      return x.EXT_PRICESTORE_SALESSTORE_SALES_SS_SOLD_DATE_SK == y.EXT_PRICESTORE_SALESSTORE_SALES_SS_SOLD_DATE_SK && x.DT_D_YEAR == y.DT_D_YEAR;
    }
  };
  ...
  typedef MultiHashMap<EXT_PRICESTORE_SALES1_entry,long,
    HashIndex<EXT_PRICESTORE_SALES1_entry,long,EXT_PRICESTORE_SALES1_mapkey01_idxfn,true>,
    HashIndex<EXT_PRICESTORE_SALES1_entry,long,EXT_PRICESTORE_SALES1_mapkey0_idxfn,false>
  > EXT_PRICESTORE_SALES1_map;
  typedef HashIndex<EXT_PRICESTORE_SALES1_entry,long,EXT_PRICESTORE_SALES1_mapkey01_idxfn,true> HashIndex_EXT_PRICESTORE_SALES1_map_01;
  ...
  struct EXT_PRICESTORE_SALES2_entry {
    long EXT_PRICESTORE_SALESSTORE_SALES_SS_ITEM_SK; long BRAND_ID; STRING_TYPE BRAND; long __av; 
    explicit EXT_PRICESTORE_SALES2_entry() { /*EXT_PRICESTORE_SALESSTORE_SALES_SS_ITEM_SK = 0L; BRAND_ID = 0L; BRAND = ""; __av = 0L; */ }
    explicit EXT_PRICESTORE_SALES2_entry(const long c0, const long c1, const STRING_TYPE& c2, const long c3) { EXT_PRICESTORE_SALESSTORE_SALES_SS_ITEM_SK = c0; BRAND_ID = c1; BRAND = c2; __av = c3; }
    EXT_PRICESTORE_SALES2_entry(const EXT_PRICESTORE_SALES2_entry& other) : EXT_PRICESTORE_SALESSTORE_SALES_SS_ITEM_SK( other.EXT_PRICESTORE_SALESSTORE_SALES_SS_ITEM_SK ), BRAND_ID( other.BRAND_ID ), BRAND( other.BRAND ), __av( other.__av ) {}
    FORCE_INLINE EXT_PRICESTORE_SALES2_entry& modify(const long c0, const long c1, const STRING_TYPE& c2) { EXT_PRICESTORE_SALESSTORE_SALES_SS_ITEM_SK = c0; BRAND_ID = c1; BRAND = c2;  return *this; }
    FORCE_INLINE EXT_PRICESTORE_SALES2_entry& modify0(const long c0) { EXT_PRICESTORE_SALESSTORE_SALES_SS_ITEM_SK = c0;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct EXT_PRICESTORE_SALES2_mapkey012_idxfn {
    ...
    FORCE_INLINE static bool equals(const EXT_PRICESTORE_SALES2_entry& x, const EXT_PRICESTORE_SALES2_entry& y) {
      return x.EXT_PRICESTORE_SALESSTORE_SALES_SS_ITEM_SK == y.EXT_PRICESTORE_SALESSTORE_SALES_SS_ITEM_SK && x.BRAND_ID == y.BRAND_ID && x.BRAND == y.BRAND;
    }
  };
  ...
  typedef MultiHashMap<EXT_PRICESTORE_SALES2_entry,long,
    HashIndex<EXT_PRICESTORE_SALES2_entry,long,EXT_PRICESTORE_SALES2_mapkey012_idxfn,true>,
    HashIndex<EXT_PRICESTORE_SALES2_entry,long,EXT_PRICESTORE_SALES2_mapkey0_idxfn,false>
  > EXT_PRICESTORE_SALES2_map;
  typedef HashIndex<EXT_PRICESTORE_SALES2_entry,long,EXT_PRICESTORE_SALES2_mapkey012_idxfn,true> HashIndex_EXT_PRICESTORE_SALES2_map_012;
  typedef HashIndex<EXT_PRICESTORE_SALES2_entry,long,EXT_PRICESTORE_SALES2_mapkey0_idxfn,false> HashIndex_EXT_PRICESTORE_SALES2_map_0;
  ...
  struct data_t : tlq_t{
    ...
    void on_insert_STORE_SALES(const long store_sales_ss_sold_date_sk, const long store_sales_ss_sold_time_sk, const long store_sales_ss_item_sk, const long store_sales_ss_customer_sk, const long store_sales_ss_cdemo_sk, const long store_sales_ss_hdemo_sk, const long store_sales_ss_addr_sk, const long store_sales_ss_store_sk, const long store_sales_ss_promo_sk, const long store_sales_ss_ticket_number, const long store_sales_ss_quantity, const DOUBLE_TYPE store_sales_ss_wholesale_cost, const DOUBLE_TYPE store_sales_ss_list_price, const DOUBLE_TYPE store_sales_ss_sales_price, const DOUBLE_TYPE store_sales_ss_ext_discount_amt, const DOUBLE_TYPE store_sales_ss_ext_sales_price, const DOUBLE_TYPE store_sales_ss_ext_wholesale_cost, const DOUBLE_TYPE store_sales_ss_ext_list_price, const DOUBLE_TYPE store_sales_ss_ext_tax, const DOUBLE_TYPE store_sales_ss_coupon_amt, const DOUBLE_TYPE store_sales_ss_net_paid, const DOUBLE_TYPE store_sales_ss_net_paid_inc_tax, const DOUBLE_TYPE store_sales_ss_net_profit) {
      {  if (tS>0) { ++tS; return; } if ((tN&127)==0) { gettimeofday(&(t),NULL); tT=((t).tv_sec-(t0).tv_sec)*1000000L+((t).tv_usec-(t0).tv_usec); if (tT>3600000000L) { tS=1; return; } } ++tN;
        { //slice 
          ...
          const HASH_RES_t h2 = EXT_PRICESTORE_SALES1_mapkey0_idxfn::hash(se3.modify0(store_sales_ss_sold_date_sk));
          HashIndex_EXT_PRICESTORE_SALES1_map_0::IdxNode* n1 = static_cast<HashIndex_EXT_PRICESTORE_SALES1_map_0::IdxNode*>(i1->slice(se3, h2));
          ...
          if (n1 && (e1 = n1->obj)) {
            do {                
              ...
              long v1 = e1->__av;
              { //slice 
                const HashIndex_EXT_PRICESTORE_SALES2_map_0* i2 = static_cast<HashIndex_EXT_PRICESTORE_SALES2_map_0*>(EXT_PRICESTORE_SALES2.index[1]);
                const HASH_RES_t h1 = EXT_PRICESTORE_SALES2_mapkey0_idxfn::hash(se2.modify0(store_sales_ss_item_sk));
                HashIndex_EXT_PRICESTORE_SALES2_map_0::IdxNode* n2 = static_cast<HashIndex_EXT_PRICESTORE_SALES2_map_0::IdxNode*>(i2->slice(se2, h1));
                EXT_PRICESTORE_SALES2_entry* e2;
               
                if (n2 && (e2 = n2->obj)) {
                  do {                
                    long brand_id = e2->BRAND_ID;
                    STRING_TYPE brand = e2->BRAND;
                    long v2 = e2->__av;
                    EXT_PRICE.addOrDelOnZero(se1.modify(dt_d_year,brand_id,brand),(v1 * (v2 * store_sales_ss_ext_sales_price)));
                    n2 = n2->nxt;
                  } while (n2 && (e2 = n2->obj) && h1 == n2->hash &&  EXT_PRICESTORE_SALES2_mapkey0_idxfn::equals(se2, *e2)); 
                }
              }
              n1 = n1->nxt;
            } while (n1 && (e1 = n1->obj) && h2 == n1->hash &&  EXT_PRICESTORE_SALES1_mapkey0_idxfn::equals(se3, *e1)); 
          }
        }{ //slice 
          ...
          const HASH_RES_t h3 = EXT_PRICESTORE_SALES1_mapkey0_idxfn::hash(se5.modify0(store_sales_ss_sold_date_sk));
          HashIndex_EXT_PRICESTORE_SALES1_map_0::IdxNode* n3 = static_cast<HashIndex_EXT_PRICESTORE_SALES1_map_0::IdxNode*>(i3->slice(se5, h3));
          ...
          if (n3 && (e3 = n3->obj)) {
            do {                
              ...
              long v3 = e3->__av;
              EXT_PRICEITEM2.addOrDelOnZero(se4.modify(store_sales_ss_item_sk,dt_d_year),(v3 * store_sales_ss_ext_sales_price));
              n3 = n3->nxt;
            } while (n3 && (e3 = n3->obj) && h3 == n3->hash &&  EXT_PRICESTORE_SALES1_mapkey0_idxfn::equals(se5, *e3)); 
          }
        }
      }
    }
    void on_insert_ITEM(const long item_i_item_sk, const STRING_TYPE& item_i_item_id, const date item_i_rec_start_date, const date item_i_rec_end_date, const STRING_TYPE& item_i_item_desc, const DOUBLE_TYPE item_i_current_price, const DOUBLE_TYPE item_i_wholesale_cost, const long item_i_brand_id, const STRING_TYPE& item_i_brand, const long item_i_class_id, const STRING_TYPE& item_i_class, const long item_i_category_id, const STRING_TYPE& item_i_category, const long item_i_manufact_id, const STRING_TYPE& item_i_manufact, const STRING_TYPE& item_i_size, const STRING_TYPE& item_i_formulation, const STRING_TYPE& item_i_color, const STRING_TYPE& item_i_units, const STRING_TYPE& item_i_container, const long item_i_manager_id, const STRING_TYPE& item_i_product_name) {
      {  if (tS>0) { ++tS; return; } if ((tN&127)==0) { gettimeofday(&(t),NULL); tT=((t).tv_sec-(t0).tv_sec)*1000000L+((t).tv_usec-(t0).tv_usec); if (tT>3600000000L) { tS=1; return; } } ++tN;
        { //slice 
          const HashIndex_EXT_PRICEITEM2_map_0* i4 = static_cast<HashIndex_EXT_PRICEITEM2_map_0*>(EXT_PRICEITEM2.index[1]);
          const HASH_RES_t h4 = EXT_PRICEITEM2_mapkey0_idxfn::hash(se7.modify0(item_i_item_sk));
          HashIndex_EXT_PRICEITEM2_map_0::IdxNode* n4 = static_cast<HashIndex_EXT_PRICEITEM2_map_0::IdxNode*>(i4->slice(se7, h4));
          EXT_PRICEITEM2_entry* e4;
         
          if (n4 && (e4 = n4->obj)) {
            do {                
              long dt_d_year = e4->DT_D_YEAR;
              DOUBLE_TYPE v4 = e4->__av;
              (/*if */(item_i_manager_id == 1L) ? EXT_PRICE.addOrDelOnZero(se6.modify(dt_d_year,item_i_brand_id,item_i_brand),v4) : (void)0);
              n4 = n4->nxt;
            } while (n4 && (e4 = n4->obj) && h4 == n4->hash &&  EXT_PRICEITEM2_mapkey0_idxfn::equals(se7, *e4)); 
          }
        }(/*if */(item_i_manager_id == 1L) ? EXT_PRICESTORE_SALES2.addOrDelOnZero(se8.modify(item_i_item_sk,item_i_brand_id,item_i_brand),1L) : (void)0);
      }
    }
    void on_system_ready_event() {
      {  
        EXT_PRICESTORE_SALES1.clear();
        long l1 = 1998L;
        agg1.clear();
        ...
        { //slice 
          ...
          if (n5 && (e5 = n5->obj)) {
            do {                
              long ext_pricestore_salesstore_sales_ss_sold_date_sk = e5->DATE_DIM_D_DATE_SK;
              ...
              long v5 = e5->__av;
              agg1.addOrDelOnZero(st1.modify(ext_pricestore_salesstore_sales_ss_sold_date_sk,v5), v5);
              n5 = n5->nxt;
          ...
          for (size_t i = 0; i < i6->size_; i++)
          {
            ...
            while (n6 && (e6 = n6->obj))
            {
              long ext_pricestore_salesstore_sales_ss_sold_date_sk = e6->_1;  
              long v6 = e6->__av; 
            EXT_PRICESTORE_SALES1.addOrDelOnZero(se9.modify(ext_pricestore_salesstore_sales_ss_sold_date_sk,l1),v6);      
              n6 = n6->nxt;
            }
          }
        }
  ...
  private:
    ...
    EXT_PRICESTORE_SALES1_entry se5;
    EXT_PRICE_entry se6;
    EXT_PRICEITEM2_entry se7;
    EXT_PRICESTORE_SALES2_entry se8;
    EXT_PRICESTORE_SALES1_entry se9;
    tuple2_L_L st1;
    DATE_DIM_entry se10;
