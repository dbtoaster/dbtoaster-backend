...
namespace dbtoaster {
  ...
  struct __SQL_SUM_AGGREGATE_1ITEM1_DELTA_entry {
    long STORE_SALES_SS_ITEM_SK; long ITEM_I_CATEGORY_ID; STRING_TYPE ITEM_I_CATEGORY; long __av; 
    explicit __SQL_SUM_AGGREGATE_1ITEM1_DELTA_entry() { /*STORE_SALES_SS_ITEM_SK = 0L; ITEM_I_CATEGORY_ID = 0L; ITEM_I_CATEGORY = ""; __av = 0L; */ }
    explicit __SQL_SUM_AGGREGATE_1ITEM1_DELTA_entry(const long c0, const long c1, const STRING_TYPE& c2, const long c3) { STORE_SALES_SS_ITEM_SK = c0; ITEM_I_CATEGORY_ID = c1; ITEM_I_CATEGORY = c2; __av = c3; }
    __SQL_SUM_AGGREGATE_1ITEM1_DELTA_entry(const __SQL_SUM_AGGREGATE_1ITEM1_DELTA_entry& other) : STORE_SALES_SS_ITEM_SK( other.STORE_SALES_SS_ITEM_SK ), ITEM_I_CATEGORY_ID( other.ITEM_I_CATEGORY_ID ), ITEM_I_CATEGORY( other.ITEM_I_CATEGORY ), __av( other.__av ) {}
    FORCE_INLINE __SQL_SUM_AGGREGATE_1ITEM1_DELTA_entry& modify(const long c0, const long c1, const STRING_TYPE& c2) { STORE_SALES_SS_ITEM_SK = c0; ITEM_I_CATEGORY_ID = c1; ITEM_I_CATEGORY = c2;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct __SQL_SUM_AGGREGATE_1ITEM1_DELTA_mapkey012_idxfn {
    FORCE_INLINE static size_t hash(const __SQL_SUM_AGGREGATE_1ITEM1_DELTA_entry& e) {
      size_t h = 0;
      hash_combine(h, e.STORE_SALES_SS_ITEM_SK);
      hash_combine(h, e.ITEM_I_CATEGORY_ID);
      hash_combine(h, e.ITEM_I_CATEGORY);
    ...
    FORCE_INLINE static bool equals(const __SQL_SUM_AGGREGATE_1ITEM1_DELTA_entry& x, const __SQL_SUM_AGGREGATE_1ITEM1_DELTA_entry& y) {
      return x.STORE_SALES_SS_ITEM_SK == y.STORE_SALES_SS_ITEM_SK && x.ITEM_I_CATEGORY_ID == y.ITEM_I_CATEGORY_ID && x.ITEM_I_CATEGORY == y.ITEM_I_CATEGORY;
    }
  };
  
  typedef MultiHashMap<__SQL_SUM_AGGREGATE_1ITEM1_DELTA_entry,long,
    HashIndex<__SQL_SUM_AGGREGATE_1ITEM1_DELTA_entry,long,__SQL_SUM_AGGREGATE_1ITEM1_DELTA_mapkey012_idxfn,true>
  > __SQL_SUM_AGGREGATE_1ITEM1_DELTA_map;
  typedef HashIndex<__SQL_SUM_AGGREGATE_1ITEM1_DELTA_entry,long,__SQL_SUM_AGGREGATE_1ITEM1_DELTA_mapkey012_idxfn,true> HashIndex___SQL_SUM_AGGREGATE_1ITEM1_DELTA_map_012;
  
  struct __SQL_SUM_AGGREGATE_1ITEM1_entry {
    long DT_D_YEAR; long STORE_SALES_SS_ITEM_SK; DOUBLE_TYPE __av; 
    explicit __SQL_SUM_AGGREGATE_1ITEM1_entry() { /*DT_D_YEAR = 0L; STORE_SALES_SS_ITEM_SK = 0L; __av = 0.0; */ }
    explicit __SQL_SUM_AGGREGATE_1ITEM1_entry(const long c0, const long c1, const DOUBLE_TYPE c2) { DT_D_YEAR = c0; STORE_SALES_SS_ITEM_SK = c1; __av = c2; }
    __SQL_SUM_AGGREGATE_1ITEM1_entry(const __SQL_SUM_AGGREGATE_1ITEM1_entry& other) : DT_D_YEAR( other.DT_D_YEAR ), STORE_SALES_SS_ITEM_SK( other.STORE_SALES_SS_ITEM_SK ), __av( other.__av ) {}
    FORCE_INLINE __SQL_SUM_AGGREGATE_1ITEM1_entry& modify(const long c0, const long c1) { DT_D_YEAR = c0; STORE_SALES_SS_ITEM_SK = c1;  return *this; }
    FORCE_INLINE __SQL_SUM_AGGREGATE_1ITEM1_entry& modify1(const long c1) { STORE_SALES_SS_ITEM_SK = c1;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct __SQL_SUM_AGGREGATE_1ITEM1_mapkey01_idxfn {
    FORCE_INLINE static size_t hash(const __SQL_SUM_AGGREGATE_1ITEM1_entry& e) {
      size_t h = 0;
      hash_combine(h, e.DT_D_YEAR);
      hash_combine(h, e.STORE_SALES_SS_ITEM_SK);
      return h;
    }
    FORCE_INLINE static bool equals(const __SQL_SUM_AGGREGATE_1ITEM1_entry& x, const __SQL_SUM_AGGREGATE_1ITEM1_entry& y) {
      return x.DT_D_YEAR == y.DT_D_YEAR && x.STORE_SALES_SS_ITEM_SK == y.STORE_SALES_SS_ITEM_SK;
    }
  };
  
  struct __SQL_SUM_AGGREGATE_1ITEM1_mapkey1_idxfn {
    FORCE_INLINE static size_t hash(const __SQL_SUM_AGGREGATE_1ITEM1_entry& e) {
      size_t h = 0;
      hash_combine(h, e.STORE_SALES_SS_ITEM_SK);
      return h;
  ...
  typedef MultiHashMap<__SQL_SUM_AGGREGATE_1ITEM1_entry,DOUBLE_TYPE,
    HashIndex<__SQL_SUM_AGGREGATE_1ITEM1_entry,DOUBLE_TYPE,__SQL_SUM_AGGREGATE_1ITEM1_mapkey01_idxfn,true>,
    HashIndex<__SQL_SUM_AGGREGATE_1ITEM1_entry,DOUBLE_TYPE,__SQL_SUM_AGGREGATE_1ITEM1_mapkey1_idxfn,false>
  > __SQL_SUM_AGGREGATE_1ITEM1_map;
  typedef HashIndex<__SQL_SUM_AGGREGATE_1ITEM1_entry,DOUBLE_TYPE,__SQL_SUM_AGGREGATE_1ITEM1_mapkey01_idxfn,true> HashIndex___SQL_SUM_AGGREGATE_1ITEM1_map_01;
  typedef HashIndex<__SQL_SUM_AGGREGATE_1ITEM1_entry,DOUBLE_TYPE,__SQL_SUM_AGGREGATE_1ITEM1_mapkey1_idxfn,false> HashIndex___SQL_SUM_AGGREGATE_1ITEM1_map_1;
  
  struct __SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_entry {
    long DT_D_DATE_SK; long STORE_SALES_SS_ITEM_SK; DOUBLE_TYPE __av; 
    explicit __SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_entry() { /*DT_D_DATE_SK = 0L; STORE_SALES_SS_ITEM_SK = 0L; __av = 0.0; */ }
    explicit __SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_entry(const long c0, const long c1, const DOUBLE_TYPE c2) { DT_D_DATE_SK = c0; STORE_SALES_SS_ITEM_SK = c1; __av = c2; }
    __SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_entry(const __SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_entry& other) : DT_D_DATE_SK( other.DT_D_DATE_SK ), STORE_SALES_SS_ITEM_SK( other.STORE_SALES_SS_ITEM_SK ), __av( other.__av ) {}
    FORCE_INLINE __SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_entry& modify(const long c0, const long c1) { DT_D_DATE_SK = c0; STORE_SALES_SS_ITEM_SK = c1;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct __SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_mapkey01_idxfn {
    FORCE_INLINE static size_t hash(const __SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_entry& e) {
      size_t h = 0;
      hash_combine(h, e.DT_D_DATE_SK);
      hash_combine(h, e.STORE_SALES_SS_ITEM_SK);
      return h;
    }
    FORCE_INLINE static bool equals(const __SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_entry& x, const __SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_entry& y) {
      return x.DT_D_DATE_SK == y.DT_D_DATE_SK && x.STORE_SALES_SS_ITEM_SK == y.STORE_SALES_SS_ITEM_SK;
    }
  };
  
  typedef MultiHashMap<__SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_entry,DOUBLE_TYPE,
    HashIndex<__SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_entry,DOUBLE_TYPE,__SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_mapkey01_idxfn,true>
  > __SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_map;
  typedef HashIndex<__SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_entry,DOUBLE_TYPE,__SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_mapkey01_idxfn,true> HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_map_01;
  
  struct __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry {
    long DT_D_DATE_SK; long DT_D_YEAR; long __av; 
    explicit __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry() { /*DT_D_DATE_SK = 0L; DT_D_YEAR = 0L; __av = 0L; */ }
    explicit __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry(const long c0, const long c1, const long c2) { DT_D_DATE_SK = c0; DT_D_YEAR = c1; __av = c2; }
    __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry(const __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry& other) : DT_D_DATE_SK( other.DT_D_DATE_SK ), DT_D_YEAR( other.DT_D_YEAR ), __av( other.__av ) {}
    FORCE_INLINE __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry& modify(const long c0, const long c1) { DT_D_DATE_SK = c0; DT_D_YEAR = c1;  return *this; }
    FORCE_INLINE __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry& modify0(const long c0) { DT_D_DATE_SK = c0;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_mapkey01_idxfn {
    FORCE_INLINE static size_t hash(const __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry& e) {
      size_t h = 0;
      hash_combine(h, e.DT_D_DATE_SK);
      hash_combine(h, e.DT_D_YEAR);
      return h;
    }
    FORCE_INLINE static bool equals(const __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry& x, const __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry& y) {
      return x.DT_D_DATE_SK == y.DT_D_DATE_SK && x.DT_D_YEAR == y.DT_D_YEAR;
    }
  };
  
  struct __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_mapkey0_idxfn {
    FORCE_INLINE static size_t hash(const __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry& e) {
      size_t h = 0;
      hash_combine(h, e.DT_D_DATE_SK);
      return h;
  ...
  typedef MultiHashMap<__SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry,long,
    HashIndex<__SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry,long,__SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_mapkey01_idxfn,true>,
    HashIndex<__SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry,long,__SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_mapkey0_idxfn,false>
  > __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_map;
  typedef HashIndex<__SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry,long,__SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_mapkey01_idxfn,true> HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_map_01;
  typedef HashIndex<__SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry,long,__SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_mapkey0_idxfn,false> HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_map_0;
  
  struct __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_entry {
    long STORE_SALES_SS_ITEM_SK; long ITEM_I_CATEGORY_ID; STRING_TYPE ITEM_I_CATEGORY; long __av; 
    explicit __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_entry() { /*STORE_SALES_SS_ITEM_SK = 0L; ITEM_I_CATEGORY_ID = 0L; ITEM_I_CATEGORY = ""; __av = 0L; */ }
    explicit __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_entry(const long c0, const long c1, const STRING_TYPE& c2, const long c3) { STORE_SALES_SS_ITEM_SK = c0; ITEM_I_CATEGORY_ID = c1; ITEM_I_CATEGORY = c2; __av = c3; }
    __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_entry(const __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_entry& other) : STORE_SALES_SS_ITEM_SK( other.STORE_SALES_SS_ITEM_SK ), ITEM_I_CATEGORY_ID( other.ITEM_I_CATEGORY_ID ), ITEM_I_CATEGORY( other.ITEM_I_CATEGORY ), __av( other.__av ) {}
    FORCE_INLINE __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_entry& modify(const long c0, const long c1, const STRING_TYPE& c2) { STORE_SALES_SS_ITEM_SK = c0; ITEM_I_CATEGORY_ID = c1; ITEM_I_CATEGORY = c2;  return *this; }
    FORCE_INLINE __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_entry& modify0(const long c0) { STORE_SALES_SS_ITEM_SK = c0;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_mapkey012_idxfn {
    FORCE_INLINE static size_t hash(const __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_entry& e) {
      size_t h = 0;
      hash_combine(h, e.STORE_SALES_SS_ITEM_SK);
      hash_combine(h, e.ITEM_I_CATEGORY_ID);
      hash_combine(h, e.ITEM_I_CATEGORY);
    ...
    FORCE_INLINE static bool equals(const __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_entry& x, const __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_entry& y) {
      return x.STORE_SALES_SS_ITEM_SK == y.STORE_SALES_SS_ITEM_SK && x.ITEM_I_CATEGORY_ID == y.ITEM_I_CATEGORY_ID && x.ITEM_I_CATEGORY == y.ITEM_I_CATEGORY;
    }
  };
  
  struct __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_mapkey0_idxfn {
    FORCE_INLINE static size_t hash(const __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_entry& e) {
      size_t h = 0;
      hash_combine(h, e.STORE_SALES_SS_ITEM_SK);
      return h;
  ...
  typedef MultiHashMap<__SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_entry,long,
    HashIndex<__SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_entry,long,__SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_mapkey012_idxfn,true>,
    HashIndex<__SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_entry,long,__SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_mapkey0_idxfn,false>
  > __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_map;
  typedef HashIndex<__SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_entry,long,__SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_mapkey012_idxfn,true> HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_map_012;
  typedef HashIndex<__SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_entry,long,__SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_mapkey0_idxfn,false> HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_map_0;
  ...
  struct data_t : tlq_t{
    ...
    void on_batch_update_STORE_SALES(TPCDSStoreSalesBatch& DELTA_STORE_SALES) {
      { 
        ...
        __SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA.clear();
        {  
          for (size_t i = 0; i < DELTA_STORE_SALES.size; i++) 
          {
                ...
                long v1 = 1L;
                __SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA.addOrDelOnZero(se1.modify(dt_d_date_sk,store_sales_ss_item_sk),(v1 * store_sales_ss_ext_sales_price));

          }
        }

        {  // foreach
          const HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_map_01* i2 = static_cast<HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_map_01*>(__SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA.index[0]);
          HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_map_01::IdxNode* n2; 
          __SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_entry* e2;
          ...
          for (size_t i = 0; i < i2->size_; i++)
          {
            ...
            while (n2 && (e2 = n2->obj))
            {
                ...
                { //slice 
                  const HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_map_0* i3 = static_cast<HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_map_0*>(__SQL_SUM_AGGREGATE_1STORE_SALES1_P_1.index[1]);
                  const HASH_RES_t h2 = __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_mapkey0_idxfn::hash(se4.modify0(dt_d_date_sk));
                  HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_map_0::IdxNode* n3 = static_cast<HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_map_0::IdxNode*>(i3->slice(se4, h2));
                  __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry* e3;
                  ...
                  if (n3 && (e3 = n3->obj)) {
                    do {                
                      ...
                      long v3 = e3->__av;
                      { //slice 
                        const HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_map_0* i4 = static_cast<HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_map_0*>(__SQL_SUM_AGGREGATE_1STORE_SALES1_P_2.index[1]);
                        const HASH_RES_t h1 = __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_mapkey0_idxfn::hash(se3.modify0(store_sales_ss_item_sk));
                        HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_map_0::IdxNode* n4 = static_cast<HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_map_0::IdxNode*>(i4->slice(se3, h1));
                        __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_entry* e4;
                       
                        if (n4 && (e4 = n4->obj)) {
                          do {                
                            long item_i_category_id = e4->ITEM_I_CATEGORY_ID;
                            STRING_TYPE item_i_category = e4->ITEM_I_CATEGORY;
                            long v4 = e4->__av;
                            __SQL_SUM_AGGREGATE_1.addOrDelOnZero(se2.modify(dt_d_year,item_i_category_id,item_i_category),(v2 * (v3 * v4)));
                            n4 = n4->nxt;
                          } while (n4 && (e4 = n4->obj) && h1 == n4->hash &&  __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_mapkey0_idxfn::equals(se3, *e4)); 
                        }
                      }
                      n3 = n3->nxt;
                    } while (n3 && (e3 = n3->obj) && h2 == n3->hash &&  __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_mapkey0_idxfn::equals(se4, *e3)); 
                  }
                }
              n2 = n2->nxt;
            }
          ...
          const HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_map_01* i5 = static_cast<HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_map_01*>(__SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA.index[0]);
          HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_map_01::IdxNode* n5; 
          __SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_entry* e5;
          ...
          for (size_t i = 0; i < i5->size_; i++)
          {
            ...
            while (n5 && (e5 = n5->obj))
            {
                ...
                { //slice 
                  const HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_map_0* i6 = static_cast<HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_map_0*>(__SQL_SUM_AGGREGATE_1STORE_SALES1_P_1.index[1]);
                  const HASH_RES_t h3 = __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_mapkey0_idxfn::hash(se6.modify0(dt_d_date_sk));
                  HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_map_0::IdxNode* n6 = static_cast<HashIndex___SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_map_0::IdxNode*>(i6->slice(se6, h3));
                  __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry* e6;
                 
                  if (n6 && (e6 = n6->obj)) {
                    do {                
                      long dt_d_year = e6->DT_D_YEAR;
                      long v6 = e6->__av;
                      __SQL_SUM_AGGREGATE_1ITEM1.addOrDelOnZero(se5.modify(dt_d_year,store_sales_ss_item_sk),(v5 * v6));
                      n6 = n6->nxt;
                    } while (n6 && (e6 = n6->obj) && h3 == n6->hash &&  __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_mapkey0_idxfn::equals(se6, *e6)); 
                  }
                }
              n5 = n5->nxt;
            }
    ...
    void on_batch_update_ITEM(TPCDSItemBatch& DELTA_ITEM) {
      { 
        ...
        __SQL_SUM_AGGREGATE_1ITEM1_DELTA.clear();
        {  
          for (size_t i = 0; i < DELTA_ITEM.size; i++) 
          {
                ...
                long v7 = 1L;
                (/*if */(lift1 == 1L) ? __SQL_SUM_AGGREGATE_1ITEM1_DELTA.addOrDelOnZero(se7.modify(store_sales_ss_item_sk,item_i_category_id,item_i_category),v7) : (void)0);
          }
        }

        {  // foreach
          const HashIndex___SQL_SUM_AGGREGATE_1ITEM1_DELTA_map_012* i8 = static_cast<HashIndex___SQL_SUM_AGGREGATE_1ITEM1_DELTA_map_012*>(__SQL_SUM_AGGREGATE_1ITEM1_DELTA.index[0]);
          HashIndex___SQL_SUM_AGGREGATE_1ITEM1_DELTA_map_012::IdxNode* n8; 
          __SQL_SUM_AGGREGATE_1ITEM1_DELTA_entry* e8;
          ...
          for (size_t i = 0; i < i8->size_; i++)
          {
            ...
            while (n8 && (e8 = n8->obj))
            {
                ...
                long item_i_category_id = e8->ITEM_I_CATEGORY_ID;
                STRING_TYPE item_i_category = e8->ITEM_I_CATEGORY;
                long v8 = e8->__av;
                { //slice 
                  const HashIndex___SQL_SUM_AGGREGATE_1ITEM1_map_1* i9 = static_cast<HashIndex___SQL_SUM_AGGREGATE_1ITEM1_map_1*>(__SQL_SUM_AGGREGATE_1ITEM1.index[1]);
                  const HASH_RES_t h4 = __SQL_SUM_AGGREGATE_1ITEM1_mapkey1_idxfn::hash(se9.modify1(store_sales_ss_item_sk));
                  HashIndex___SQL_SUM_AGGREGATE_1ITEM1_map_1::IdxNode* n9 = static_cast<HashIndex___SQL_SUM_AGGREGATE_1ITEM1_map_1::IdxNode*>(i9->slice(se9, h4));
                  __SQL_SUM_AGGREGATE_1ITEM1_entry* e9;
                 
                  if (n9 && (e9 = n9->obj)) {
                    do {                
                      long dt_d_year = e9->DT_D_YEAR;
                      DOUBLE_TYPE v9 = e9->__av;
                      __SQL_SUM_AGGREGATE_1.addOrDelOnZero(se8.modify(dt_d_year,item_i_category_id,item_i_category),(v8 * v9));
                      n9 = n9->nxt;
                    } while (n9 && (e9 = n9->obj) && h4 == n9->hash &&  __SQL_SUM_AGGREGATE_1ITEM1_mapkey1_idxfn::equals(se9, *e9)); 
                  }
                }
              n8 = n8->nxt;
            }
          ...
          const HashIndex___SQL_SUM_AGGREGATE_1ITEM1_DELTA_map_012* i10 = static_cast<HashIndex___SQL_SUM_AGGREGATE_1ITEM1_DELTA_map_012*>(__SQL_SUM_AGGREGATE_1ITEM1_DELTA.index[0]);
          HashIndex___SQL_SUM_AGGREGATE_1ITEM1_DELTA_map_012::IdxNode* n10; 
          __SQL_SUM_AGGREGATE_1ITEM1_DELTA_entry* e10;
          ...
          for (size_t i = 0; i < i10->size_; i++)
          {
            ...
            while (n10 && (e10 = n10->obj))
            {
                ...
                long item_i_category_id = e10->ITEM_I_CATEGORY_ID;
                STRING_TYPE item_i_category = e10->ITEM_I_CATEGORY;
                long v10 = e10->__av;
                __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2.addOrDelOnZero(se10.modify(store_sales_ss_item_sk,item_i_category_id,item_i_category),v10);
              n10 = n10->nxt;
            }
          }
        }
    ...
    void on_system_ready_event() {
      {  
        __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1.clear();
        long l1 = 1998L;
        agg1.clear();
        
        long l2 = 12L;
        { //slice 
          const HashIndex_DATE_DIM_map_68* i11 = static_cast<HashIndex_DATE_DIM_map_68*>(DATE_DIM.index[1]);
          const HASH_RES_t h5 = DATE_DIM_mapkey68_idxfn::hash(se12.modify68(l1, l2));
          HashIndex_DATE_DIM_map_68::IdxNode* n11 = static_cast<HashIndex_DATE_DIM_map_68::IdxNode*>(i11->slice(se12, h5));
          DATE_DIM_entry* e11;
         
          if (n11 && (e11 = n11->obj)) {
            do {                
              long dt_d_date_sk = e11->DATE_DIM_D_DATE_SK;
              STRING_TYPE dt_d_date_id = e11->DATE_DIM_D_DATE_ID;
              date dt_d_date = e11->DATE_DIM_D_DATE;
              long dt_d_month_seq = e11->DATE_DIM_D_MONTH_SEQ;
              long dt_d_week_seq = e11->DATE_DIM_D_WEEK_SEQ;
              long dt_d_quarter_seq = e11->DATE_DIM_D_QUARTER_SEQ;
              long dt_d_dow = e11->DATE_DIM_D_DOW;
              long dt_d_dom = e11->DATE_DIM_D_DOM;
              long dt_d_qoy = e11->DATE_DIM_D_QOY;
              long dt_d_fy_year = e11->DATE_DIM_D_FY_YEAR;
              long dt_d_fy_quarter_seq = e11->DATE_DIM_D_FY_QUARTER_SEQ;
              long dt_d_fy_week_seq = e11->DATE_DIM_D_FY_WEEK_SEQ;
              STRING_TYPE dt_d_day_name = e11->DATE_DIM_D_DAY_NAME;
              STRING_TYPE dt_d_quarter_name = e11->DATE_DIM_D_QUARTER_NAME;
              STRING_TYPE dt_d_holiday = e11->DATE_DIM_D_HOLIDAY;
              STRING_TYPE dt_d_weekend = e11->DATE_DIM_D_WEEKEND;
              STRING_TYPE dt_d_following_holiday = e11->DATE_DIM_D_FOLLOWING_HOLIDAY;
              long dt_d_first_dom = e11->DATE_DIM_D_FIRST_DOM;
              long dt_d_last_dom = e11->DATE_DIM_D_LAST_DOM;
              long dt_d_same_day_ly = e11->DATE_DIM_D_SAME_DAY_LY;
              long dt_d_same_day_lq = e11->DATE_DIM_D_SAME_DAY_LQ;
              STRING_TYPE dt_d_current_day = e11->DATE_DIM_D_CURRENT_DAY;
              STRING_TYPE dt_d_current_week = e11->DATE_DIM_D_CURRENT_WEEK;
              STRING_TYPE dt_d_current_month = e11->DATE_DIM_D_CURRENT_MONTH;
              STRING_TYPE dt_d_current_quarter = e11->DATE_DIM_D_CURRENT_QUARTER;
              STRING_TYPE dt_d_current_year = e11->DATE_DIM_D_CURRENT_YEAR;
              long v11 = e11->__av;
              agg1.addOrDelOnZero(st1.modify(dt_d_date_sk,v11), v11);
              n11 = n11->nxt;
            } while (n11 && (e11 = n11->obj) && h5 == n11->hash &&  DATE_DIM_mapkey68_idxfn::equals(se12, *e11)); 
          }
        }{  // temp foreach
          const HashIndex<tuple2_L_L, long>* i12 = static_cast<HashIndex<tuple2_L_L, long>*>(agg1.index[0]);
          ...
          for (size_t i = 0; i < i12->size_; i++)
          {
            ...
            {
              long dt_d_date_sk = e12->_1;  
              long v12 = e12->__av; 
            __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1.addOrDelOnZero(se11.modify(dt_d_date_sk,l1),v12);      
              n12 = n12->nxt;
            }
          }
        }
  ...
  private:
    ...
    __SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_entry se1;
    __SQL_SUM_AGGREGATE_1_entry se2;
    __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_entry se3;
    __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry se4;
    __SQL_SUM_AGGREGATE_1ITEM1_entry se5;
    __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry se6;
    __SQL_SUM_AGGREGATE_1ITEM1_DELTA_entry se7;
    __SQL_SUM_AGGREGATE_1_entry se8;
    __SQL_SUM_AGGREGATE_1ITEM1_entry se9;
    __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_entry se10;
    __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_entry se11;
    tuple2_L_L st1;
    DATE_DIM_entry se12;
  
    /* Data structures used for storing materialized views */
    DATE_DIM_map DATE_DIM;
    __SQL_SUM_AGGREGATE_1ITEM1_DELTA_map __SQL_SUM_AGGREGATE_1ITEM1_DELTA;
    __SQL_SUM_AGGREGATE_1ITEM1_map __SQL_SUM_AGGREGATE_1ITEM1;
    __SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA_map __SQL_SUM_AGGREGATE_1STORE_SALES1_DELTA;
    __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1_map __SQL_SUM_AGGREGATE_1STORE_SALES1_P_1;
    __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2_map __SQL_SUM_AGGREGATE_1STORE_SALES1_P_2;
