...
namespace dbtoaster {
  ...
  struct EXT_PRICESTORE_SALES1_DELTA_entry {
    long DATE_DIM_D_DATE_SK; long STORE_SALES_SS_ITEM_SK; DOUBLE_TYPE __av; 
    explicit EXT_PRICESTORE_SALES1_DELTA_entry() { /*DATE_DIM_D_DATE_SK = 0L; STORE_SALES_SS_ITEM_SK = 0L; __av = 0.0; */ }
    explicit EXT_PRICESTORE_SALES1_DELTA_entry(const long c0, const long c1, const DOUBLE_TYPE c2) { DATE_DIM_D_DATE_SK = c0; STORE_SALES_SS_ITEM_SK = c1; __av = c2; }
    EXT_PRICESTORE_SALES1_DELTA_entry(const EXT_PRICESTORE_SALES1_DELTA_entry& other) : DATE_DIM_D_DATE_SK( other.DATE_DIM_D_DATE_SK ), STORE_SALES_SS_ITEM_SK( other.STORE_SALES_SS_ITEM_SK ), __av( other.__av ) {}
    FORCE_INLINE EXT_PRICESTORE_SALES1_DELTA_entry& modify(const long c0, const long c1) { DATE_DIM_D_DATE_SK = c0; STORE_SALES_SS_ITEM_SK = c1;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct EXT_PRICESTORE_SALES1_DELTA_mapkey01_idxfn {
    ...
    FORCE_INLINE static bool equals(const EXT_PRICESTORE_SALES1_DELTA_entry& x, const EXT_PRICESTORE_SALES1_DELTA_entry& y) {
      return x.DATE_DIM_D_DATE_SK == y.DATE_DIM_D_DATE_SK && x.STORE_SALES_SS_ITEM_SK == y.STORE_SALES_SS_ITEM_SK;
    }
  };
  ...
  struct EXT_PRICESTORE_SALES1_P_1_entry {
    ...
    explicit EXT_PRICESTORE_SALES1_P_1_entry() { /*STORE_SALES_SS_ITEM_SK = 0L; BRAND = ""; BRAND_ID = 0L; __av = 0L; */ }
    explicit EXT_PRICESTORE_SALES1_P_1_entry(const long c0, const STRING_TYPE& c1, const long c2, const long c3) { STORE_SALES_SS_ITEM_SK = c0; BRAND = c1; BRAND_ID = c2; __av = c3; }
    EXT_PRICESTORE_SALES1_P_1_entry(const EXT_PRICESTORE_SALES1_P_1_entry& other) : STORE_SALES_SS_ITEM_SK( other.STORE_SALES_SS_ITEM_SK ), BRAND( other.BRAND ), BRAND_ID( other.BRAND_ID ), __av( other.__av ) {}
    FORCE_INLINE EXT_PRICESTORE_SALES1_P_1_entry& modify(const long c0, const STRING_TYPE& c1, const long c2) { STORE_SALES_SS_ITEM_SK = c0; BRAND = c1; BRAND_ID = c2;  return *this; }
  ...
  struct EXT_PRICESTORE_SALES1_P_1_mapkey012_idxfn {
  ...
  typedef MultiHashMap<EXT_PRICESTORE_SALES1_P_1_entry,long,
    HashIndex<EXT_PRICESTORE_SALES1_P_1_entry,long,EXT_PRICESTORE_SALES1_P_1_mapkey012_idxfn,true>,
  ...
  typedef HashIndex<EXT_PRICESTORE_SALES1_P_1_entry,long,EXT_PRICESTORE_SALES1_P_1_mapkey012_idxfn,true> HashIndex_EXT_PRICESTORE_SALES1_P_1_map_012;
  ...
  struct data_t : tlq_t{
      ...
      { 
        ...
        {  
          for (size_t i = 0; i < DELTA_STORE_SALES.size; i++) 
          {
                ...
                long v1 = 1L;
                EXT_PRICESTORE_SALES1_DELTA.addOrDelOnZero(se1.modify(date_dim_d_date_sk,store_sales_ss_item_sk),(v1 * store_sales_ss_ext_sales_price));            
          }
        }
        ...
        {  // foreach
          ...
          for (size_t i = 0; i < i2->size_; i++)
          {
            ...
            while (n2 && (e2 = n2->obj))
            {
                ...
                { //slice 
                  ...
                  const HASH_RES_t h1 = EXT_PRICESTORE_SALES1_P_1_mapkey0_idxfn::hash(se4.modify0(store_sales_ss_item_sk));
                  HashIndex_EXT_PRICESTORE_SALES1_P_1_map_0::IdxNode* n3 = static_cast<HashIndex_EXT_PRICESTORE_SALES1_P_1_map_0::IdxNode*>(i3->slice(se4, h1));
                  ...
                  if (n3 && (e3 = n3->obj)) {
                    do {                
                      ...
                      long v3 = e3->__av;
                      EXT_PRICE.addOrDelOnZero(se2.modify(brand_id,brand),(v2 * (EXT_PRICESTORE_SALES1_P_2.getValueOrDefault(se3.modify(date_dim_d_date_sk)) * v3)));
                      n3 = n3->nxt;
                    } while (n3 && (e3 = n3->obj) && h1 == n3->hash &&  EXT_PRICESTORE_SALES1_P_1_mapkey0_idxfn::equals(se4, *e3)); 
                  }
                }
              n2 = n2->nxt;
            }
          ...
          const HashIndex_EXT_PRICESTORE_SALES1_DELTA_map_01* i4 = static_cast<HashIndex_EXT_PRICESTORE_SALES1_DELTA_map_01*>(EXT_PRICESTORE_SALES1_DELTA.index[0]);
          HashIndex_EXT_PRICESTORE_SALES1_DELTA_map_01::IdxNode* n4; 
          ...
          for (size_t i = 0; i < i4->size_; i++)
          {
            ...
            while (n4 && (e4 = n4->obj))
            {
                ...
                EXT_PRICEITEM1.addOrDelOnZero(se5.modify(store_sales_ss_item_sk),(v4 * EXT_PRICESTORE_SALES1_P_2.getValueOrDefault(se6.modify(date_dim_d_date_sk))));
              n4 = n4->nxt;
            }
          }
        }
      ...
      { 
        ...
        {  
          for (size_t i = 0; i < DELTA_ITEM.size; i++) 
          {
                ...
                long v5 = 1L;
                (/*if */(lift1 == 36L) ? EXT_PRICEITEM1_DELTA.addOrDelOnZero(se7.modify(store_sales_ss_item_sk,item_i_brand_id,item_i_brand),v5) : (void)0);            
          }
        }

        {  // foreach
          const HashIndex_EXT_PRICEITEM1_DELTA_map_012* i6 = static_cast<HashIndex_EXT_PRICEITEM1_DELTA_map_012*>(EXT_PRICEITEM1_DELTA.index[0]);
          HashIndex_EXT_PRICEITEM1_DELTA_map_012::IdxNode* n6; 
          EXT_PRICEITEM1_DELTA_entry* e6;
          ...
          for (size_t i = 0; i < i6->size_; i++)
          {
            ...
            while (n6 && (e6 = n6->obj))
            {
                ...
                long brand_id = e6->BRAND_ID;
                STRING_TYPE brand = e6->BRAND;
                long v6 = e6->__av;
                EXT_PRICE.addOrDelOnZero(se8.modify(brand_id,brand),(v6 * EXT_PRICEITEM1.getValueOrDefault(se9.modify(store_sales_ss_item_sk))));
              n6 = n6->nxt;
            }
          }
        }{  // foreach
          const HashIndex_EXT_PRICEITEM1_DELTA_map_012* i7 = static_cast<HashIndex_EXT_PRICEITEM1_DELTA_map_012*>(EXT_PRICEITEM1_DELTA.index[0]);
          HashIndex_EXT_PRICEITEM1_DELTA_map_012::IdxNode* n7; 
          EXT_PRICEITEM1_DELTA_entry* e7;
          ...
          for (size_t i = 0; i < i7->size_; i++)
          {
            ...
            while (n7 && (e7 = n7->obj))
            {
                ...
                long v7 = e7->__av;
                EXT_PRICESTORE_SALES1_P_1.addOrDelOnZero(se10.modify(store_sales_ss_item_sk,brand,brand_id),v7);
              n7 = n7->nxt;
            }
          }
        }
    ...
    void on_system_ready_event() {
      {  
        ...
        long l2 = 12L;
        { //slice 
          const HashIndex_DATE_DIM_map_68* i8 = static_cast<HashIndex_DATE_DIM_map_68*>(DATE_DIM.index[1]);
          const HASH_RES_t h2 = DATE_DIM_mapkey68_idxfn::hash(se12.modify68(l1, l2));
          HashIndex_DATE_DIM_map_68::IdxNode* n8 = static_cast<HashIndex_DATE_DIM_map_68::IdxNode*>(i8->slice(se12, h2));
          DATE_DIM_entry* e8;
          ...
          if (n8 && (e8 = n8->obj)) {
            do {                
              ...
              STRING_TYPE date_dim_d_day_name = e8->DATE_DIM_D_DAY_NAME;
              ...
              long v8 = e8->__av;
              EXT_PRICESTORE_SALES1_P_2.addOrDelOnZero(se11.modify(date_dim_d_date_sk),v8);
              n8 = n8->nxt;
            } while (n8 && (e8 = n8->obj) && h2 == n8->hash &&  DATE_DIM_mapkey68_idxfn::equals(se12, *e8)); 
          }
        }
      }
    }
  ...
  private:
    ...
    EXT_PRICESTORE_SALES1_P_2_entry se6;
    EXT_PRICEITEM1_DELTA_entry se7;
    EXT_PRICE_entry se8;
    EXT_PRICEITEM1_entry se9;
    EXT_PRICESTORE_SALES1_P_1_entry se10;
