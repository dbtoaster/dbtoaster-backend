...
namespace dbtoaster {
  ...
  struct COUNT_entry {
    STRING_TYPE CUSTOMER_C_LAST_NAME; STRING_TYPE CUSTOMER_C_FIRST_NAME; STRING_TYPE CUSTOMER_C_SALUTATION; STRING_TYPE CUSTOMER_C_PREFERRED_CUST_FLAG; long DJ_SS_TICKET_NUMBER; long DJ_CNT; long __av; 
    explicit COUNT_entry() { /*CUSTOMER_C_LAST_NAME = ""; CUSTOMER_C_FIRST_NAME = ""; CUSTOMER_C_SALUTATION = ""; CUSTOMER_C_PREFERRED_CUST_FLAG = ""; DJ_SS_TICKET_NUMBER = 0L; DJ_CNT = 0L; __av = 0L; */ }
    explicit COUNT_entry(const STRING_TYPE& c0, const STRING_TYPE& c1, const STRING_TYPE& c2, const STRING_TYPE& c3, const long c4, const long c5, const long c6) { CUSTOMER_C_LAST_NAME = c0; CUSTOMER_C_FIRST_NAME = c1; CUSTOMER_C_SALUTATION = c2; CUSTOMER_C_PREFERRED_CUST_FLAG = c3; DJ_SS_TICKET_NUMBER = c4; DJ_CNT = c5; __av = c6; }
    COUNT_entry(const COUNT_entry& other) : CUSTOMER_C_LAST_NAME( other.CUSTOMER_C_LAST_NAME ), CUSTOMER_C_FIRST_NAME( other.CUSTOMER_C_FIRST_NAME ), CUSTOMER_C_SALUTATION( other.CUSTOMER_C_SALUTATION ), CUSTOMER_C_PREFERRED_CUST_FLAG( other.CUSTOMER_C_PREFERRED_CUST_FLAG ), DJ_SS_TICKET_NUMBER( other.DJ_SS_TICKET_NUMBER ), DJ_CNT( other.DJ_CNT ), __av( other.__av ) {}
    FORCE_INLINE COUNT_entry& modify(const STRING_TYPE& c0, const STRING_TYPE& c1, const STRING_TYPE& c2, const STRING_TYPE& c3, const long c4, const long c5) { CUSTOMER_C_LAST_NAME = c0; CUSTOMER_C_FIRST_NAME = c1; CUSTOMER_C_SALUTATION = c2; CUSTOMER_C_PREFERRED_CUST_FLAG = c3; DJ_SS_TICKET_NUMBER = c4; DJ_CNT = c5;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
      ...
      DBT_SERIALIZATION_NVP(ar, CUSTOMER_C_PREFERRED_CUST_FLAG);
      ar << ELEM_SEPARATOR;
      DBT_SERIALIZATION_NVP(ar, DJ_SS_TICKET_NUMBER);
      ar << ELEM_SEPARATOR;
      DBT_SERIALIZATION_NVP(ar, DJ_CNT);
      ar << ELEM_SEPARATOR;
      DBT_SERIALIZATION_NVP(ar, __av);
    }
  };
  struct COUNT_mapkey012345_idxfn {
    FORCE_INLINE static size_t hash(const COUNT_entry& e) {
      ...
      hash_combine(h, e.CUSTOMER_C_SALUTATION);
      hash_combine(h, e.CUSTOMER_C_PREFERRED_CUST_FLAG);
      hash_combine(h, e.DJ_SS_TICKET_NUMBER);
      hash_combine(h, e.DJ_CNT);
      return h;
    }
    FORCE_INLINE static bool equals(const COUNT_entry& x, const COUNT_entry& y) {
      return x.CUSTOMER_C_LAST_NAME == y.CUSTOMER_C_LAST_NAME && x.CUSTOMER_C_FIRST_NAME == y.CUSTOMER_C_FIRST_NAME && x.CUSTOMER_C_SALUTATION == y.CUSTOMER_C_SALUTATION && x.CUSTOMER_C_PREFERRED_CUST_FLAG == y.CUSTOMER_C_PREFERRED_CUST_FLAG && x.DJ_SS_TICKET_NUMBER == y.DJ_SS_TICKET_NUMBER && x.DJ_CNT == y.DJ_CNT;
    }
  };
  ...
  struct COUNTSTORE_SALES1_DOMAIN1_entry {
    long DJ_SS_TICKET_NUMBER; long __av; 
    explicit COUNTSTORE_SALES1_DOMAIN1_entry() { /*DJ_SS_TICKET_NUMBER = 0L; __av = 0L; */ }
    explicit COUNTSTORE_SALES1_DOMAIN1_entry(const long c0, const long c1) { DJ_SS_TICKET_NUMBER = c0; __av = c1; }
    COUNTSTORE_SALES1_DOMAIN1_entry(const COUNTSTORE_SALES1_DOMAIN1_entry& other) : DJ_SS_TICKET_NUMBER( other.DJ_SS_TICKET_NUMBER ), __av( other.__av ) {}
    FORCE_INLINE COUNTSTORE_SALES1_DOMAIN1_entry& modify(const long c0) { DJ_SS_TICKET_NUMBER = c0;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct COUNTSTORE_SALES1_DOMAIN1_mapkey0_idxfn {
    ...
    FORCE_INLINE static bool equals(const COUNTSTORE_SALES1_DOMAIN1_entry& x, const COUNTSTORE_SALES1_DOMAIN1_entry& y) {
      return x.DJ_SS_TICKET_NUMBER == y.DJ_SS_TICKET_NUMBER;
    }
  };
  ...
  struct COUNTSTORE_SALES3_L1_2_DELTA_entry {
    long STORE_SALES_SS_SOLD_DATE_SK; long CUSTOMER_C_CUSTOMER_SK; long STORE_SALES_SS_HDEMO_SK; long STORE_SALES_SS_STORE_SK; long DJ_SS_TICKET_NUMBER; long __av; 
    explicit COUNTSTORE_SALES3_L1_2_DELTA_entry() { /*STORE_SALES_SS_SOLD_DATE_SK = 0L; CUSTOMER_C_CUSTOMER_SK = 0L; STORE_SALES_SS_HDEMO_SK = 0L; STORE_SALES_SS_STORE_SK = 0L; DJ_SS_TICKET_NUMBER = 0L; __av = 0L; */ }
    explicit COUNTSTORE_SALES3_L1_2_DELTA_entry(const long c0, const long c1, const long c2, const long c3, const long c4, const long c5) { STORE_SALES_SS_SOLD_DATE_SK = c0; CUSTOMER_C_CUSTOMER_SK = c1; STORE_SALES_SS_HDEMO_SK = c2; STORE_SALES_SS_STORE_SK = c3; DJ_SS_TICKET_NUMBER = c4; __av = c5; }
    COUNTSTORE_SALES3_L1_2_DELTA_entry(const COUNTSTORE_SALES3_L1_2_DELTA_entry& other) : STORE_SALES_SS_SOLD_DATE_SK( other.STORE_SALES_SS_SOLD_DATE_SK ), CUSTOMER_C_CUSTOMER_SK( other.CUSTOMER_C_CUSTOMER_SK ), STORE_SALES_SS_HDEMO_SK( other.STORE_SALES_SS_HDEMO_SK ), STORE_SALES_SS_STORE_SK( other.STORE_SALES_SS_STORE_SK ), DJ_SS_TICKET_NUMBER( other.DJ_SS_TICKET_NUMBER ), __av( other.__av ) {}
    FORCE_INLINE COUNTSTORE_SALES3_L1_2_DELTA_entry& modify(const long c0, const long c1, const long c2, const long c3, const long c4) { STORE_SALES_SS_SOLD_DATE_SK = c0; CUSTOMER_C_CUSTOMER_SK = c1; STORE_SALES_SS_HDEMO_SK = c2; STORE_SALES_SS_STORE_SK = c3; DJ_SS_TICKET_NUMBER = c4;  return *this; }
    FORCE_INLINE COUNTSTORE_SALES3_L1_2_DELTA_entry& modify4(const long c4) { DJ_SS_TICKET_NUMBER = c4;  return *this; }
    FORCE_INLINE COUNTSTORE_SALES3_L1_2_DELTA_entry& modify14(const long c1, const long c4) { CUSTOMER_C_CUSTOMER_SK = c1; DJ_SS_TICKET_NUMBER = c4;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct COUNTSTORE_SALES3_L1_2_DELTA_mapkey01234_idxfn {
    ...
    FORCE_INLINE static bool equals(const COUNTSTORE_SALES3_L1_2_DELTA_entry& x, const COUNTSTORE_SALES3_L1_2_DELTA_entry& y) {
      return x.STORE_SALES_SS_SOLD_DATE_SK == y.STORE_SALES_SS_SOLD_DATE_SK && x.CUSTOMER_C_CUSTOMER_SK == y.CUSTOMER_C_CUSTOMER_SK && x.STORE_SALES_SS_HDEMO_SK == y.STORE_SALES_SS_HDEMO_SK && x.STORE_SALES_SS_STORE_SK == y.STORE_SALES_SS_STORE_SK && x.DJ_SS_TICKET_NUMBER == y.DJ_SS_TICKET_NUMBER;
    }
  };
  ...
  struct COUNTSTORE_SALES3_L1_2_DELTA_mapkey14_idxfn {
    ...
    FORCE_INLINE static bool equals(const COUNTSTORE_SALES3_L1_2_DELTA_entry& x, const COUNTSTORE_SALES3_L1_2_DELTA_entry& y) {
      return x.CUSTOMER_C_CUSTOMER_SK == y.CUSTOMER_C_CUSTOMER_SK && x.DJ_SS_TICKET_NUMBER == y.DJ_SS_TICKET_NUMBER;
    }
  };
  ...
  struct COUNTCUSTOMER1_E1_1_entry {
    long CUSTOMER_C_CUSTOMER_SK; long DJ_SS_TICKET_NUMBER; long __av; 
    explicit COUNTCUSTOMER1_E1_1_entry() { /*CUSTOMER_C_CUSTOMER_SK = 0L; DJ_SS_TICKET_NUMBER = 0L; __av = 0L; */ }
    explicit COUNTCUSTOMER1_E1_1_entry(const long c0, const long c1, const long c2) { CUSTOMER_C_CUSTOMER_SK = c0; DJ_SS_TICKET_NUMBER = c1; __av = c2; }
    COUNTCUSTOMER1_E1_1_entry(const COUNTCUSTOMER1_E1_1_entry& other) : CUSTOMER_C_CUSTOMER_SK( other.CUSTOMER_C_CUSTOMER_SK ), DJ_SS_TICKET_NUMBER( other.DJ_SS_TICKET_NUMBER ), __av( other.__av ) {}
    FORCE_INLINE COUNTCUSTOMER1_E1_1_entry& modify(const long c0, const long c1) { CUSTOMER_C_CUSTOMER_SK = c0; DJ_SS_TICKET_NUMBER = c1;  return *this; }
    FORCE_INLINE COUNTCUSTOMER1_E1_1_entry& modify1(const long c1) { DJ_SS_TICKET_NUMBER = c1;  return *this; }
  ...
  struct COUNTCUSTOMER1_E1_1STORE1_entry {
    long CUSTOMER_C_CUSTOMER_SK; long STORE_SALES_SS_STORE_SK; long DJ_SS_TICKET_NUMBER; long __av; 
    explicit COUNTCUSTOMER1_E1_1STORE1_entry() { /*CUSTOMER_C_CUSTOMER_SK = 0L; STORE_SALES_SS_STORE_SK = 0L; DJ_SS_TICKET_NUMBER = 0L; __av = 0L; */ }
    explicit COUNTCUSTOMER1_E1_1STORE1_entry(const long c0, const long c1, const long c2, const long c3) { CUSTOMER_C_CUSTOMER_SK = c0; STORE_SALES_SS_STORE_SK = c1; DJ_SS_TICKET_NUMBER = c2; __av = c3; }
    COUNTCUSTOMER1_E1_1STORE1_entry(const COUNTCUSTOMER1_E1_1STORE1_entry& other) : CUSTOMER_C_CUSTOMER_SK( other.CUSTOMER_C_CUSTOMER_SK ), STORE_SALES_SS_STORE_SK( other.STORE_SALES_SS_STORE_SK ), DJ_SS_TICKET_NUMBER( other.DJ_SS_TICKET_NUMBER ), __av( other.__av ) {}
    FORCE_INLINE COUNTCUSTOMER1_E1_1STORE1_entry& modify(const long c0, const long c1, const long c2) { CUSTOMER_C_CUSTOMER_SK = c0; STORE_SALES_SS_STORE_SK = c1; DJ_SS_TICKET_NUMBER = c2;  return *this; }
  ...
  struct COUNTCUSTOMER1_E1_1STORE1_mapkey012_idxfn {
    ...
    FORCE_INLINE static bool equals(const COUNTCUSTOMER1_E1_1STORE1_entry& x, const COUNTCUSTOMER1_E1_1STORE1_entry& y) {
      return x.CUSTOMER_C_CUSTOMER_SK == y.CUSTOMER_C_CUSTOMER_SK && x.STORE_SALES_SS_STORE_SK == y.STORE_SALES_SS_STORE_SK && x.DJ_SS_TICKET_NUMBER == y.DJ_SS_TICKET_NUMBER;
    }
  };
  ...
  struct data_t : tlq_t{
    data_t(): tlq_t(), _c1(16U), _c2(16U) {
      ...
      c5 = STRING_TYPE(">10000");
      c6 = STRING_TYPE("5001-10000");
      ...
      { 
        ...
        {  // foreach
          ...
          for (size_t i = 0; i < i3->size_; i++)
          {
            ...
            while (n3 && (e3 = n3->obj))
            {
                long dj_ss_ticket_number = e3->DJ_SS_TICKET_NUMBER;
                long v3 = e3->__av;
                _c1.clear();
                { //slice 
                  const HashIndex_COUNTCUSTOMER1_E1_1_map_1* i4 = static_cast<HashIndex_COUNTCUSTOMER1_E1_1_map_1*>(COUNTCUSTOMER1_E1_1.index[1]);
                  const HASH_RES_t h2 = COUNTCUSTOMER1_E1_1_mapkey1_idxfn::hash(se6.modify1(dj_ss_ticket_number));
                  ...
                  if (n4 && (e4 = n4->obj)) {
                    do {                
                      ...
                      long v5 = e4->__av;
                      long l1 = COUNTCUSTOMER1_E1_1.getValueOrDefault(se4.modify(customer_c_customer_sk,dj_ss_ticket_number));
                      { //slice 
                        ...
                        if (n5 && (e5 = n5->obj)) {
                          do {                
                            ...
                            long v6 = e5->__av;
                            (/*if */(5L >= l1 && l1 >= 1L) ? _c1.addOrDelOnZero(st1.modify(l1,customer_c_salutation,customer_c_first_name,customer_c_last_name,customer_c_preferred_cust_flag,(((v5 != 0 ? 1L : 0L) * v6) * -1L)), (((v5 != 0 ? 1L : 0L) * v6) * -1L)) : (void)0);
                            n5 = n5->nxt;
                ...
                { //slice 
                  ...
                  const HASH_RES_t h3 = COUNTCUSTOMER1_E1_1_mapkey1_idxfn::hash(se7.modify1(dj_ss_ticket_number));
                  ...
                  const HASH_RES_t h4 = COUNTSTORE_SALES3_L1_2_DELTA_mapkey4_idxfn::hash(se11.modify4(dj_ss_ticket_number));
                  ...
                  for (size_t i = 0; i < i8->size_; i++)
                  {
                    ...
                    { //slice 
                      ...
                      const HASH_RES_t h5 = COUNTSTORE_SALES3_L1_2_DELTA_mapkey14_idxfn::hash(se16.modify14(customer_c_customer_sk, dj_ss_ticket_number));
                    ...
                    }long l2 = (COUNTCUSTOMER1_E1_1.getValueOrDefault(se12.modify(customer_c_customer_sk,dj_ss_ticket_number)) + agg1);
                    { //slice 
                      ...
                      if (n10 && (e10 = n10->obj)) {
                        do {                
                          ...
                          long v12 = e10->__av;
                          (/*if */(5L >= l2 && l2 >= 1L) ? _c1.addOrDelOnZero(st4.modify(l2,customer_c_salutation,customer_c_first_name,customer_c_last_name,customer_c_preferred_cust_flag,((v10 != 0 ? 1L : 0L) * v12)), ((v10 != 0 ? 1L : 0L) * v12)) : (void)0);
                          n10 = n10->nxt;
                  ...
                  for (size_t i = 0; i < i11->size_; i++)
                  {
                    ...
                    while (n11 && (e11 = n11->obj))
                    {
                      ...
                      long v13 = e11->__av; 
                    COUNT.addOrDelOnZero(se3.modify(customer_c_last_name,customer_c_first_name,customer_c_salutation,customer_c_preferred_cust_flag,dj_ss_ticket_number,dj_cnt),((v3 != 0 ? 1L : 0L) * v13));      
                      n11 = n11->nxt;
                    }
                  }
                }
          ...
          for (size_t i = 0; i < i13->size_; i++)
          {
            ...
            while (n13 && (e13 = n13->obj))
            {
                ...
                long dj_ss_ticket_number = e13->DJ_SS_TICKET_NUMBER;
                long v15 = e13->__av;
                COUNTCUSTOMER1_E1_1STORE1.addOrDelOnZero(se22.modify(customer_c_customer_sk,store_sales_ss_store_sk,dj_ss_ticket_number),(v15 * (COUNTSTORE_SALES3_L1_2_P_1.getValueOrDefault(se23.modify(store_sales_ss_hdemo_sk)) * COUNTSTORE_SALES3_L1_2_P_3.getValueOrDefault(se24.modify(store_sales_ss_sold_date_sk)))));
              n13 = n13->nxt;
            }
          }
        }
          ...
          for (size_t i = 0; i < i15->size_; i++)
          {
            ...
            while (n15 && (e15 = n15->obj))
            {
                ...
                { //slice 
                  ...
                  if (n16 && (e16 = n16->obj)) {
                    do {                
                      long dj_ss_ticket_number = e16->DJ_SS_TICKET_NUMBER;
                      long v18 = e16->__av;
                      long l3 = COUNTCUSTOMER1_E1_1.getValueOrDefault(se27.modify(customer_c_customer_sk,dj_ss_ticket_number));
                      (/*if */(5L >= l3 && l3 >= 1L) ? COUNT.addOrDelOnZero(se26.modify(customer_c_last_name,customer_c_first_name,customer_c_salutation,customer_c_preferred_cust_flag,dj_ss_ticket_number,l3),(v17 * (v18 != 0 ? 1L : 0L))) : (void)0);
                      n16 = n16->nxt;
      ...
      { 
        ...
        {  
          for (size_t i = 0; i < DELTA_STORE.size; i++) 
          {
                ...
                long v20 = 1L;
                (/*if */(((store_s_county == c1) || (store_s_county == c2) || (store_s_county == c3) || (store_s_county == c4))) ? COUNTSTORE_SALES3_L1_2_P_2STORE1_DELTA.addOrDelOnZero(se30.modify(store_sales_ss_store_sk),v20) : (void)0);
          }
        }
                ...
                { //slice 
                  ...
                  if (n21 && (e21 = n21->obj)) {
                    do {                
                      ...
                      long dj_ss_ticket_number = e21->DJ_SS_TICKET_NUMBER;
                      long v23 = e21->__av;
                      COUNTCUSTOMER1_E1_1.addOrDelOnZero(se32.modify(customer_c_customer_sk,dj_ss_ticket_number),(v22 * v23));
                      n21 = n21->nxt;
          ...
          for (size_t i = 0; i < i22->size_; i++)
          {
            ...
            while (n22 && (e22 = n22->obj))
            {
                ...
                { //slice 
                  ...
                  if (n23 && (e23 = n23->obj)) {
                    do {                
                      long dj_ss_ticket_number = e23->DJ_SS_TICKET_NUMBER;
                      long v25 = e23->__av;
                      long l4 = COUNTCUSTOMER1_E1_1.getValueOrDefault(se35.modify(customer_c_customer_sk,dj_ss_ticket_number));
                      (/*if */(5L >= l4 && l4 >= 1L) ? COUNT.addOrDelOnZero(se34.modify(customer_c_last_name,customer_c_first_name,customer_c_salutation,customer_c_preferred_cust_flag,dj_ss_ticket_number,l4),(v24 * (v25 != 0 ? 1L : 0L))) : (void)0);
                      n23 = n23->nxt;
        ...
        {  // foreach
          ...
          for (size_t i = 0; i < i24->size_; i++)
          {
            ...
            while (n24 && (e24 = n24->obj))
            {
                ...
                long v26 = e24->__av;
                long l5 = ((/*if */(household_demographics_hd_buy_potential == c5) ? 1L : 0L) + (/*if */(household_demographics_hd_buy_potential == c6) ? 1L : 0L));
                DOUBLE_TYPE l6 = (household_demographics_hd_dep_count * Udiv(household_demographics_hd_vehicle_count));
                (/*if */(household_demographics_hd_vehicle_count > 0L && l5 > 0L && l6 > 1L) ? COUNTSTORE_SALES3_L1_2_P_1.addOrDelOnZero(se37.modify(store_sales_ss_hdemo_sk),v26) : (void)0);
              n24 = n24->nxt;
            }
          }
        ...
        {  // foreach
          ...
          for (size_t i = 0; i < i25->size_; i++)
          {
            ...
            while (n25 && (e25 = n25->obj))
            {
                ...
                long v27 = e25->__av;
                (/*if */(date_dim_d_dom >= 1L && 2L >= date_dim_d_dom && ((date_dim_d_year == 1998L) || (date_dim_d_year == 1999L) || (date_dim_d_year == 2000L))) ? COUNTSTORE_SALES3_L1_2_P_3.addOrDelOnZero(se38.modify(store_sales_ss_sold_date_sk),v27) : (void)0);
              n25 = n25->nxt;
            }
          }
        }
