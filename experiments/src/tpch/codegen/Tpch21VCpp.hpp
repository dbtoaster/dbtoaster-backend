...
namespace dbtoaster {
  ...
  struct NUMWAIT_mLINEITEM3_entry {
    long NUMWAIT_mLINEITEMLINEITEM_ORDERKEY; long __av; 
    explicit NUMWAIT_mLINEITEM3_entry() { /*NUMWAIT_mLINEITEMLINEITEM_ORDERKEY = 0L; __av = 0L; */ }
    explicit NUMWAIT_mLINEITEM3_entry(const long c0, const long c1) { NUMWAIT_mLINEITEMLINEITEM_ORDERKEY = c0; __av = c1; }
    NUMWAIT_mLINEITEM3_entry(const NUMWAIT_mLINEITEM3_entry& other) : NUMWAIT_mLINEITEMLINEITEM_ORDERKEY( other.NUMWAIT_mLINEITEMLINEITEM_ORDERKEY ), __av( other.__av ) {}
    FORCE_INLINE NUMWAIT_mLINEITEM3_entry& modify(const long c0) { NUMWAIT_mLINEITEMLINEITEM_ORDERKEY = c0;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct NUMWAIT_mLINEITEM3_mapkey0_idxfn {
    FORCE_INLINE static size_t hash(const NUMWAIT_mLINEITEM3_entry& e) {
      size_t h = 0;
      hash_combine(h, e.NUMWAIT_mLINEITEMLINEITEM_ORDERKEY);
      return h;
    }
    FORCE_INLINE static bool equals(const NUMWAIT_mLINEITEM3_entry& x, const NUMWAIT_mLINEITEM3_entry& y) {
      return x.NUMWAIT_mLINEITEMLINEITEM_ORDERKEY == y.NUMWAIT_mLINEITEMLINEITEM_ORDERKEY;
    }
  };
  
  typedef MultiHashMap<NUMWAIT_mLINEITEM3_entry,long,
    HashIndex<NUMWAIT_mLINEITEM3_entry,long,NUMWAIT_mLINEITEM3_mapkey0_idxfn,true>
  > NUMWAIT_mLINEITEM3_map;
  typedef HashIndex<NUMWAIT_mLINEITEM3_entry,long,NUMWAIT_mLINEITEM3_mapkey0_idxfn,true> HashIndex_NUMWAIT_mLINEITEM3_map_0;
  
  struct NUMWAIT_mLINEITEM7_entry {
    long NUMWAIT_mLINEITEMLINEITEM_ORDERKEY; long S_SUPPKEY; STRING_TYPE S_NAME; long __av; 
    explicit NUMWAIT_mLINEITEM7_entry() { /*NUMWAIT_mLINEITEMLINEITEM_ORDERKEY = 0L; S_SUPPKEY = 0L; S_NAME = ""; __av = 0L; */ }
    explicit NUMWAIT_mLINEITEM7_entry(const long c0, const long c1, const STRING_TYPE& c2, const long c3) { NUMWAIT_mLINEITEMLINEITEM_ORDERKEY = c0; S_SUPPKEY = c1; S_NAME = c2; __av = c3; }
    NUMWAIT_mLINEITEM7_entry(const NUMWAIT_mLINEITEM7_entry& other) : NUMWAIT_mLINEITEMLINEITEM_ORDERKEY( other.NUMWAIT_mLINEITEMLINEITEM_ORDERKEY ), S_SUPPKEY( other.S_SUPPKEY ), S_NAME( other.S_NAME ), __av( other.__av ) {}
    FORCE_INLINE NUMWAIT_mLINEITEM7_entry& modify(const long c0, const long c1, const STRING_TYPE& c2) { NUMWAIT_mLINEITEMLINEITEM_ORDERKEY = c0; S_SUPPKEY = c1; S_NAME = c2;  return *this; }
    FORCE_INLINE NUMWAIT_mLINEITEM7_entry& modify0(const long c0) { NUMWAIT_mLINEITEMLINEITEM_ORDERKEY = c0;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct NUMWAIT_mLINEITEM7_mapkey012_idxfn {
    ...
    FORCE_INLINE static bool equals(const NUMWAIT_mLINEITEM7_entry& x, const NUMWAIT_mLINEITEM7_entry& y) {
      return x.NUMWAIT_mLINEITEMLINEITEM_ORDERKEY == y.NUMWAIT_mLINEITEMLINEITEM_ORDERKEY && x.S_SUPPKEY == y.S_SUPPKEY && x.S_NAME == y.S_NAME;
    }
  };
  
  struct NUMWAIT_mLINEITEM7_mapkey0_idxfn {
    FORCE_INLINE static size_t hash(const NUMWAIT_mLINEITEM7_entry& e) {
      size_t h = 0;
      hash_combine(h, e.NUMWAIT_mLINEITEMLINEITEM_ORDERKEY);
      return h;
  ...
  typedef MultiHashMap<NUMWAIT_mLINEITEM7_entry,long,
    ...
    HashIndex<NUMWAIT_mLINEITEM7_entry,long,NUMWAIT_mLINEITEM7_mapkey0_idxfn,false>
  ...
  typedef HashIndex<NUMWAIT_mLINEITEM7_entry,long,NUMWAIT_mLINEITEM7_mapkey0_idxfn,false> HashIndex_NUMWAIT_mLINEITEM7_map_0;
  ...
  struct data_t : tlq_t{
    ...
    void on_insert_LINEITEM(const long lineitem_orderkey, const long lineitem_partkey, const long lineitem_suppkey, const long lineitem_linenumber, const DOUBLE_TYPE lineitem_quantity, const DOUBLE_TYPE lineitem_extendedprice, const DOUBLE_TYPE lineitem_discount, const DOUBLE_TYPE lineitem_tax, const STRING_TYPE& lineitem_returnflag, const STRING_TYPE& lineitem_linestatus, const date lineitem_shipdate, const date lineitem_commitdate, const date lineitem_receiptdate, const STRING_TYPE& lineitem_shipinstruct, const STRING_TYPE& lineitem_shipmode, const STRING_TYPE& lineitem_comment) {
      {  //++tN;
        ...
        long agg2 = 0L;
        { //slice 
          const HashIndex_NUMWAIT_mSUPPLIER1_L2_1_map_0* i1 = static_cast<HashIndex_NUMWAIT_mSUPPLIER1_L2_1_map_0*>(NUMWAIT_mSUPPLIER1_L2_1.index[1]);
          const HASH_RES_t h1 = NUMWAIT_mSUPPLIER1_L2_1_mapkey0_idxfn::hash(se3.modify0(lineitem_orderkey));
          HashIndex_NUMWAIT_mSUPPLIER1_L2_1_map_0::IdxNode* n1 = static_cast<HashIndex_NUMWAIT_mSUPPLIER1_L2_1_map_0::IdxNode*>(i1->slice(se3, h1));
          NUMWAIT_mSUPPLIER1_L2_1_entry* e1;
          ...
          if (n1 && (e1 = n1->obj)) {
            do {                
              ...
              n1 = n1->nxt;
            } while (n1 && (e1 = n1->obj) && h1 == n1->hash &&  NUMWAIT_mSUPPLIER1_L2_1_mapkey0_idxfn::equals(se3, *e1)); 
          }
        }long l1 = agg2;
        (/*if */(l1 == 0L) ? agg1 += 1L : 0L);
        { //slice 
          const HashIndex_NUMWAIT_mLINEITEM2_map_0* i2 = static_cast<HashIndex_NUMWAIT_mLINEITEM2_map_0*>(NUMWAIT_mLINEITEM2.index[1]);
          const HASH_RES_t h3 = NUMWAIT_mLINEITEM2_mapkey0_idxfn::hash(se5.modify0(lineitem_suppkey));
          HashIndex_NUMWAIT_mLINEITEM2_map_0::IdxNode* n2 = static_cast<HashIndex_NUMWAIT_mLINEITEM2_map_0::IdxNode*>(i2->slice(se5, h3));
          NUMWAIT_mLINEITEM2_entry* e2;
          ...
          if (n2 && (e2 = n2->obj)) {
            do {                
              ...
              }(/*if */(lineitem_receiptdate > lineitem_commitdate) ? NUMWAIT.addOrDelOnZero(se1.modify(s_name),(NUMWAIT_mLINEITEM3.getValueOrDefault(se2.modify(lineitem_orderkey)) * (agg1 * (v2 * (agg3 != 0 ? 1L : 0L))))) : (void)0);
              n2 = n2->nxt;
            } while (n2 && (e2 = n2->obj) && h3 == n2->hash &&  NUMWAIT_mLINEITEM2_mapkey0_idxfn::equals(se5, *e2)); 
          }
        }long l2 = 0L;
        { //slice 
          const HashIndex_NUMWAIT_mLINEITEM7_map_0* i4 = static_cast<HashIndex_NUMWAIT_mLINEITEM7_map_0*>(NUMWAIT_mLINEITEM7.index[1]);
          const HASH_RES_t h6 = NUMWAIT_mLINEITEM7_mapkey0_idxfn::hash(se8.modify0(lineitem_orderkey));
          HashIndex_NUMWAIT_mLINEITEM7_map_0::IdxNode* n4 = static_cast<HashIndex_NUMWAIT_mLINEITEM7_map_0::IdxNode*>(i4->slice(se8, h6));
          ...
          if (n4 && (e4 = n4->obj)) {
            do {                
              ...
              }(/*if */(l2 == agg4) ? NUMWAIT.addOrDelOnZero(se1.modify(s_name),(NUMWAIT_mLINEITEM3.getValueOrDefault(se2.modify(lineitem_orderkey)) * ((v4 * (agg5 != 0 ? 1L : 0L)) * -1L))) : (void)0);
              n4 = n4->nxt;
            } while (n4 && (e4 = n4->obj) && h6 == n4->hash &&  NUMWAIT_mLINEITEM7_mapkey0_idxfn::equals(se8, *e4)); 
          }
        }long l3 = 0L;
        { //slice 
          const HashIndex_NUMWAIT_mLINEITEM7_map_0* i7 = static_cast<HashIndex_NUMWAIT_mLINEITEM7_map_0*>(NUMWAIT_mLINEITEM7.index[1]);
          const HASH_RES_t h9 = NUMWAIT_mLINEITEM7_mapkey0_idxfn::hash(se11.modify0(lineitem_orderkey));
          HashIndex_NUMWAIT_mLINEITEM7_map_0::IdxNode* n7 = static_cast<HashIndex_NUMWAIT_mLINEITEM7_map_0::IdxNode*>(i7->slice(se11, h9));
          NUMWAIT_mLINEITEM7_entry* e7;
          ...
          if (n7 && (e7 = n7->obj)) {
            do {                
              ...
              long agg6 = 0L;
              { //slice 
                const HashIndex_NUMWAIT_mSUPPLIER1_L2_1_map_0* i8 = static_cast<HashIndex_NUMWAIT_mSUPPLIER1_L2_1_map_0*>(NUMWAIT_mSUPPLIER1_L2_1.index[1]);
                const HASH_RES_t h7 = NUMWAIT_mSUPPLIER1_L2_1_mapkey0_idxfn::hash(se9.modify0(lineitem_orderkey));
                HashIndex_NUMWAIT_mSUPPLIER1_L2_1_map_0::IdxNode* n8 = static_cast<HashIndex_NUMWAIT_mSUPPLIER1_L2_1_map_0::IdxNode*>(i8->slice(se9, h7));
                NUMWAIT_mSUPPLIER1_L2_1_entry* e8;
                ...
                if (n8 && (e8 = n8->obj)) {
                  do {                
                    ...
                    n8 = n8->nxt;
                  } while (n8 && (e8 = n8->obj) && h7 == n8->hash &&  NUMWAIT_mSUPPLIER1_L2_1_mapkey0_idxfn::equals(se9, *e8)); 
                }
              }long agg7 = 0L;
              { //slice 
                const HashIndex_NUMWAIT_mSUPPLIER1_E3_1_map_0* i9 = static_cast<HashIndex_NUMWAIT_mSUPPLIER1_E3_1_map_0*>(NUMWAIT_mSUPPLIER1_E3_1.index[1]);
                const HASH_RES_t h8 = NUMWAIT_mSUPPLIER1_E3_1_mapkey0_idxfn::hash(se10.modify0(lineitem_orderkey));
                HashIndex_NUMWAIT_mSUPPLIER1_E3_1_map_0::IdxNode* n9 = static_cast<HashIndex_NUMWAIT_mSUPPLIER1_E3_1_map_0::IdxNode*>(i9->slice(se10, h8));
                NUMWAIT_mSUPPLIER1_E3_1_entry* e9;
                ...
                if (n9 && (e9 = n9->obj)) {
                  do {                
                    ...
                    n9 = n9->nxt;
                  } while (n9 && (e9 = n9->obj) && h8 == n9->hash &&  NUMWAIT_mSUPPLIER1_E3_1_mapkey0_idxfn::equals(se10, *e9)); 
                }
              }(/*if */(l3 == (agg6 + (/*if */(lineitem_suppkey != s_suppkey && lineitem_receiptdate > lineitem_commitdate) ? 1L : 0L))) ? NUMWAIT.addOrDelOnZero(se1.modify(s_name),(NUMWAIT_mLINEITEM3.getValueOrDefault(se2.modify(lineitem_orderkey)) * (v7 * ((agg7 + (/*if */(lineitem_suppkey != s_suppkey) ? 1L : 0L)) != 0 ? 1L : 0L)))) : (void)0);
              n7 = n7->nxt;
            } while (n7 && (e7 = n7->obj) && h9 == n7->hash &&  NUMWAIT_mLINEITEM7_mapkey0_idxfn::equals(se11, *e7)); 
          }
        }{ //slice 
          ...
          if (n10 && (e10 = n10->obj)) {
            do {                
              ...
              long v10 = e10->__av;
              (/*if */(lineitem_receiptdate > lineitem_commitdate) ? NUMWAIT_mLINEITEM7.addOrDelOnZero(se12.modify(lineitem_orderkey,lineitem_suppkey,s_name),v10) : (void)0);
              n10 = n10->nxt;
            } while (n10 && (e10 = n10->obj) && h10 == n10->hash &&  NUMWAIT_mLINEITEM2_mapkey0_idxfn::equals(se13, *e10)); 
          }
        }(/*if */(lineitem_receiptdate > lineitem_commitdate) ? NUMWAIT_mSUPPLIER1.addOrDelOnZero(se14.modify(lineitem_orderkey,lineitem_suppkey),NUMWAIT_mLINEITEM3.getValueOrDefault(se15.modify(lineitem_orderkey))) : (void)0);
    ...
    void on_delete_LINEITEM(const long lineitem_orderkey, const long lineitem_partkey, const long lineitem_suppkey, const long lineitem_linenumber, const DOUBLE_TYPE lineitem_quantity, const DOUBLE_TYPE lineitem_extendedprice, const DOUBLE_TYPE lineitem_discount, const DOUBLE_TYPE lineitem_tax, const STRING_TYPE& lineitem_returnflag, const STRING_TYPE& lineitem_linestatus, const date lineitem_shipdate, const date lineitem_commitdate, const date lineitem_receiptdate, const STRING_TYPE& lineitem_shipinstruct, const STRING_TYPE& lineitem_shipmode, const STRING_TYPE& lineitem_comment) {
      {  //++tN;
        ...
        long agg9 = 0L;
        { //slice 
          const HashIndex_NUMWAIT_mSUPPLIER1_L2_1_map_0* i11 = static_cast<HashIndex_NUMWAIT_mSUPPLIER1_L2_1_map_0*>(NUMWAIT_mSUPPLIER1_L2_1.index[1]);
          const HASH_RES_t h11 = NUMWAIT_mSUPPLIER1_L2_1_mapkey0_idxfn::hash(se20.modify0(lineitem_orderkey));
          HashIndex_NUMWAIT_mSUPPLIER1_L2_1_map_0::IdxNode* n11 = static_cast<HashIndex_NUMWAIT_mSUPPLIER1_L2_1_map_0::IdxNode*>(i11->slice(se20, h11));
          NUMWAIT_mSUPPLIER1_L2_1_entry* e11;
         
          if (n11 && (e11 = n11->obj)) {
            do {                
              long l3_suppkey = e11->L3_SUPPKEY;
              long v11 = e11->__av;
              (/*if */(l3_suppkey != lineitem_suppkey) ? agg9 += v11 : 0L);
              n11 = n11->nxt;
            } while (n11 && (e11 = n11->obj) && h11 == n11->hash &&  NUMWAIT_mSUPPLIER1_L2_1_mapkey0_idxfn::equals(se20, *e11)); 
          }
        }long l4 = agg9;
        (/*if */(l4 == 0L) ? agg8 += 1L : 0L);
        { //slice 
          const HashIndex_NUMWAIT_mLINEITEM2_map_0* i12 = static_cast<HashIndex_NUMWAIT_mLINEITEM2_map_0*>(NUMWAIT_mLINEITEM2.index[1]);
          const HASH_RES_t h13 = NUMWAIT_mLINEITEM2_mapkey0_idxfn::hash(se22.modify0(lineitem_suppkey));
          HashIndex_NUMWAIT_mLINEITEM2_map_0::IdxNode* n12 = static_cast<HashIndex_NUMWAIT_mLINEITEM2_map_0::IdxNode*>(i12->slice(se22, h13));
          NUMWAIT_mLINEITEM2_entry* e12;
              ...
              { //slice 
                ...
                if (n13 && (e13 = n13->obj)) {
                  do {                
                    ...
                    long v13 = e13->__av;
                    (/*if */(l2_suppkey != lineitem_suppkey) ? agg10 += v13 : 0L);
                    n13 = n13->nxt;
                  } while (n13 && (e13 = n13->obj) && h12 == n13->hash &&  NUMWAIT_mSUPPLIER1_E3_1_mapkey0_idxfn::equals(se21, *e13)); 
                }
              }(/*if */(lineitem_receiptdate > lineitem_commitdate) ? NUMWAIT.addOrDelOnZero(se18.modify(s_name),(NUMWAIT_mLINEITEM3.getValueOrDefault(se19.modify(lineitem_orderkey)) * (agg8 * (v12 * ((agg10 != 0 ? 1L : 0L) * -1L))))) : (void)0);
              n12 = n12->nxt;
            } while (n12 && (e12 = n12->obj) && h13 == n12->hash &&  NUMWAIT_mLINEITEM2_mapkey0_idxfn::equals(se22, *e12)); 
          }
        }long l5 = 0L;
        { //slice 
          const HashIndex_NUMWAIT_mLINEITEM7_map_0* i14 = static_cast<HashIndex_NUMWAIT_mLINEITEM7_map_0*>(NUMWAIT_mLINEITEM7.index[1]);
          const HASH_RES_t h16 = NUMWAIT_mLINEITEM7_mapkey0_idxfn::hash(se25.modify0(lineitem_orderkey));
          HashIndex_NUMWAIT_mLINEITEM7_map_0::IdxNode* n14 = static_cast<HashIndex_NUMWAIT_mLINEITEM7_map_0::IdxNode*>(i14->slice(se25, h16));
              ...
              { //slice 
                ...
                if (n15 && (e15 = n15->obj)) {
                  do {                
                    ...
                    long v15 = e15->__av;
                    (/*if */(l3_suppkey != s_suppkey) ? agg11 += v15 : 0L);
                    n15 = n15->nxt;
              ...
              { //slice 
                ...
                if (n16 && (e16 = n16->obj)) {
                  do {                
                    ...
                    long v16 = e16->__av;
                    (/*if */(l2_suppkey != s_suppkey) ? agg12 += v16 : 0L);
                    n16 = n16->nxt;
                  } while (n16 && (e16 = n16->obj) && h15 == n16->hash &&  NUMWAIT_mSUPPLIER1_E3_1_mapkey0_idxfn::equals(se24, *e16)); 
                }
              }(/*if */(l5 == agg11) ? NUMWAIT.addOrDelOnZero(se18.modify(s_name),(NUMWAIT_mLINEITEM3.getValueOrDefault(se19.modify(lineitem_orderkey)) * ((v14 * (agg12 != 0 ? 1L : 0L)) * -1L))) : (void)0);
              n14 = n14->nxt;
            } while (n14 && (e14 = n14->obj) && h16 == n14->hash &&  NUMWAIT_mLINEITEM7_mapkey0_idxfn::equals(se25, *e14)); 
          }
        }long l6 = 0L;
        { //slice 
          const HashIndex_NUMWAIT_mLINEITEM7_map_0* i17 = static_cast<HashIndex_NUMWAIT_mLINEITEM7_map_0*>(NUMWAIT_mLINEITEM7.index[1]);
          const HASH_RES_t h19 = NUMWAIT_mLINEITEM7_mapkey0_idxfn::hash(se28.modify0(lineitem_orderkey));
          HashIndex_NUMWAIT_mLINEITEM7_map_0::IdxNode* n17 = static_cast<HashIndex_NUMWAIT_mLINEITEM7_map_0::IdxNode*>(i17->slice(se28, h19));
          NUMWAIT_mLINEITEM7_entry* e17;
          ...
          if (n17 && (e17 = n17->obj)) {
            do {                
              ...
              long agg13 = 0L;
              { //slice 
                const HashIndex_NUMWAIT_mSUPPLIER1_L2_1_map_0* i18 = static_cast<HashIndex_NUMWAIT_mSUPPLIER1_L2_1_map_0*>(NUMWAIT_mSUPPLIER1_L2_1.index[1]);
                const HASH_RES_t h17 = NUMWAIT_mSUPPLIER1_L2_1_mapkey0_idxfn::hash(se26.modify0(lineitem_orderkey));
                HashIndex_NUMWAIT_mSUPPLIER1_L2_1_map_0::IdxNode* n18 = static_cast<HashIndex_NUMWAIT_mSUPPLIER1_L2_1_map_0::IdxNode*>(i18->slice(se26, h17));
                NUMWAIT_mSUPPLIER1_L2_1_entry* e18;
               
                if (n18 && (e18 = n18->obj)) {
                  do {                
                    long l3_suppkey = e18->L3_SUPPKEY;
                    long v18 = e18->__av;
                    (/*if */(l3_suppkey != s_suppkey) ? agg13 += v18 : 0L);
                    n18 = n18->nxt;
                  } while (n18 && (e18 = n18->obj) && h17 == n18->hash &&  NUMWAIT_mSUPPLIER1_L2_1_mapkey0_idxfn::equals(se26, *e18)); 
                }
              }long agg14 = 0L;
              { //slice 
                const HashIndex_NUMWAIT_mSUPPLIER1_E3_1_map_0* i19 = static_cast<HashIndex_NUMWAIT_mSUPPLIER1_E3_1_map_0*>(NUMWAIT_mSUPPLIER1_E3_1.index[1]);
                const HASH_RES_t h18 = NUMWAIT_mSUPPLIER1_E3_1_mapkey0_idxfn::hash(se27.modify0(lineitem_orderkey));
                HashIndex_NUMWAIT_mSUPPLIER1_E3_1_map_0::IdxNode* n19 = static_cast<HashIndex_NUMWAIT_mSUPPLIER1_E3_1_map_0::IdxNode*>(i19->slice(se27, h18));
                NUMWAIT_mSUPPLIER1_E3_1_entry* e19;
               
                if (n19 && (e19 = n19->obj)) {
                  do {                
                    long l2_suppkey = e19->L2_SUPPKEY;
                    long v19 = e19->__av;
                    (/*if */(l2_suppkey != s_suppkey) ? agg14 += v19 : 0L);
                    n19 = n19->nxt;
                  } while (n19 && (e19 = n19->obj) && h18 == n19->hash &&  NUMWAIT_mSUPPLIER1_E3_1_mapkey0_idxfn::equals(se27, *e19)); 
                }
              }(/*if */(l6 == (agg13 + (/*if */(lineitem_suppkey != s_suppkey && lineitem_receiptdate > lineitem_commitdate) ? -1L : 0L))) ? NUMWAIT.addOrDelOnZero(se18.modify(s_name),(NUMWAIT_mLINEITEM3.getValueOrDefault(se19.modify(lineitem_orderkey)) * (v17 * ((agg14 + (/*if */(lineitem_suppkey != s_suppkey) ? -1L : 0L)) != 0 ? 1L : 0L)))) : (void)0);
              n17 = n17->nxt;
            } while (n17 && (e17 = n17->obj) && h19 == n17->hash &&  NUMWAIT_mLINEITEM7_mapkey0_idxfn::equals(se28, *e17)); 
          }
        }{ //slice 
          ...
          if (n20 && (e20 = n20->obj)) {
            do {                
              ...
              long v20 = e20->__av;
              (/*if */(lineitem_receiptdate > lineitem_commitdate) ? NUMWAIT_mLINEITEM7.addOrDelOnZero(se29.modify(lineitem_orderkey,lineitem_suppkey,s_name),(v20 * -1L)) : (void)0);
              n20 = n20->nxt;
            } while (n20 && (e20 = n20->obj) && h20 == n20->hash &&  NUMWAIT_mLINEITEM2_mapkey0_idxfn::equals(se30, *e20)); 
          }
        }(/*if */(lineitem_receiptdate > lineitem_commitdate) ? NUMWAIT_mSUPPLIER1.addOrDelOnZero(se31.modify(lineitem_orderkey,lineitem_suppkey),(NUMWAIT_mLINEITEM3.getValueOrDefault(se32.modify(lineitem_orderkey)) * -1L)) : (void)0);
    ...
    void on_insert_ORDERS(const long orders_orderkey, const long orders_custkey, const STRING_TYPE& orders_orderstatus, const DOUBLE_TYPE orders_totalprice, const date orders_orderdate, const STRING_TYPE& orders_orderpriority, const STRING_TYPE& orders_clerk, const long orders_shippriority, const STRING_TYPE& orders_comment) {
      {  //++tN;
        long l7 = 0L;
        { //slice 
          const HashIndex_NUMWAIT_mLINEITEM7_map_0* i21 = static_cast<HashIndex_NUMWAIT_mLINEITEM7_map_0*>(NUMWAIT_mLINEITEM7.index[1]);
          const HASH_RES_t h23 = NUMWAIT_mLINEITEM7_mapkey0_idxfn::hash(se38.modify0(orders_orderkey));
          HashIndex_NUMWAIT_mLINEITEM7_map_0::IdxNode* n21 = static_cast<HashIndex_NUMWAIT_mLINEITEM7_map_0::IdxNode*>(i21->slice(se38, h23));
          ...
          if (n21 && (e21 = n21->obj)) {
            do {                
              ...
              n21 = n21->nxt;
            } while (n21 && (e21 = n21->obj) && h23 == n21->hash &&  NUMWAIT_mLINEITEM7_mapkey0_idxfn::equals(se38, *e21)); 
          }
        }(/*if */(orders_orderstatus == c1) ? NUMWAIT_mLINEITEM3.addOrDelOnZero(se39.modify(orders_orderkey),1L) : (void)0);
        { //slice 
    ...
    void on_delete_ORDERS(const long orders_orderkey, const long orders_custkey, const STRING_TYPE& orders_orderstatus, const DOUBLE_TYPE orders_totalprice, const date orders_orderdate, const STRING_TYPE& orders_orderpriority, const STRING_TYPE& orders_clerk, const long orders_shippriority, const STRING_TYPE& orders_comment) {
      {  //++tN;
        long l8 = 0L;
        { //slice 
          const HashIndex_NUMWAIT_mLINEITEM7_map_0* i25 = static_cast<HashIndex_NUMWAIT_mLINEITEM7_map_0*>(NUMWAIT_mLINEITEM7.index[1]);
          const HASH_RES_t h27 = NUMWAIT_mLINEITEM7_mapkey0_idxfn::hash(se45.modify0(orders_orderkey));
          HashIndex_NUMWAIT_mLINEITEM7_map_0::IdxNode* n25 = static_cast<HashIndex_NUMWAIT_mLINEITEM7_map_0::IdxNode*>(i25->slice(se45, h27));
          ...
          if (n25 && (e25 = n25->obj)) {
            do {                
              ...
              n25 = n25->nxt;
            } while (n25 && (e25 = n25->obj) && h27 == n25->hash &&  NUMWAIT_mLINEITEM7_mapkey0_idxfn::equals(se45, *e25)); 
          }
        }(/*if */(orders_orderstatus == c1) ? NUMWAIT_mLINEITEM3.addOrDelOnZero(se46.modify(orders_orderkey),-1L) : (void)0);
        { //slice 
    ...
    void on_insert_SUPPLIER(const long supplier_suppkey, const STRING_TYPE& supplier_name, const STRING_TYPE& supplier_address, const long supplier_nationkey, const STRING_TYPE& supplier_phone, const DOUBLE_TYPE supplier_acctbal, const STRING_TYPE& supplier_comment) {
      {  //++tN;
        ...
        { //slice 
          ...
          const HASH_RES_t h31 = NUMWAIT_mSUPPLIER1_mapkey1_idxfn::hash(se53.modify1(supplier_suppkey));
          HashIndex_NUMWAIT_mSUPPLIER1_map_1::IdxNode* n29 = static_cast<HashIndex_NUMWAIT_mSUPPLIER1_map_1::IdxNode*>(i29->slice(se53, h31));
          ...
          if (n29 && (e29 = n29->obj)) {
            do {                
              ...
              { //slice 
                ...
                const HASH_RES_t h29 = NUMWAIT_mSUPPLIER1_L2_1_mapkey0_idxfn::hash(se51.modify0(l1_orderkey));
                HashIndex_NUMWAIT_mSUPPLIER1_L2_1_map_0::IdxNode* n30 = static_cast<HashIndex_NUMWAIT_mSUPPLIER1_L2_1_map_0::IdxNode*>(i30->slice(se51, h29));
                ...
                if (n30 && (e30 = n30->obj)) {
                  do {                
                    ...
                    n30 = n30->nxt;
                  } while (n30 && (e30 = n30->obj) && h29 == n30->hash &&  NUMWAIT_mSUPPLIER1_L2_1_mapkey0_idxfn::equals(se51, *e30)); 
                }
              }long agg21 = 0L;
              { //slice 
                ...
                const HASH_RES_t h30 = NUMWAIT_mSUPPLIER1_E3_1_mapkey0_idxfn::hash(se52.modify0(l1_orderkey));
                HashIndex_NUMWAIT_mSUPPLIER1_E3_1_map_0::IdxNode* n31 = static_cast<HashIndex_NUMWAIT_mSUPPLIER1_E3_1_map_0::IdxNode*>(i31->slice(se52, h30));
                ...
                if (n31 && (e31 = n31->obj)) {
                  do {                
                    ...
                    n31 = n31->nxt;
                  } while (n31 && (e31 = n31->obj) && h30 == n31->hash &&  NUMWAIT_mSUPPLIER1_E3_1_mapkey0_idxfn::equals(se52, *e31)); 
                }
              }(/*if */(l9 == agg20) ? agg19 += (v29 * (agg21 != 0 ? 1L : 0L)) : 0L);
              n29 = n29->nxt;
            } while (n29 && (e29 = n29->obj) && h31 == n29->hash &&  NUMWAIT_mSUPPLIER1_mapkey1_idxfn::equals(se53, *e29)); 
          }
        }NUMWAIT.addOrDelOnZero(se49.modify(supplier_name),(NUMWAIT_mSUPPLIER2.getValueOrDefault(se50.modify(supplier_nationkey)) * agg19));
        ...
        { //slice 
          ...
          if (n32 && (e32 = n32->obj)) {
            do {                
              ...
              long v32 = e32->__av;
              NUMWAIT_mLINEITEM7.addOrDelOnZero(se56.modify(numwait_mlineitemlineitem_orderkey,supplier_suppkey,supplier_name),(NUMWAIT_mSUPPLIER2.getValueOrDefault(se57.modify(supplier_nationkey)) * v32));
              n32 = n32->nxt;
    ...
    void on_delete_SUPPLIER(const long supplier_suppkey, const STRING_TYPE& supplier_name, const STRING_TYPE& supplier_address, const long supplier_nationkey, const STRING_TYPE& supplier_phone, const DOUBLE_TYPE supplier_acctbal, const STRING_TYPE& supplier_comment) {
      {  //++tN;
        ...
        { //slice 
          ...
          const HASH_RES_t h35 = NUMWAIT_mSUPPLIER1_mapkey1_idxfn::hash(se63.modify1(supplier_suppkey));
          HashIndex_NUMWAIT_mSUPPLIER1_map_1::IdxNode* n33 = static_cast<HashIndex_NUMWAIT_mSUPPLIER1_map_1::IdxNode*>(i33->slice(se63, h35));
          ...
          if (n33 && (e33 = n33->obj)) {
            do {                
              ...
              { //slice 
                ...
                const HASH_RES_t h33 = NUMWAIT_mSUPPLIER1_L2_1_mapkey0_idxfn::hash(se61.modify0(l1_orderkey));
                HashIndex_NUMWAIT_mSUPPLIER1_L2_1_map_0::IdxNode* n34 = static_cast<HashIndex_NUMWAIT_mSUPPLIER1_L2_1_map_0::IdxNode*>(i34->slice(se61, h33));
                ...
                if (n34 && (e34 = n34->obj)) {
                  do {                
                    ...
                    n34 = n34->nxt;
                  } while (n34 && (e34 = n34->obj) && h33 == n34->hash &&  NUMWAIT_mSUPPLIER1_L2_1_mapkey0_idxfn::equals(se61, *e34)); 
                }
              }long agg24 = 0L;
              { //slice 
                ...
                const HASH_RES_t h34 = NUMWAIT_mSUPPLIER1_E3_1_mapkey0_idxfn::hash(se62.modify0(l1_orderkey));
                HashIndex_NUMWAIT_mSUPPLIER1_E3_1_map_0::IdxNode* n35 = static_cast<HashIndex_NUMWAIT_mSUPPLIER1_E3_1_map_0::IdxNode*>(i35->slice(se62, h34));
                ...
                if (n35 && (e35 = n35->obj)) {
                  do {                
                    ...
                    n35 = n35->nxt;
                  } while (n35 && (e35 = n35->obj) && h34 == n35->hash &&  NUMWAIT_mSUPPLIER1_E3_1_mapkey0_idxfn::equals(se62, *e35)); 
                }
              }(/*if */(l10 == agg23) ? agg22 += (v33 * (agg24 != 0 ? 1L : 0L)) : 0L);
              n33 = n33->nxt;
            } while (n33 && (e33 = n33->obj) && h35 == n33->hash &&  NUMWAIT_mSUPPLIER1_mapkey1_idxfn::equals(se63, *e33)); 
          }
        }NUMWAIT.addOrDelOnZero(se59.modify(supplier_name),(NUMWAIT_mSUPPLIER2.getValueOrDefault(se60.modify(supplier_nationkey)) * (agg22 * -1L)));
        ...
        { //slice 
          ...
          if (n36 && (e36 = n36->obj)) {
            do {                
              ...
              long v36 = e36->__av;
              NUMWAIT_mLINEITEM7.addOrDelOnZero(se66.modify(numwait_mlineitemlineitem_orderkey,supplier_suppkey,supplier_name),(NUMWAIT_mSUPPLIER2.getValueOrDefault(se67.modify(supplier_nationkey)) * (v36 * -1L)));
              n36 = n36->nxt;
  ...
  private:
    ...
    NUMWAIT_mLINEITEM3_entry se46;
    NUMWAIT_mSUPPLIER1_entry se47;
    NUMWAIT_mSUPPLIER1_L2_1_entry se48;
    NUMWAIT_entry se49;
    NUMWAIT_mSUPPLIER2_entry se50;
    NUMWAIT_mSUPPLIER1_L2_1_entry se51;
    NUMWAIT_mSUPPLIER1_E3_1_entry se52;
    NUMWAIT_mSUPPLIER1_entry se53;
    ...
    NUMWAIT_entry se59;
    NUMWAIT_mSUPPLIER2_entry se60;
    NUMWAIT_mSUPPLIER1_L2_1_entry se61;
    NUMWAIT_mSUPPLIER1_E3_1_entry se62;
    NUMWAIT_mSUPPLIER1_entry se63;
    ...
    NUMWAIT_mLINEITEM3_map NUMWAIT_mLINEITEM3;
