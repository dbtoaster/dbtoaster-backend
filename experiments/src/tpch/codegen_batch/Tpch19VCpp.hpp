...
namespace dbtoaster {
  ...
  struct REVENUEPART1_DELTA_entry {
    ...
    explicit REVENUEPART1_DELTA_entry() { /*P_PARTKEY = 0L; P_BRAND = ""; P_SIZE = 0L; P_CONTAINER = ""; __av = 0L; */ }
    explicit REVENUEPART1_DELTA_entry(const long c0, const STRING_TYPE& c1, const long c2, const STRING_TYPE& c3, const long c4) { P_PARTKEY = c0; P_BRAND = c1; P_SIZE = c2; P_CONTAINER = c3; __av = c4; }
    REVENUEPART1_DELTA_entry(const REVENUEPART1_DELTA_entry& other) : P_PARTKEY( other.P_PARTKEY ), P_BRAND( other.P_BRAND ), P_SIZE( other.P_SIZE ), P_CONTAINER( other.P_CONTAINER ), __av( other.__av ) {}
    FORCE_INLINE REVENUEPART1_DELTA_entry& modify(const long c0, const STRING_TYPE& c1, const long c2, const STRING_TYPE& c3) { P_PARTKEY = c0; P_BRAND = c1; P_SIZE = c2; P_CONTAINER = c3;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct REVENUEPART1_entry {
    ...
    explicit REVENUEPART1_entry() { /*L_PARTKEY = 0L; L_QUANTITY = 0.0; L_SHIPINSTRUCT = ""; L_SHIPMODE = ""; __av = 0.0; */ }
    explicit REVENUEPART1_entry(const long c0, const DOUBLE_TYPE c1, const STRING_TYPE& c2, const STRING_TYPE& c3, const DOUBLE_TYPE c4) { L_PARTKEY = c0; L_QUANTITY = c1; L_SHIPINSTRUCT = c2; L_SHIPMODE = c3; __av = c4; }
    REVENUEPART1_entry(const REVENUEPART1_entry& other) : L_PARTKEY( other.L_PARTKEY ), L_QUANTITY( other.L_QUANTITY ), L_SHIPINSTRUCT( other.L_SHIPINSTRUCT ), L_SHIPMODE( other.L_SHIPMODE ), __av( other.__av ) {}
    FORCE_INLINE REVENUEPART1_entry& modify(const long c0, const DOUBLE_TYPE c1, const STRING_TYPE& c2, const STRING_TYPE& c3) { L_PARTKEY = c0; L_QUANTITY = c1; L_SHIPINSTRUCT = c2; L_SHIPMODE = c3;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct REVENUEPART1_mapkey0123_idxfn {
  ...
  typedef MultiHashMap<REVENUEPART1_entry,DOUBLE_TYPE,
    HashIndex<REVENUEPART1_entry,DOUBLE_TYPE,REVENUEPART1_mapkey0123_idxfn,true>
  > REVENUEPART1_map;
  typedef HashIndex<REVENUEPART1_entry,DOUBLE_TYPE,REVENUEPART1_mapkey0123_idxfn,true> HashIndex_REVENUEPART1_map_0123;
  
  struct REVENUELINEITEM1_DELTA_entry {
    long L_PARTKEY; DOUBLE_TYPE L_QUANTITY; STRING_TYPE L_SHIPINSTRUCT; STRING_TYPE L_SHIPMODE; DOUBLE_TYPE __av; 
    explicit REVENUELINEITEM1_DELTA_entry() { /*L_PARTKEY = 0L; L_QUANTITY = 0.0; L_SHIPINSTRUCT = ""; L_SHIPMODE = ""; __av = 0.0; */ }
    explicit REVENUELINEITEM1_DELTA_entry(const long c0, const DOUBLE_TYPE c1, const STRING_TYPE& c2, const STRING_TYPE& c3, const DOUBLE_TYPE c4) { L_PARTKEY = c0; L_QUANTITY = c1; L_SHIPINSTRUCT = c2; L_SHIPMODE = c3; __av = c4; }
    REVENUELINEITEM1_DELTA_entry(const REVENUELINEITEM1_DELTA_entry& other) : L_PARTKEY( other.L_PARTKEY ), L_QUANTITY( other.L_QUANTITY ), L_SHIPINSTRUCT( other.L_SHIPINSTRUCT ), L_SHIPMODE( other.L_SHIPMODE ), __av( other.__av ) {}
    FORCE_INLINE REVENUELINEITEM1_DELTA_entry& modify(const long c0, const DOUBLE_TYPE c1, const STRING_TYPE& c2, const STRING_TYPE& c3) { L_PARTKEY = c0; L_QUANTITY = c1; L_SHIPINSTRUCT = c2; L_SHIPMODE = c3;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct REVENUELINEITEM1_DELTA_mapkey0123_idxfn {
  ...
  typedef MultiHashMap<REVENUELINEITEM1_DELTA_entry,DOUBLE_TYPE,
    HashIndex<REVENUELINEITEM1_DELTA_entry,DOUBLE_TYPE,REVENUELINEITEM1_DELTA_mapkey0123_idxfn,true>
  > REVENUELINEITEM1_DELTA_map;
  typedef HashIndex<REVENUELINEITEM1_DELTA_entry,DOUBLE_TYPE,REVENUELINEITEM1_DELTA_mapkey0123_idxfn,true> HashIndex_REVENUELINEITEM1_DELTA_map_0123;
  
  struct REVENUELINEITEM1_entry {
    long P_PARTKEY; STRING_TYPE P_BRAND; long P_SIZE; STRING_TYPE P_CONTAINER; long __av; 
    explicit REVENUELINEITEM1_entry() { /*P_PARTKEY = 0L; P_BRAND = ""; P_SIZE = 0L; P_CONTAINER = ""; __av = 0L; */ }
    explicit REVENUELINEITEM1_entry(const long c0, const STRING_TYPE& c1, const long c2, const STRING_TYPE& c3, const long c4) { P_PARTKEY = c0; P_BRAND = c1; P_SIZE = c2; P_CONTAINER = c3; __av = c4; }
    REVENUELINEITEM1_entry(const REVENUELINEITEM1_entry& other) : P_PARTKEY( other.P_PARTKEY ), P_BRAND( other.P_BRAND ), P_SIZE( other.P_SIZE ), P_CONTAINER( other.P_CONTAINER ), __av( other.__av ) {}
    FORCE_INLINE REVENUELINEITEM1_entry& modify(const long c0, const STRING_TYPE& c1, const long c2, const STRING_TYPE& c3) { P_PARTKEY = c0; P_BRAND = c1; P_SIZE = c2; P_CONTAINER = c3;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct data_t : tlq_t{
    ...
    void on_batch_update_LINEITEM(TPCHLineitemBatch& DELTA_LINEITEM) {
      {  
        ...
        {  // foreach
          const HashIndex_REVENUELINEITEM1_DELTA_map_0123* i2 = static_cast<HashIndex_REVENUELINEITEM1_DELTA_map_0123*>(REVENUELINEITEM1_DELTA.index[0]);
          HashIndex_REVENUELINEITEM1_DELTA_map_0123::IdxNode* n2; 
          ...
          for (size_t i = 0; i < i2->size_; i++)
          {
            ...
            while (n2 && (e2 = n2->obj))
            {
                ...
                STRING_TYPE l_shipinstruct = e2->L_SHIPINSTRUCT;
                STRING_TYPE l_shipmode = e2->L_SHIPMODE;
                DOUBLE_TYPE v2 = e2->__av;
                {  // foreach
                  const HashIndex_REVENUELINEITEM1_map_0123* i3 = static_cast<HashIndex_REVENUELINEITEM1_map_0123*>(REVENUELINEITEM1.index[0]);
                  HashIndex_REVENUELINEITEM1_map_0123::IdxNode* n3; 
        ...
        {  // foreach
          const HashIndex_REVENUELINEITEM1_DELTA_map_0123* i4 = static_cast<HashIndex_REVENUELINEITEM1_DELTA_map_0123*>(REVENUELINEITEM1_DELTA.index[0]);
          HashIndex_REVENUELINEITEM1_DELTA_map_0123::IdxNode* n4; 
          ...
          for (size_t i = 0; i < i4->size_; i++)
          {
            ...
            while (n4 && (e4 = n4->obj))
            {
                ...
                REVENUEPART1.addOrDelOnZero(se3.modify(l_partkey,l_quantity,l_shipinstruct,l_shipmode),v4);
              n4 = n4->nxt;
            }
          }
        }
        ...
        {  // foreach
          ...
          for (size_t i = 0; i < i6->size_; i++)
          {
            ...
            while (n6 && (e6 = n6->obj))
            {
                ...
                long v6 = e6->__av;
                {  // foreach
                  const HashIndex_REVENUEPART1_map_0123* i7 = static_cast<HashIndex_REVENUEPART1_map_0123*>(REVENUEPART1.index[0]);
                  HashIndex_REVENUEPART1_map_0123::IdxNode* n7; 
                  ...
                  for (size_t i = 0; i < i7->size_; i++)
                  {
                    ...
                    while (n7 && (e7 = n7->obj))
                    {
                        ...
                        STRING_TYPE l_shipinstruct = e7->L_SHIPINSTRUCT;
        ...
        {  // foreach
          ...
          for (size_t i = 0; i < i8->size_; i++)
          {
            ...
            while (n8 && (e8 = n8->obj))
            {
                ...
                long v8 = e8->__av;
                REVENUELINEITEM1.addOrDelOnZero(se6.modify(p_partkey,p_brand,p_size,p_container),v8);
              n8 = n8->nxt;
            }
          }
        }
  ...
  private:
    ...
    REVENUEPART1_entry se3;
    REVENUEPART1_DELTA_entry se4;
    REVENUELINEITEM1_entry se6;
