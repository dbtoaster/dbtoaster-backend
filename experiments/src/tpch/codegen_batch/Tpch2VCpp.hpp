...
namespace dbtoaster {
  ...
  struct COUNTSUPPLIER1SUPPLIER1_P_1_entry {
    long P_PARTKEY; STRING_TYPE P_MFGR; long S_SUPPKEY; DOUBLE_TYPE PS_SUPPLYCOST; long __av; 
    explicit COUNTSUPPLIER1SUPPLIER1_P_1_entry() { /*P_PARTKEY = 0L; P_MFGR = ""; S_SUPPKEY = 0L; PS_SUPPLYCOST = 0.0; __av = 0L; */ }
    explicit COUNTSUPPLIER1SUPPLIER1_P_1_entry(const long c0, const STRING_TYPE& c1, const long c2, const DOUBLE_TYPE c3, const long c4) { P_PARTKEY = c0; P_MFGR = c1; S_SUPPKEY = c2; PS_SUPPLYCOST = c3; __av = c4; }
    COUNTSUPPLIER1SUPPLIER1_P_1_entry(const COUNTSUPPLIER1SUPPLIER1_P_1_entry& other) : P_PARTKEY( other.P_PARTKEY ), P_MFGR( other.P_MFGR ), S_SUPPKEY( other.S_SUPPKEY ), PS_SUPPLYCOST( other.PS_SUPPLYCOST ), __av( other.__av ) {}
    FORCE_INLINE COUNTSUPPLIER1SUPPLIER1_P_1_entry& modify(const long c0, const STRING_TYPE& c1, const long c2, const DOUBLE_TYPE c3) { P_PARTKEY = c0; P_MFGR = c1; S_SUPPKEY = c2; PS_SUPPLYCOST = c3;  return *this; }
    FORCE_INLINE COUNTSUPPLIER1SUPPLIER1_P_1_entry& modify2(const long c2) { S_SUPPKEY = c2;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct COUNTSUPPLIER1SUPPLIER1_P_1_mapkey0123_idxfn {
    ...
    FORCE_INLINE static bool equals(const COUNTSUPPLIER1SUPPLIER1_P_1_entry& x, const COUNTSUPPLIER1SUPPLIER1_P_1_entry& y) {
      return x.P_PARTKEY == y.P_PARTKEY && x.P_MFGR == y.P_MFGR && x.S_SUPPKEY == y.S_SUPPKEY && x.PS_SUPPLYCOST == y.PS_SUPPLYCOST;
    }
  };
  
  struct COUNTSUPPLIER1SUPPLIER1_P_1_mapkey2_idxfn {
    FORCE_INLINE static size_t hash(const COUNTSUPPLIER1SUPPLIER1_P_1_entry& e) {
      size_t h = 0;
      hash_combine(h, e.S_SUPPKEY);
      return h;
  ...
  typedef MultiHashMap<COUNTSUPPLIER1SUPPLIER1_P_1_entry,long,
    ...
    HashIndex<COUNTSUPPLIER1SUPPLIER1_P_1_entry,long,COUNTSUPPLIER1SUPPLIER1_P_1_mapkey2_idxfn,false>
  ...
  typedef HashIndex<COUNTSUPPLIER1SUPPLIER1_P_1_entry,long,COUNTSUPPLIER1SUPPLIER1_P_1_mapkey2_idxfn,false> HashIndex_COUNTSUPPLIER1SUPPLIER1_P_1_map_2;
  ...
  struct tuple8_SSSSDSS_L {
    STRING_TYPE _1; STRING_TYPE _2; STRING_TYPE _3; STRING_TYPE _4; DOUBLE_TYPE _5; STRING_TYPE _6; STRING_TYPE _7; long __av;
    explicit tuple8_SSSSDSS_L() { }
    explicit tuple8_SSSSDSS_L(const STRING_TYPE& c1, const STRING_TYPE& c2, const STRING_TYPE& c3, const STRING_TYPE& c4, const DOUBLE_TYPE c5, const STRING_TYPE& c6, const STRING_TYPE& c7, long c__av=0L) { _1 = c1; _2 = c2; _3 = c3; _4 = c4; _5 = c5; _6 = c6; _7 = c7; __av = c__av;}
    int operator==(const tuple8_SSSSDSS_L &rhs) const { return ((this->_1==rhs._1) && (this->_2==rhs._2) && (this->_3==rhs._3) && (this->_4==rhs._4) && (this->_5==rhs._5) && (this->_6==rhs._6) && (this->_7==rhs._7)); }
    FORCE_INLINE tuple8_SSSSDSS_L& modify(const STRING_TYPE& c0, const STRING_TYPE& c1, const STRING_TYPE& c2, const STRING_TYPE& c3, const DOUBLE_TYPE c4, const STRING_TYPE& c5, const STRING_TYPE& c6, long c__av) { _1 = c0; _2 = c1; _3 = c2; _4 = c3; _5 = c4; _6 = c5; _7 = c6; __av = c__av; return *this; }
    static bool equals(const tuple8_SSSSDSS_L &x, const tuple8_SSSSDSS_L &y) { return ((x._1==y._1) && (x._2==y._2) && (x._3==y._3) && (x._4==y._4) && (x._5==y._5) && (x._6==y._6) && (x._7==y._7)); }
    static long hash(const tuple8_SSSSDSS_L &e) {
      size_t h = 0;
      hash_combine(h, e._1);
      hash_combine(h, e._2);
      hash_combine(h, e._3);
  ...
  struct data_t : tlq_t{
    data_t(): tlq_t(), _c1(16U), _c2(16U), agg1(16U) {
                ...
                { //slice 
                  ...
                  if (n10 && (e10 = n10->obj)) {
                    do {                
                      ...
                      long v10 = e10->__av;
                      COUNTSUPPLIER1SUPPLIER1_P_1.addOrDelOnZero(se8.modify(p_partkey,p_mfgr,s_suppkey,ps_supplycost),(v9 * v10));
                      n10 = n10->nxt;
      ...
      {  
        ...
        {  
          for (size_t i = 0; i < DELTA_SUPPLIER.size; i++) 
          {
                ...
                long v12 = 1L;
                COUNTPARTSUPP4_P_2SUPPLIER1_DELTA.addOrDelOnZero(se11.modify(s_suppkey,s_name,s_address,s_nationkey,s_phone,s_acctbal,s_comment),v12);                
          }
        }
        {  // foreach
          ...
          for (size_t i = 0; i < i16->size_; i++)
          {
            ...
            while (n16 && (e16 = n16->obj))
            {
                ...
                long v16 = e16->__av;
                { //slice 
                  const HashIndex_COUNTSUPPLIER1SUPPLIER1_P_1_map_2* i17 = static_cast<HashIndex_COUNTSUPPLIER1SUPPLIER1_P_1_map_2*>(COUNTSUPPLIER1SUPPLIER1_P_1.index[1]);
                  const HASH_RES_t h7 = COUNTSUPPLIER1SUPPLIER1_P_1_mapkey2_idxfn::hash(se18.modify2(s_suppkey));
                  HashIndex_COUNTSUPPLIER1SUPPLIER1_P_1_map_2::IdxNode* n17 = static_cast<HashIndex_COUNTSUPPLIER1SUPPLIER1_P_1_map_2::IdxNode*>(i17->slice(se18, h7));
                  ...
                  if (n17 && (e17 = n17->obj)) {
                    do {                
                      ...
                      n17 = n17->nxt;
                    } while (n17 && (e17 = n17->obj) && h7 == n17->hash &&  COUNTSUPPLIER1SUPPLIER1_P_1_mapkey2_idxfn::equals(se18, *e17)); 
                  }
                }
              n16 = n16->nxt;
            }
        ...
        {  // foreach
          ...
          for (size_t i = 0; i < i28->size_; i++)
          {
            ...
            while (n28 && (e28 = n28->obj))
            {
                            ...
                            { //slice 
                              ...
                              if (n31 && (e31 = n31->obj)) {
                                do {                
                                  ...
                                  long v33 = e31->__av;
                                  (/*if */(ps_supplycost > ps2_supplycost) ? agg4 += v33 : 0L);
                                  n31 = n31->nxt;
                            ...
                            { //slice 
                              ...
                              if (n32 && (e32 = n32->obj)) {
                                do {                
                                  ...
                                  long v34 = e32->__av;
                                  (/*if */(ps_supplycost > ps2_supplycost) ? agg5 += (v34 * COUNTPARTSUPP1_L2_2.getValueOrDefault(se31.modify(ps2_suppkey))) : 0L);
                                  n32 = n32->nxt;
                                } while (n32 && (e32 = n32->obj) && h13 == n32->hash &&  COUNTPARTSUPP1_L2_2_DELTA_mapkey0_idxfn::equals(se32, *e32)); 
                              }
                            }(/*if */(l3 == (agg4 + agg5)) ? _c2.addOrDelOnZero(st2.modify(s_name,s_address,s_phone,s_acctbal,s_comment,n_name,v32), v32) : (void)0);
                            n30 = n30->nxt;
                      ...
                      { //slice 
                            ...
                            { //slice 
                              ...
                              if (n34 && (e34 = n34->obj)) {
                                do {                
                                  ...
                                  long v36 = e34->__av;
                                  (/*if */(ps_supplycost > ps2_supplycost) ? agg6 += v36 : 0L);
                                  n34 = n34->nxt;
                                } while (n34 && (e34 = n34->obj) && h15 == n34->hash &&  COUNTPART1_L2_1_mapkey0_idxfn::equals(se34, *e34)); 
                              }
                            }(/*if */(l4 == agg6) ? _c2.addOrDelOnZero(st3.modify(s_name,s_address,s_phone,s_acctbal,s_comment,n_name,(v35 * -1L)), (v35 * -1L)) : (void)0);
                            n33 = n33->nxt;
                          } while (n33 && (e33 = n33->obj) && h16 == n33->hash &&  COUNTPART1_mapkey5_idxfn::equals(se35, *e33)); 
                        }
                      }{  // temp foreach
                        const HashIndex<tuple7_SSSDSS_L, long>* i35 = static_cast<HashIndex<tuple7_SSSDSS_L, long>*>(_c2.index[0]);
                        ...
                        for (size_t i = 0; i < i35->size_; i++)
                        {
                          ...
                          while (n35 && (e35 = n35->obj))
                          {
                            ...
                            long v37 = e35->__av; 
                          _c1.addOrDelOnZero(st4.modify(p_mfgr,s_name,s_address,s_phone,s_acctbal,s_comment,n_name,(v30 * v37)), (v30 * v37));      
                            n35 = n35->nxt;
                          }
                        }
                      }
                ...
                { //slice 
                  const HashIndex_COUNTPARTSUPP1_L2_2_DELTA_map_0* i36 = static_cast<HashIndex_COUNTPARTSUPP1_L2_2_DELTA_map_0*>(COUNTPARTSUPP1_L2_2_DELTA.index[1]);
                  const HASH_RES_t h22 = COUNTPARTSUPP1_L2_2_DELTA_mapkey0_idxfn::hash(se42.modify0(p_partkey));
                  HashIndex_COUNTPARTSUPP1_L2_2_DELTA_map_0::IdxNode* n36 = static_cast<HashIndex_COUNTPARTSUPP1_L2_2_DELTA_map_0::IdxNode*>(i36->slice(se42, h22));
                  ...
                  if (n36 && (e36 = n36->obj)) {
                    do {                
                      ...
                      { //slice 
                        ...
                        if (n37 && (e37 = n37->obj)) {
                          do {                
                            ...
                            long v39 = e37->__av;
                            (/*if */(ps_supplycost > ps2_supplycost) ? agg7 += v39 : 0L);
                            n37 = n37->nxt;
                      ...
                      { //slice 
                        ...
                        if (n38 && (e38 = n38->obj)) {
                          do {                
                            ...
                            long v40 = e38->__av;
                            (/*if */(ps_supplycost > ps2_supplycost) ? agg8 += (v40 * COUNTPARTSUPP1_L2_2.getValueOrDefault(se38.modify(ps2_suppkey))) : 0L);
                            n38 = n38->nxt;
                            ...
                            { //slice 
                              ...
                              if (n40 && (e40 = n40->obj)) {
                                do {                
                                  ...
                                  long v42 = e40->__av;
                                  (/*if */(l5 == (agg7 + agg8)) ? _c1.addOrDelOnZero(st5.modify(p_mfgr,s_name,s_address,s_phone,s_acctbal,s_comment,n_name,(v38 * (v41 * v42))), (v38 * (v41 * v42))) : (void)0);
                                  n40 = n40->nxt;
                      ...
                      n36 = n36->nxt;
                    } while (n36 && (e36 = n36->obj) && h22 == n36->hash &&  COUNTPARTSUPP1_L2_2_DELTA_mapkey0_idxfn::equals(se42, *e36)); 
                  }
                }{  // temp foreach
                  const HashIndex<tuple8_SSSSDSS_L, long>* i41 = static_cast<HashIndex<tuple8_SSSSDSS_L, long>*>(_c1.index[0]);
                  HashIndex<tuple8_SSSSDSS_L, long>::IdxNode* n41; 
                  tuple8_SSSSDSS_L* e41;
                  ...
                  for (size_t i = 0; i < i41->size_; i++)
                  {
                    ...
                    {
                      STRING_TYPE p_mfgr = e41->_1;
                      STRING_TYPE s_name = e41->_2;
                      STRING_TYPE s_address = e41->_3;
                      STRING_TYPE s_phone = e41->_4;
                      DOUBLE_TYPE s_acctbal = e41->_5;
                      STRING_TYPE s_comment = e41->_6;
                      STRING_TYPE n_name = e41->_7;  
                      long v43 = e41->__av; 
                    COUNT.addOrDelOnZero(se29.modify(s_acctbal,s_name,n_name,p_partkey,p_mfgr,s_address,s_phone,s_comment),((v28 != 0 ? 1L : 0L) * v43));      
                      n41 = n41->nxt;
                    }
                  }
                }
          ...
          const HashIndex_COUNTPARTSUPP1_L2_2_DELTA_map_012* i42 = static_cast<HashIndex_COUNTPARTSUPP1_L2_2_DELTA_map_012*>(COUNTPARTSUPP1_L2_2_DELTA.index[0]);
          HashIndex_COUNTPARTSUPP1_L2_2_DELTA_map_012::IdxNode* n42; 
          COUNTPARTSUPP1_L2_2_DELTA_entry* e42;
          ...
          for (size_t i = 0; i < i42->size_; i++)
          {
            ...
            while (n42 && (e42 = n42->obj))
            {
                ...
                long s_suppkey = e42->PS2_SUPPKEY;
                DOUBLE_TYPE ps_supplycost = e42->PS2_SUPPLYCOST;
                long v44 = e42->__av;
                { //slice 
                  const HashIndex_COUNTPARTSUPP1_P_1_map_0* i43 = static_cast<HashIndex_COUNTPARTSUPP1_P_1_map_0*>(COUNTPARTSUPP1_P_1.index[1]);
                  const HASH_RES_t h24 = COUNTPARTSUPP1_P_1_mapkey0_idxfn::hash(se45.modify0(p_partkey));
                  HashIndex_COUNTPARTSUPP1_P_1_map_0::IdxNode* n43 = static_cast<HashIndex_COUNTPARTSUPP1_P_1_map_0::IdxNode*>(i43->slice(se45, h24));
                  COUNTPARTSUPP1_P_1_entry* e43;
                 
                  if (n43 && (e43 = n43->obj)) {
                    do {                
                      STRING_TYPE p_mfgr = e43->P_MFGR;
                      long v45 = e43->__av;
                      { //slice 
                        const HashIndex_COUNTPARTSUPP4_P_2_map_0* i44 = static_cast<HashIndex_COUNTPARTSUPP4_P_2_map_0*>(COUNTPARTSUPP4_P_2.index[1]);
                        const HASH_RES_t h23 = COUNTPARTSUPP4_P_2_mapkey0_idxfn::hash(se44.modify0(s_suppkey));
                        HashIndex_COUNTPARTSUPP4_P_2_map_0::IdxNode* n44 = static_cast<HashIndex_COUNTPARTSUPP4_P_2_map_0::IdxNode*>(i44->slice(se44, h23));
                        COUNTPARTSUPP4_P_2_entry* e44;
                        ...
                        if (n44 && (e44 = n44->obj)) {
                          do {                
                            ...
                            long v46 = e44->__av;
                            COUNTSUPPLIER1.addOrDelOnZero(se43.modify(p_partkey,p_mfgr,s_name,s_address,s_phone,s_acctbal,s_comment,ps_supplycost,n_name),(v44 * (v45 * v46)));
                            n44 = n44->nxt;
                          } while (n44 && (e44 = n44->obj) && h23 == n44->hash &&  COUNTPARTSUPP4_P_2_mapkey0_idxfn::equals(se44, *e44)); 
                        }
                      }
                      n43 = n43->nxt;
                    } while (n43 && (e43 = n43->obj) && h24 == n43->hash &&  COUNTPARTSUPP1_P_1_mapkey0_idxfn::equals(se45, *e43)); 
                  }
                }
              n42 = n42->nxt;
            }
          ...
          const HashIndex_COUNTPARTSUPP1_L2_2_DELTA_map_012* i45 = static_cast<HashIndex_COUNTPARTSUPP1_L2_2_DELTA_map_012*>(COUNTPARTSUPP1_L2_2_DELTA.index[0]);
          HashIndex_COUNTPARTSUPP1_L2_2_DELTA_map_012::IdxNode* n45; 
          COUNTPARTSUPP1_L2_2_DELTA_entry* e45;
          ...
          for (size_t i = 0; i < i45->size_; i++)
          {
            ...
            {
                long p_partkey = e45->P_PARTKEY;
                long s_suppkey = e45->PS2_SUPPKEY;
                DOUBLE_TYPE ps_supplycost = e45->PS2_SUPPLYCOST;
                long v47 = e45->__av;
                { //slice 
                  const HashIndex_COUNTPARTSUPP1_P_1_map_0* i46 = static_cast<HashIndex_COUNTPARTSUPP1_P_1_map_0*>(COUNTPARTSUPP1_P_1.index[1]);
                  const HASH_RES_t h25 = COUNTPARTSUPP1_P_1_mapkey0_idxfn::hash(se47.modify0(p_partkey));
                  HashIndex_COUNTPARTSUPP1_P_1_map_0::IdxNode* n46 = static_cast<HashIndex_COUNTPARTSUPP1_P_1_map_0::IdxNode*>(i46->slice(se47, h25));
                  COUNTPARTSUPP1_P_1_entry* e46;
                 
                  if (n46 && (e46 = n46->obj)) {
                    do {                
                      STRING_TYPE p_mfgr = e46->P_MFGR;
                      long v48 = e46->__av;
                      COUNTSUPPLIER1SUPPLIER1_P_1.addOrDelOnZero(se46.modify(p_partkey,p_mfgr,s_suppkey,ps_supplycost),(v47 * v48));
                      n46 = n46->nxt;
                    } while (n46 && (e46 = n46->obj) && h25 == n46->hash &&  COUNTPARTSUPP1_P_1_mapkey0_idxfn::equals(se47, *e46)); 
                  }
                }
              n45 = n45->nxt;
            }
          ...
          for (size_t i = 0; i < i47->size_; i++)
          {
            ...
            while (n47 && (e47 = n47->obj))
            {
                ...
                long v49 = e47->__av;
                COUNTSUPPLIER1SUPPLIER1_P_1PART1.addOrDelOnZero(se48.modify(p_partkey,s_suppkey,ps_supplycost),v49);
              n47 = n47->nxt;
            }
          }
        }{  // foreach
          const HashIndex_COUNTPARTSUPP1_L2_2_DELTA_map_012* i48 = static_cast<HashIndex_COUNTPARTSUPP1_L2_2_DELTA_map_012*>(COUNTPARTSUPP1_L2_2_DELTA.index[0]);
          HashIndex_COUNTPARTSUPP1_L2_2_DELTA_map_012::IdxNode* n48; 
          COUNTPARTSUPP1_L2_2_DELTA_entry* e48;
          ...
          for (size_t i = 0; i < i48->size_; i++)
          {
            ...
            {
                long p_partkey = e48->P_PARTKEY;
                long s_suppkey = e48->PS2_SUPPKEY;
                DOUBLE_TYPE ps_supplycost = e48->PS2_SUPPLYCOST;
                long v50 = e48->__av;
                { //slice 
                  const HashIndex_COUNTPARTSUPP4_P_2_map_0* i49 = static_cast<HashIndex_COUNTPARTSUPP4_P_2_map_0*>(COUNTPARTSUPP4_P_2.index[1]);
                  const HASH_RES_t h26 = COUNTPARTSUPP4_P_2_mapkey0_idxfn::hash(se50.modify0(s_suppkey));
                  HashIndex_COUNTPARTSUPP4_P_2_map_0::IdxNode* n49 = static_cast<HashIndex_COUNTPARTSUPP4_P_2_map_0::IdxNode*>(i49->slice(se50, h26));
                  COUNTPARTSUPP4_P_2_entry* e49;
                 
                  if (n49 && (e49 = n49->obj)) {
                    do {                
                      STRING_TYPE s_name = e49->S_NAME;
                      STRING_TYPE s_address = e49->S_ADDRESS;
                      STRING_TYPE s_phone = e49->S_PHONE;
                      DOUBLE_TYPE s_acctbal = e49->S_ACCTBAL;
                      STRING_TYPE s_comment = e49->S_COMMENT;
                      STRING_TYPE n_name = e49->N_NAME;
                      long v51 = e49->__av;
                      COUNTPART1.addOrDelOnZero(se49.modify(s_name,s_address,s_phone,s_acctbal,s_comment,p_partkey,ps_supplycost,n_name),(v50 * v51));
                      n49 = n49->nxt;
                    } while (n49 && (e49 = n49->obj) && h26 == n49->hash &&  COUNTPARTSUPP4_P_2_mapkey0_idxfn::equals(se50, *e49)); 
                  }
                }
              n48 = n48->nxt;
            }
          ...
          const HashIndex_COUNTPARTSUPP1_L2_2_DELTA_map_012* i50 = static_cast<HashIndex_COUNTPARTSUPP1_L2_2_DELTA_map_012*>(COUNTPARTSUPP1_L2_2_DELTA.index[0]);
          HashIndex_COUNTPARTSUPP1_L2_2_DELTA_map_012::IdxNode* n50; 
          COUNTPARTSUPP1_L2_2_DELTA_entry* e50;
          ...
          for (size_t i = 0; i < i50->size_; i++)
          {
            ...
            while (n50 && (e50 = n50->obj))
            {
                ...
                long ps2_suppkey = e50->PS2_SUPPKEY;
                DOUBLE_TYPE ps2_supplycost = e50->PS2_SUPPLYCOST;
                long v52 = e50->__av;
                COUNTPART1_L2_1.addOrDelOnZero(se51.modify(p_partkey,ps2_supplycost),(v52 * COUNTPARTSUPP1_L2_2.getValueOrDefault(se52.modify(ps2_suppkey))));
              n50 = n50->nxt;
            }
          }
        }
      ...
      {  
        ...
        {  // foreach
          ...
          for (size_t i = 0; i < i51->size_; i++)
          {
            ...
            {
                long s2_nationkey = e51->NATION_NATIONKEY;
                ...
                { //slice 
                  ...
                  const HASH_RES_t h27 = REGION_mapkey01_idxfn::hash(se54.modify01(n2_regionkey, l6));
                  HashIndex_REGION_map_01::IdxNode* n52 = static_cast<HashIndex_REGION_map_01::IdxNode*>(i52->slice(se54, h27));
                  REGION_entry* e52;
                  ...
                  if (n52 && (e52 = n52->obj)) {
                    do {                
                      ...
                      long v54 = e52->__av;
                      COUNTPARTSUPP1_L2_2SUPPLIER1.addOrDelOnZero(se53.modify(s2_nationkey),(v53 * v54));
                      n52 = n52->nxt;
                    } while (n52 && (e52 = n52->obj) && h27 == n52->hash &&  REGION_mapkey01_idxfn::equals(se54, *e52)); 
                  }
                }
              n51 = n51->nxt;
            }
          ...
          for (size_t i = 0; i < i53->size_; i++)
          {
            ...
            while (n53 && (e53 = n53->obj))
            {
                ...
                { //slice 
                  ...
                  const HASH_RES_t h28 = REGION_mapkey01_idxfn::hash(se56.modify01(n_regionkey, l7));
                  HashIndex_REGION_map_01::IdxNode* n54 = static_cast<HashIndex_REGION_map_01::IdxNode*>(i54->slice(se56, h28));
                  REGION_entry* e54;
                  ...
                  if (n54 && (e54 = n54->obj)) {
                    do {                
                      ...
                      long v56 = e54->__av;
                      COUNTPARTSUPP4_P_2SUPPLIER1.addOrDelOnZero(se55.modify(s_nationkey,n_name),(v55 * v56));
                      n54 = n54->nxt;
                    } while (n54 && (e54 = n54->obj) && h28 == n54->hash &&  REGION_mapkey01_idxfn::equals(se56, *e54)); 
                  }
                }
              n53 = n53->nxt;
            }
  ...
  private:
    ...
    tuple8_SSSSDSS_L st5;
    COUNTPARTSUPP4_P_2_entry se40;
    COUNTPARTSUPP1_P_1_entry se41;
    COUNTPARTSUPP1_L2_2_DELTA_entry se42;
    COUNTSUPPLIER1_entry se43;
    COUNTPARTSUPP4_P_2_entry se44;
    COUNTPARTSUPP1_P_1_entry se45;
    COUNTSUPPLIER1SUPPLIER1_P_1_entry se46;
    COUNTPARTSUPP1_P_1_entry se47;
    COUNTSUPPLIER1SUPPLIER1_P_1PART1_entry se48;
    COUNTPART1_entry se49;
    COUNTPARTSUPP4_P_2_entry se50;
    COUNTPART1_L2_1_entry se51;
    COUNTPARTSUPP1_L2_2_entry se52;
    COUNTPARTSUPP1_L2_2SUPPLIER1_entry se53;
    REGION_entry se54;
    COUNTPARTSUPP4_P_2SUPPLIER1_entry se55;
    REGION_entry se56;
    ...
    MultiHashMap<tuple8_SSSSDSS_L,long,HashIndex<tuple8_SSSSDSS_L,long> > _c1;
