...
namespace dbtoaster {
  ...
  struct REVENUE_mLINEITEM2_entry {
    long C_CUSTKEY; STRING_TYPE C_NAME; STRING_TYPE C_ADDRESS; STRING_TYPE C_PHONE; DOUBLE_TYPE C_ACCTBAL; STRING_TYPE C_COMMENT; long REVENUE_mLINEITEMLINEITEM_ORDERKEY; STRING_TYPE N_NAME; long __av; 
    explicit REVENUE_mLINEITEM2_entry() { /*C_CUSTKEY = 0L; C_NAME = ""; C_ADDRESS = ""; C_PHONE = ""; C_ACCTBAL = 0.0; C_COMMENT = ""; REVENUE_mLINEITEMLINEITEM_ORDERKEY = 0L; N_NAME = ""; __av = 0L; */ }
    explicit REVENUE_mLINEITEM2_entry(const long c0, const STRING_TYPE& c1, const STRING_TYPE& c2, const STRING_TYPE& c3, const DOUBLE_TYPE c4, const STRING_TYPE& c5, const long c6, const STRING_TYPE& c7, const long c8) { C_CUSTKEY = c0; C_NAME = c1; C_ADDRESS = c2; C_PHONE = c3; C_ACCTBAL = c4; C_COMMENT = c5; REVENUE_mLINEITEMLINEITEM_ORDERKEY = c6; N_NAME = c7; __av = c8; }
    REVENUE_mLINEITEM2_entry(const REVENUE_mLINEITEM2_entry& other) : C_CUSTKEY( other.C_CUSTKEY ), C_NAME( other.C_NAME ), C_ADDRESS( other.C_ADDRESS ), C_PHONE( other.C_PHONE ), C_ACCTBAL( other.C_ACCTBAL ), C_COMMENT( other.C_COMMENT ), REVENUE_mLINEITEMLINEITEM_ORDERKEY( other.REVENUE_mLINEITEMLINEITEM_ORDERKEY ), N_NAME( other.N_NAME ), __av( other.__av ) {}
    FORCE_INLINE REVENUE_mLINEITEM2_entry& modify(const long c0, const STRING_TYPE& c1, const STRING_TYPE& c2, const STRING_TYPE& c3, const DOUBLE_TYPE c4, const STRING_TYPE& c5, const long c6, const STRING_TYPE& c7) { C_CUSTKEY = c0; C_NAME = c1; C_ADDRESS = c2; C_PHONE = c3; C_ACCTBAL = c4; C_COMMENT = c5; REVENUE_mLINEITEMLINEITEM_ORDERKEY = c6; N_NAME = c7;  return *this; }
    FORCE_INLINE REVENUE_mLINEITEM2_entry& modify6(const long c6) { REVENUE_mLINEITEMLINEITEM_ORDERKEY = c6;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct REVENUE_mLINEITEM2_mapkey01234567_idxfn {
    ...
    FORCE_INLINE static bool equals(const REVENUE_mLINEITEM2_entry& x, const REVENUE_mLINEITEM2_entry& y) {
      return x.C_CUSTKEY == y.C_CUSTKEY && x.C_NAME == y.C_NAME && x.C_ADDRESS == y.C_ADDRESS && x.C_PHONE == y.C_PHONE && x.C_ACCTBAL == y.C_ACCTBAL && x.C_COMMENT == y.C_COMMENT && x.REVENUE_mLINEITEMLINEITEM_ORDERKEY == y.REVENUE_mLINEITEMLINEITEM_ORDERKEY && x.N_NAME == y.N_NAME;
    }
  };
  
  struct REVENUE_mLINEITEM2_mapkey6_idxfn {
    FORCE_INLINE static size_t hash(const REVENUE_mLINEITEM2_entry& e) {
      size_t h = 0;
      hash_combine(h, e.REVENUE_mLINEITEMLINEITEM_ORDERKEY);
      return h;
  ...
  typedef MultiHashMap<REVENUE_mLINEITEM2_entry,long,
    ...
    HashIndex<REVENUE_mLINEITEM2_entry,long,REVENUE_mLINEITEM2_mapkey6_idxfn,false>
  ...
  typedef HashIndex<REVENUE_mLINEITEM2_entry,long,REVENUE_mLINEITEM2_mapkey6_idxfn,false> HashIndex_REVENUE_mLINEITEM2_map_6;
  ...
  struct REVENUE_mORDERS1_entry {
    long REVENUE_mORDERSORDERS_ORDERKEY; DOUBLE_TYPE __av; 
    explicit REVENUE_mORDERS1_entry() { /*REVENUE_mORDERSORDERS_ORDERKEY = 0L; __av = 0.0; */ }
    explicit REVENUE_mORDERS1_entry(const long c0, const DOUBLE_TYPE c1) { REVENUE_mORDERSORDERS_ORDERKEY = c0; __av = c1; }
    REVENUE_mORDERS1_entry(const REVENUE_mORDERS1_entry& other) : REVENUE_mORDERSORDERS_ORDERKEY( other.REVENUE_mORDERSORDERS_ORDERKEY ), __av( other.__av ) {}
    FORCE_INLINE REVENUE_mORDERS1_entry& modify(const long c0) { REVENUE_mORDERSORDERS_ORDERKEY = c0;  return *this; }
    template<class Archive>
    void serialize(Archive& ar, const unsigned int version) const 
    {
      ar << ELEM_SEPARATOR;
  ...
  struct REVENUE_mORDERS1_mapkey0_idxfn {
    FORCE_INLINE static size_t hash(const REVENUE_mORDERS1_entry& e) {
      size_t h = 0;
      hash_combine(h, e.REVENUE_mORDERSORDERS_ORDERKEY);
      return h;
    }
    FORCE_INLINE static bool equals(const REVENUE_mORDERS1_entry& x, const REVENUE_mORDERS1_entry& y) {
      return x.REVENUE_mORDERSORDERS_ORDERKEY == y.REVENUE_mORDERSORDERS_ORDERKEY;
    }
  };
  
  typedef MultiHashMap<REVENUE_mORDERS1_entry,DOUBLE_TYPE,
    HashIndex<REVENUE_mORDERS1_entry,DOUBLE_TYPE,REVENUE_mORDERS1_mapkey0_idxfn,true>
  > REVENUE_mORDERS1_map;
  typedef HashIndex<REVENUE_mORDERS1_entry,DOUBLE_TYPE,REVENUE_mORDERS1_mapkey0_idxfn,true> HashIndex_REVENUE_mORDERS1_map_0;
  ...
  struct data_t : tlq_t{
    ...
    void on_insert_LINEITEM(const long lineitem_orderkey, const long lineitem_partkey, const long lineitem_suppkey, const long lineitem_linenumber, const DOUBLE_TYPE lineitem_quantity, const DOUBLE_TYPE lineitem_extendedprice, const DOUBLE_TYPE lineitem_discount, const DOUBLE_TYPE lineitem_tax, const STRING_TYPE& lineitem_returnflag, const STRING_TYPE& lineitem_linestatus, const date lineitem_shipdate, const date lineitem_commitdate, const date lineitem_receiptdate, const STRING_TYPE& lineitem_shipinstruct, const STRING_TYPE& lineitem_shipmode, const STRING_TYPE& lineitem_comment) {
      {  if (tS>0) { ++tS; return; } if ((tN&127)==0) { gettimeofday(&(t),NULL); tT=((t).tv_sec-(t0).tv_sec)*1000000L+((t).tv_usec-(t0).tv_usec); if (tT>3600000000L) { tS=1; return; } } ++tN;
        { //slice 
          const HashIndex_REVENUE_mLINEITEM2_map_6* i1 = static_cast<HashIndex_REVENUE_mLINEITEM2_map_6*>(REVENUE_mLINEITEM2.index[1]);
          const HASH_RES_t h1 = REVENUE_mLINEITEM2_mapkey6_idxfn::hash(se2.modify6(lineitem_orderkey));
          HashIndex_REVENUE_mLINEITEM2_map_6::IdxNode* n1 = static_cast<HashIndex_REVENUE_mLINEITEM2_map_6::IdxNode*>(i1->slice(se2, h1));
          ...
          if (n1 && (e1 = n1->obj)) {
            do {                
              ...
              n1 = n1->nxt;
            } while (n1 && (e1 = n1->obj) && h1 == n1->hash &&  REVENUE_mLINEITEM2_mapkey6_idxfn::equals(se2, *e1)); 
          }
        }(/*if */(lineitem_returnflag == c1) ? REVENUE_mORDERS1.addOrDelOnZero(se3.modify(lineitem_orderkey),(lineitem_extendedprice * (1L + (-1L * lineitem_discount)))) : (void)0);
        { //slice 
    ...
    void on_delete_LINEITEM(const long lineitem_orderkey, const long lineitem_partkey, const long lineitem_suppkey, const long lineitem_linenumber, const DOUBLE_TYPE lineitem_quantity, const DOUBLE_TYPE lineitem_extendedprice, const DOUBLE_TYPE lineitem_discount, const DOUBLE_TYPE lineitem_tax, const STRING_TYPE& lineitem_returnflag, const STRING_TYPE& lineitem_linestatus, const date lineitem_shipdate, const date lineitem_commitdate, const date lineitem_receiptdate, const STRING_TYPE& lineitem_shipinstruct, const STRING_TYPE& lineitem_shipmode, const STRING_TYPE& lineitem_comment) {
      {  if (tS>0) { ++tS; return; } if ((tN&127)==0) { gettimeofday(&(t),NULL); tT=((t).tv_sec-(t0).tv_sec)*1000000L+((t).tv_usec-(t0).tv_usec); if (tT>3600000000L) { tS=1; return; } } ++tN;
        { //slice 
          const HashIndex_REVENUE_mLINEITEM2_map_6* i3 = static_cast<HashIndex_REVENUE_mLINEITEM2_map_6*>(REVENUE_mLINEITEM2.index[1]);
          const HASH_RES_t h3 = REVENUE_mLINEITEM2_mapkey6_idxfn::hash(se7.modify6(lineitem_orderkey));
          HashIndex_REVENUE_mLINEITEM2_map_6::IdxNode* n3 = static_cast<HashIndex_REVENUE_mLINEITEM2_map_6::IdxNode*>(i3->slice(se7, h3));
          ...
          if (n3 && (e3 = n3->obj)) {
            do {                
              ...
              n3 = n3->nxt;
            } while (n3 && (e3 = n3->obj) && h3 == n3->hash &&  REVENUE_mLINEITEM2_mapkey6_idxfn::equals(se7, *e3)); 
          }
        }(/*if */(lineitem_returnflag == c1) ? REVENUE_mORDERS1.addOrDelOnZero(se8.modify(lineitem_orderkey),(-1L * (lineitem_extendedprice * (1L + (-1L * lineitem_discount))))) : (void)0);
        { //slice 
        ...
        { //slice 
          ...
          if (n5 && (e5 = n5->obj)) {
            do {                
              ...
              long v5 = e5->__av;
              (/*if */(orders_orderdate >= c2 && c3 > orders_orderdate) ? REVENUE.addOrDelOnZero(se11.modify(orders_custkey,c_name,c_acctbal,n_name,c_address,c_phone,c_comment),(REVENUE_mORDERS1.getValueOrDefault(se12.modify(orders_orderkey)) * v5)) : (void)0);
              n5 = n5->nxt;
          ...
          if (n6 && (e6 = n6->obj)) {
            do {                
              ...
              long v6 = e6->__av;
              (/*if */(orders_orderdate >= c2 && c3 > orders_orderdate) ? REVENUE_mLINEITEM2.addOrDelOnZero(se14.modify(orders_custkey,c_name,c_address,c_phone,c_acctbal,c_comment,orders_orderkey,n_name),v6) : (void)0);
              n6 = n6->nxt;
            } while (n6 && (e6 = n6->obj) && h6 == n6->hash &&  REVENUE_mORDERS4_mapkey0_idxfn::equals(se15, *e6)); 
          }
        }(/*if */(orders_orderdate >= c2 && c3 > orders_orderdate) ? REVENUE_mLINEITEM2_mCUSTOMER1.addOrDelOnZero(se16.modify(orders_orderkey,orders_custkey),1L) : (void)0);
        (/*if */(orders_orderdate >= c2 && c3 > orders_orderdate) ? REVENUE_mCUSTOMER1.addOrDelOnZero(se17.modify(orders_custkey),REVENUE_mORDERS1.getValueOrDefault(se18.modify(orders_orderkey))) : (void)0);
      }
    }
        ...
        { //slice 
          ...
          if (n7 && (e7 = n7->obj)) {
            do {                
              ...
              long v7 = e7->__av;
              (/*if */(orders_orderdate >= c2 && c3 > orders_orderdate) ? REVENUE.addOrDelOnZero(se19.modify(orders_custkey,c_name,c_acctbal,n_name,c_address,c_phone,c_comment),(REVENUE_mORDERS1.getValueOrDefault(se20.modify(orders_orderkey)) * (v7 * -1L))) : (void)0);
              n7 = n7->nxt;
          ...
          if (n8 && (e8 = n8->obj)) {
            do {                
              ...
              long v8 = e8->__av;
              (/*if */(orders_orderdate >= c2 && c3 > orders_orderdate) ? REVENUE_mLINEITEM2.addOrDelOnZero(se22.modify(orders_custkey,c_name,c_address,c_phone,c_acctbal,c_comment,orders_orderkey,n_name),(v8 * -1L)) : (void)0);
              n8 = n8->nxt;
            } while (n8 && (e8 = n8->obj) && h8 == n8->hash &&  REVENUE_mORDERS4_mapkey0_idxfn::equals(se23, *e8)); 
          }
        }(/*if */(orders_orderdate >= c2 && c3 > orders_orderdate) ? REVENUE_mLINEITEM2_mCUSTOMER1.addOrDelOnZero(se24.modify(orders_orderkey,orders_custkey),-1L) : (void)0);
        (/*if */(orders_orderdate >= c2 && c3 > orders_orderdate) ? REVENUE_mCUSTOMER1.addOrDelOnZero(se25.modify(orders_custkey),(REVENUE_mORDERS1.getValueOrDefault(se26.modify(orders_orderkey)) * -1L)) : (void)0);
      }
    }
              ...
              { //slice 
                ...
                if (n11 && (e11 = n11->obj)) {
                  do {                
                    ...
                    long v11 = e11->__av;
                    REVENUE_mLINEITEM2.addOrDelOnZero(se30.modify(customer_custkey,customer_name,customer_address,customer_phone,customer_acctbal,customer_comment,revenue_mlineitemlineitem_orderkey,n_name),(v10 * v11));
                    n11 = n11->nxt;
              ...
              { //slice 
                ...
                if (n15 && (e15 = n15->obj)) {
                  do {                
                    ...
                    long v15 = e15->__av;
                    REVENUE_mLINEITEM2.addOrDelOnZero(se38.modify(customer_custkey,customer_name,customer_address,customer_phone,customer_acctbal,customer_comment,revenue_mlineitemlineitem_orderkey,n_name),(v14 * (v15 * -1L)));
                    n15 = n15->nxt;
  ...
  private:
    ...
    REVENUE_mORDERS1_entry se18;
    REVENUE_entry se19;
    REVENUE_mORDERS1_entry se20;
    ...
    REVENUE_mORDERS1_map REVENUE_mORDERS1;
