...
//        System.err.println("Transaction "+count)
  ...
  private def doNeword(t_num: Int): Int = {
    ...
    var price = Array.ofDim[Double](MAX_NUM_ITEMS)
    var amt = Array.ofDim[Double](MAX_NUM_ITEMS)
    var iname = Array.ofDim[String](MAX_NUM_ITEMS)
    var bg = Array.ofDim[String](MAX_NUM_ITEMS)
