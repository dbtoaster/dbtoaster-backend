...
object SCDataLoader {
  def loadDataIntoMaps(exec: SCExecutor, driverClassName: String, jdbcUrl: String, db_user: String, db_password: String) = {
    ...
    try {
      ...
      while (rs.next()) {
        //TODO: SBJ: Check OK
        exec.x3.unsafeInsert(0, GenericEntry("SteNewSEntry",
          rs.getInt("w_id"),
          rs.getString("w_name"),
      ...
      while (rs.next()) {
        exec.x8.unsafeInsert(0,GenericEntry("SteNewSEntry",
          rs.getInt("c_id"),
          rs.getInt("c_d_id"),
          rs.getInt("c_w_id"),
      ...
      while (rs.next()) {
        exec.x6.unsafeInsert(0,GenericEntry("SteNewSEntry",
          rs.getInt("d_id"),
          rs.getInt("d_w_id"),
          rs.getString("d_name"),
      ...
      while (rs.next()) {
        exec.x2.unsafeInsert(0,GenericEntry("SteNewSEntry",
          rs.getInt("h_c_id"),
          rs.getInt("h_c_d_id"),
          rs.getInt("h_c_w_id"),
          rs.getInt("h_d_id"),
      ...
      while (rs.next()) {
        exec.x4.unsafeInsert(0,GenericEntry("SteNewSEntry",
          rs.getInt("i_id"),
          rs.getInt("i_im_id"),
          rs.getString("i_name"),
      ...
      while (rs.next()) {
        exec.x1.unsafeInsert(0,GenericEntry("SteNewSEntry",
          rs.getInt("no_o_id"),
          rs.getInt("no_d_id"),
          rs.getInt("no_w_id")
        ))
      ...
      while (rs.next()) {
        exec.x7.unsafeInsert(0,GenericEntry("SteNewSEntry",
          rs.getInt("ol_o_id"),
          rs.getInt("ol_d_id"),
          rs.getInt("ol_w_id"),
          rs.getInt("ol_number"),
      ...
      while (rs.next()) {
        ...
        exec.x5.unsafeInsert(0,GenericEntry("SteNewSEntry",
          rs.getInt("o_id"),
          rs.getInt("o_d_id"),
          rs.getInt("o_w_id"),
          rs.getInt("o_c_id"),
      ...
      while (rs.next()) {
        exec.x9.unsafeInsert(0,GenericEntry("SteNewSEntry",
          rs.getInt("s_i_id"),
          rs.getInt("s_w_id"),
