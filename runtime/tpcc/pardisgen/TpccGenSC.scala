...
class SCExecutor 
{
  ...
  val newOrderTbl = new Store[SEntry3_III](3, x2210);
  val x2212 = newOrderTbl.index(0, IHash, true, -1)
  val x2213 = newOrderTbl.index(1, ISliceHeapMin, false, 2)
  val x2214 = newOrderTbl.index(2, INone, false, -1)
  val x2411 = Array[EntryIdx[SEntry8_IIIIITDS]](SEntry8_IIIIITDS_Idx)
  val historyTbl = new Store[SEntry8_IIIIITDS](1, x2411);
  val x2413 = historyTbl.index(0, IList, false, -1)
  val x2453 = Array[EntryIdx[SEntry9_ISSSSSSDD]](SEntry9_ISSSSSSDD_Idx1)
  val warehouseTbl = new Store[SEntry9_ISSSSSSDD](1, x2453);
  val x2455 = warehouseTbl.index(0, IHash, true, -1)
  val x2494 = Array[EntryIdx[SEntry5_IISDS]](SEntry5_IISDS_Idx1)
  val itemTbl = new Store[SEntry5_IISDS](1, x2494);
  val x2496 = itemTbl.index(0, IHash, true, -1)
  ...
  val orderTbl = new Store[SEntry8_IIIITIIB](3, x2720);
  val x2722 = orderTbl.index(0, IHash, true, -1)
  val x2723 = orderTbl.index(1, ISliceHeapMax, false, 2)
  val x2724 = orderTbl.index(2, INone, false, -1)
  val x2783 = Array[EntryIdx[SEntry11_IISSSSSSDDI]](SEntry11_IISSSSSSDDI_Idx12)
  val districtTbl = new Store[SEntry11_IISSSSSSDDI](1, x2783);
  val x2785 = districtTbl.index(0, IHash, true, -1)
  val x2957 = Array[EntryIdx[SEntry10_IIIIIITIDS]](SEntry10_IIIIIITIDS_Idx1234, SEntry10_IIIIIITIDS_Idx123)
  val orderLineTbl = new Store[SEntry10_IIIIIITIDS](2, x2957);
  val x2959 = orderLineTbl.index(0, IHash, true, -1)
  val x2960 = orderLineTbl.index(1, IHash, false, -1)
  ...
  val customerTbl = new Store[SEntry21_IIISSSSSSSSSTSDDDDIIS](2, x3113);
  val x3115 = customerTbl.index(0, IHash, true, -1)
  val x3116 = customerTbl.index(1, IHash, false, -1)
  val x3174 = Array[EntryIdx[SEntry17_IIISSSSSSSSSSIIIS]](SEntry17_IIISSSSSSSSSSIIIS_Idx12)
  val stockTbl = new Store[SEntry17_IIISSSSSSSSSSIIIS](1, x3174);
  val x3176 = stockTbl.index(0, IHash, true, -1)
  ...
  class DeliveryTx(newOrderTbl : Store[SEntry3_III], historyTbl : Store[SEntry8_IIIIITDS], warehouseTbl : Store[SEntry9_ISSSSSSDD], itemTbl : Store[SEntry5_IISDS], orderTbl : Store[SEntry8_IIIITIIB], districtTbl : Store[SEntry11_IISSSSSSDDI], orderLineTbl : Store[SEntry10_IIIIIITIDS], customerTbl : Store[SEntry21_IIISSSSSSSSSTSDDDDIIS], stockTbl : Store[SEntry17_IIISSSSSSSSSSIIIS]) extends ((Boolean, Date, Int, Int) => Int ) {
    def apply(x10 : Boolean, x11 : Date, x12 : Int, x13 : Int) =     {
      ...
      {
        val x27 = x18;
        val x6650 = SEntry3_III(-2147483648, x27, x12);
        val x6653 = newOrderTbl.getCopy(1, x6650)
        val x33 = x6653.!=(null);
        if(x33) 
        {
          val x6656 = x6653._1;
          val x36 = x18;
          val x37 = x36.-(1);
          orderIDs.update(x37, x6656)
          newOrderTbl.deleteCopy(x6653)
          val x41 = x18;
          val x6663 = SEntry8_IIIITIIB(x6656, x41, x12, -2147483648, null, -2147483648, -2147483648, false);
          val x6665 = orderTbl.getCopy(0, x6663)
          val x6666 = x6665._4;
          x6665._6_=(x13)
          orderTbl.updateCopy(x6665)
          var x51: Double = 0.0;
          val x63 = { orderLineEntry: SEntry10_IIIIIITIDS => {
          ...
          val x53 = x18;
          val x6673 = SEntry10_IIIIIITIDS(x6656, x53, x12, -2147483648, -2147483648, -2147483648, null, -2147483648, -1.7976931348623157E308, null);
          orderLineTbl.sliceCopy(1, x6673, x63)
          val x66 = x18;
          val x6677 = SEntry21_IIISSSSSSSSSTSDDDDIIS(x6666, x66, x12, null, null, null, null, null, null, null, null, null, null, null, -1.7976931348623157E308, -1.7976931348623157E308, -1.7976931348623157E308, -1.7976931348623157E308, -2147483648, -2147483648, null);
          val x6678 = customerTbl.getCopy(0, x6677)
          val x70 = x51;
          val x6680 = x6678._17;
          val x6681 = x6680.+(x70);
          x6678._17_=(x6681)
  ...
  class StockLevelTx(newOrderTbl : Store[SEntry3_III], historyTbl : Store[SEntry8_IIIIITDS], warehouseTbl : Store[SEntry9_ISSSSSSDD], itemTbl : Store[SEntry5_IISDS], orderTbl : Store[SEntry8_IIIITIIB], districtTbl : Store[SEntry11_IISSSSSSDDI], orderLineTbl : Store[SEntry10_IIIIIITIDS], customerTbl : Store[SEntry21_IIISSSSSSSSSTSDDDDIIS], stockTbl : Store[SEntry17_IIISSSSSSSSSSIIIS]) extends ((Boolean, Date, Int, Int, Int, Int) => Int ) {
    def apply(x82 : Boolean, x83 : Date, x84 : Int, x85 : Int, x86 : Int, x87 : Int) =     {
      val x6816 = SEntry11_IISSSSSSDDI(x86, x85, null, null, null, null, null, null, -1.7976931348623157E308, -1.7976931348623157E308, -2147483648);
      val x6818 = districtTbl.getCopy(0, x6816)
      val x6819 = x6818._11;
      val x96 = x6819.-(20);
      var x97: Int = x96;
      ...
      {
        val x118 = { orderLineEntry: SEntry10_IIIIIITIDS => {
            val x6848 = orderLineEntry._5;
            val x6850 = SEntry17_IIISSSSSSSSSSIIIS(x6848, x85, -2147483648, null, null, null, null, null, null, null, null, null, null, -2147483648, -2147483648, -2147483648, null);
            val x6851 = stockTbl.getCopy(0, x6850)
            val x6852 = x6851._3;
            val x115 = x6852.<(x87);
            if(x115) 
            {
        ...
        val x103 = x97;
        val x6829 = SEntry10_IIIIIITIDS(x103, x86, x85, -2147483648, -2147483648, -2147483648, null, -2147483648, -1.7976931348623157E308, null);
        orderLineTbl.sliceCopy(1, x6829, x118)
        val x120 = x97;
        val x121 = x120.+(1);
        x97 = x121
        ()
  ...
  class OrderStatusTx(newOrderTbl : Store[SEntry3_III], historyTbl : Store[SEntry8_IIIIITDS], warehouseTbl : Store[SEntry9_ISSSSSSDD], itemTbl : Store[SEntry5_IISDS], orderTbl : Store[SEntry8_IIIITIIB], districtTbl : Store[SEntry11_IISSSSSSDDI], orderLineTbl : Store[SEntry10_IIIIIITIDS], customerTbl : Store[SEntry21_IIISSSSSSSSSTSDDDDIIS], stockTbl : Store[SEntry17_IIISSSSSSSSSSIIIS]) extends ((Boolean, Date, Int, Int, Int, Int, Int, String) => Int ) {
    def apply(x126 : Boolean, x127 : Date, x128 : Int, x129 : Int, x130 : Int, x131 : Int, x132 : Int, x133 : String) =     {
      ...
      val x6894 = if(x135) 
      {
        ...
        val x142 = { custEntry: SEntry21_IIISSSSSSSSSTSDDDDIIS => {
            x6908.append(custEntry)
            ()
          }
        };
        val x6911 = SEntry21_IIISSSSSSSSSTSDDDDIIS(-2147483648, x130, x129, null, null, x133, null, null, null, null, null, null, null, null, -1.7976931348623157E308, -1.7976931348623157E308, -1.7976931348623157E308, -1.7976931348623157E308, -2147483648, -2147483648, null);
        customerTbl.sliceCopy(1, x6911, x142)
        val x145 = x6908.size;
        val x146 = x145./(2);
        var x147: Int = x146;
        val x162 = { (c1: SEntry21_IIISSSSSSSSSTSDDDDIIS, c2: SEntry21_IIISSSSSSSSSTSDDDDIIS) => {
            val x6959 = c1._4;
            val x6960 = c2._4;
            val x160 = StringExtra.StringCompare(x6959, x6960);
            val x161 = x160.<(0);
            x161
          }
        };
      ...
      {
        val x6928 = SEntry21_IIISSSSSSSSSTSDDDDIIS(x132, x130, x129, null, null, null, null, null, null, null, null, null, null, null, -1.7976931348623157E308, -1.7976931348623157E308, -1.7976931348623157E308, -1.7976931348623157E308, -2147483648, -2147483648, null);
        val x6930 = customerTbl.getCopy(0, x6928)
        x6930
      }
      ;
      val x6895 = x6894._3;
      val x6899 = SEntry8_IIIITIIB(-2147483648, x130, x129, x6895, null, -2147483648, -2147483648, false);
      val x6902 = orderTbl.getCopy(1, x6899)
      var x184: Int = 0;
      val x6904 = x6902._1;
      x184 = x6904
      1
  ...
  class PaymentTx(newOrderTbl : Store[SEntry3_III], historyTbl : Store[SEntry8_IIIIITDS], warehouseTbl : Store[SEntry9_ISSSSSSDD], itemTbl : Store[SEntry5_IISDS], orderTbl : Store[SEntry8_IIIITIIB], districtTbl : Store[SEntry11_IISSSSSSDDI], orderLineTbl : Store[SEntry10_IIIIIITIDS], customerTbl : Store[SEntry21_IIISSSSSSSSSTSDDDDIIS], stockTbl : Store[SEntry17_IIISSSSSSSSSSIIIS]) extends ((Boolean, Date, Int, Int, Int, Int, Int, Int, Int, String, Double) => Int ) {
    def apply(x188 : Boolean, x189 : Date, x190 : Int, x191 : Int, x192 : Int, x193 : Int, x194 : Int, x195 : Int, x196 : Int, x197 : String, x198 : Double) =     {
      val x7037 = SEntry9_ISSSSSSDD(x191, null, null, null, null, null, null, -1.7976931348623157E308, -1.7976931348623157E308);
      val x7039 = warehouseTbl.getCopy(0, x7037)
      val x7040 = x7039._9;
      val x7041 = x7040.+(x198);
      x7039._9_=(x7041)
      warehouseTbl.updateCopy(x7039)
      val x7045 = SEntry11_IISSSSSSDDI(x192, x191, null, null, null, null, null, null, -1.7976931348623157E308, -1.7976931348623157E308, -2147483648);
      val x7046 = districtTbl.getCopy(0, x7045)
      val x7047 = x7046._10;
      val x7048 = x7047.+(x198);
      x7046._10_=(x7048)
      ...
      val x7052 = if(x213) 
      {
        ...
        val x220 = { custEntry: SEntry21_IIISSSSSSSSSTSDDDDIIS => {
            x7093.append(custEntry)
            ()
          }
        };
        val x7096 = SEntry21_IIISSSSSSSSSTSDDDDIIS(-2147483648, x195, x194, null, null, x197, null, null, null, null, null, null, null, null, -1.7976931348623157E308, -1.7976931348623157E308, -1.7976931348623157E308, -1.7976931348623157E308, -2147483648, -2147483648, null);
        customerTbl.sliceCopy(1, x7096, x220)
        val x223 = x7093.size;
        val x224 = x223./(2);
        var x225: Int = x224;
        val x240 = { (c1: SEntry21_IIISSSSSSSSSTSDDDDIIS, c2: SEntry21_IIISSSSSSSSSTSDDDDIIS) => {
            val x7168 = c1._4;
            val x7169 = c2._4;
            val x238 = StringExtra.StringCompare(x7168, x7169);
            val x239 = x238.<(0);
            x239
          }
        };
      ...
      {
        val x7113 = SEntry21_IIISSSSSSSSSTSDDDDIIS(x196, x195, x194, null, null, null, null, null, null, null, null, null, null, null, -1.7976931348623157E308, -1.7976931348623157E308, -1.7976931348623157E308, -1.7976931348623157E308, -2147483648, -2147483648, null);
        val x7114 = customerTbl.getCopy(0, x7113)
        x7114
      }
      ;
      val x7053 = x7052._21;
      ...
      val x7072 = x7052._1;
      val x7074 = SEntry8_IIIIITDS(x7072, x195, x194, x192, x191, x189, x198, h_data);
      historyTbl.insert(x7074)
      1
    }
  }
  class NewOrderTx(newOrderTbl : Store[SEntry3_III], historyTbl : Store[SEntry8_IIIIITDS], warehouseTbl : Store[SEntry9_ISSSSSSDD], itemTbl : Store[SEntry5_IISDS], orderTbl : Store[SEntry8_IIIITIIB], districtTbl : Store[SEntry11_IISSSSSSDDI], orderLineTbl : Store[SEntry10_IIIIIITIDS], customerTbl : Store[SEntry21_IIISSSSSSSSSTSDDDDIIS], stockTbl : Store[SEntry17_IIISSSSSSSSSSIIIS]) extends ((Boolean, Date, Int, Int, Int, Int, Int, Int, Array[Int], Array[Int], Array[Int], Array[Double], Array[String], Array[Int], Array[String], Array[Double]) => Int ) {
    def apply(x272 : Boolean, x273 : Date, x274 : Int, x275 : Int, x276 : Int, x277 : Int, x278 : Int, x279 : Int, x280 : Array[Int], x281 : Array[Int], x282 : Array[Int], x283 : Array[Double], x284 : Array[String], x285 : Array[Int], x286 : Array[String], x287 : Array[Double]) =     {
      ...
      })
      {
        ...
        val x7290 = SEntry5_IISDS(x305, -2147483648, null, -1.7976931348623157E308, null);
        val x7292 = itemTbl.getCopy(0, x7290)
        val x310 = x7292.==(null);
        if(x310) 
        {
          x297 = false
      ...
      if(x326) 
      {
        val x7311 = SEntry21_IIISSSSSSSSSTSDDDDIIS(x277, x276, x275, null, null, null, null, null, null, null, null, null, null, null, -1.7976931348623157E308, -1.7976931348623157E308, -1.7976931348623157E308, -1.7976931348623157E308, -2147483648, -2147483648, null);
        val x7313 = customerTbl.getCopy(0, x7311)
        val x7315 = SEntry9_ISSSSSSDD(x275, null, null, null, null, null, null, -1.7976931348623157E308, -1.7976931348623157E308);
        val x7316 = warehouseTbl.getCopy(0, x7315)
        val x7318 = SEntry11_IISSSSSSDDI(x276, x275, null, null, null, null, null, null, -1.7976931348623157E308, -1.7976931348623157E308, -2147483648);
        val x7319 = districtTbl.getCopy(0, x7318)
        val x7320 = x7319._11;
        val x7321 = x7319._11;
        val x7322 = x7321.+(1);
        x7319._11_=(x7322)
        ...
        val x344 = x279.>(0);
        val x7327 = SEntry8_IIIITIIB(x7320, x276, x275, x277, x273, -1, x278, x344);
        orderTbl.insert(x7327)
        val x7330 = SEntry3_III(x7320, x276, x275);
        newOrderTbl.insert(x7330)
        var x352: Double = 0.0;
        x289 = 0
        while({
          val x355 = x289;
        ...
        })
        {
          ...
          val x7344 = SEntry17_IIISSSSSSSSSSIIIS(ol_i_id, ol_supply_w_id, -2147483648, null, null, null, null, null, null, null, null, null, null, -2147483648, -2147483648, -2147483648, null);
          val x7345 = stockTbl.getCopy(0, x7344)
          val x371 = x276.==(1);
          val ol_dist_info = if(x371) 
          {
            val x7348 = x7345._4;
            x7348
          }
          ...
          val x413 = x7374.-(ol_quantity);
          x7345._3_=(x413)
          val x415 = x7374.<=(ol_quantity);
          if(x415) 
          {
            val x7391 = x7345._3;
            val x7392 = x7391.+(91);
          ...
          val x434 = ol_quantity.toDouble;
          val x435 = x434.*(x433);
          val x436 = 1.0.+(x7400);
          val x437 = x436.+(x7401);
          val x438 = x435.*(x437);
          val x439 = 1.0.-(x7399);
          val ol_amount = x438.*(x439);
          val x441 = x289;
          x287.update(x441, ol_amount)
          val x443 = x352;
          val x444 = x443.+(ol_amount);
          x352 = x444
          val x446 = x289;
          val x447 = x446.+(1);
          val x7419 = SEntry10_IIIIIITIDS(x7320, x276, x275, x447, ol_i_id, ol_supply_w_id, null, ol_quantity, ol_amount, ol_dist_info);
          orderLineTbl.insert(x7419)
          val x451 = x289;
          val x452 = x451.+(1);
          x289 = x452
          ()
