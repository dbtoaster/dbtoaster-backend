...
class TpccTable {
	...
	val historyTbl:SHMap[(Int,Int,Int,Int,Int,Date,Double,String),Boolean] = if(testSpecialDsUsed) {
		new SHMapPooled[(Int,Int,Int,Int,Int,Date,Double,String),Boolean](0.9f, 4194304)
	} else {
		new SHMap[(Int,Int,Int,Int,Int,Date,Double,String),Boolean]/*(0.9f, 4194304)*/
	}

	val warehouseTbl = if(testSpecialDsUsed) {
		null.asInstanceOf[SHMap[Int,(String,String,String,String,String,String,Double,Double)]]
	} else {
		new SHMap[Int,(String,String,String,String,String,String,Double,Double)]
	}

	val warehouseArr = if(testSpecialDsUsed) {
		new Array[(String,String,String,String,String,String,Double,Double)](NUM_WAREHOUSES + 1)
	} else {
		null.asInstanceOf[Array[(String,String,String,String,String,String,Double,Double)]]
	}

	val itemPartialTbl = if(testSpecialDsUsed) {
		null.asInstanceOf[SHMap[Int,(/*Int,*/String,Double,String)]]
	} else {
		new SHMap[Int,(/*Int,*/String,Double,String)]/*(1f, 262144)*/
	}

	val itemPartialArr = if(testSpecialDsUsed) {
		new Array[(/*Int,*/String,Double,String)](100000 + 1)
	} else {
		null.asInstanceOf[Array[(/*Int,*/String,Double,String)]]
	}
	...
	val districtTbl = if(testSpecialDsUsed) {
		null.asInstanceOf[SHMap[(Int,Int),(String,String,String,String,String,String,Double,Double,Int)]]
	} else {
		new SHMap[(Int,Int),(String,String,String,String,String,String,Double,Double,Int)]/*(1f, 32)*/
	}

	val districtArr = if(testSpecialDsUsed) {
		new Array[(String,String,String,String,String,String,Double,Double,Int)]((NUM_WAREHOUSES + 1) * (DISTRICTS_UNDER_A_WAREHOUSE + 1))
	} else {
		null.asInstanceOf[Array[(String,String,String,String,String,String,Double,Double,Int)]]
	}

	val orderLineTbl:SHMap[(Int,Int,Int,Int),(Int,Int,Option[Date],Int,Double,String)] = if(testSpecialDsUsed) {
		new SHMapPooled[(Int,Int,Int,Int),(Int,Int,Option[Date],Int,Double,String)](0.9f, 33554432, List((0.9f, 4194304)), (k:(Int,Int,Int,Int), v:(Int,Int,Option[Date],Int,Double,String)) => ((k._1, k._2, k._3)) )
	} else {
		new SHMap[(Int,Int,Int,Int),(Int,Int,Option[Date],Int,Double,String)](/*0.9f, 33554432, List((0.9f, 4194304)),*/ (k:(Int,Int,Int,Int), v:(Int,Int,Option[Date],Int,Double,String)) => ((k._1, k._2, k._3)) )
	}

	val customerTbl:SHMap[(Int,Int,Int),(String,String,String,String,String,String,String,String,String,Date,String,Double,Double,Double,Double,Int,Int,String)] = if(testSpecialDsUsed) {
		new SHMapPooled[(Int,Int,Int),(String,String,String,String,String,String,String,String,String,Date,String,Double,Double,Double,Double,Int,Int,String)] (/*1f, 65536, List((1f, 16384)),*/ (k:(Int,Int,Int), v:(String,String,String,String,String,String,String,String,String,Date,String,Double,Double,Double,Double,Int,Int,String)) => ((k._2, k._3, v._3)) )
	} else {
		new SHMap[(Int,Int,Int),(String,String,String,String,String,String,String,String,String,Date,String,Double,Double,Double,Double,Int,Int,String)] (/*1f, 65536, List((1f, 16384)),*/ (k:(Int,Int,Int), v:(String,String,String,String,String,String,String,String,String,Date,String,Double,Double,Double,Double,Int,Int,String)) => ((k._2, k._3, v._3)) )
	}
	...
	val customerWarehouseFinancialInfoMap:SHMap[(Int,Int,Int),(Double,String,String,Double)] = if(testSpecialDsUsed) {
		new SHMapPooled[(Int,Int,Int),(Double,String,String,Double)](1f, 65536)
	} else {
		new SHMap[(Int,Int,Int),(Double,String,String,Double)]/*(1f, 65536)*/
	}
	...
	def onUpdate_Warehouse_byFunc(w_id:Int, updateFunc:((String, String, String, String, String, String, Double, Double)) => (String, String, String, String, String, String, Double, Double)) = {
		if(testSpecialDsUsed) {
	...
	def onUpdate_District_byFunc(d_id:Int, d_w_id:Int, updateFunc:((String, String, String, String, String, String, Double, Double, Int)) => (String, String, String, String, String, String, Double, Double, Int)) = {
		if(testSpecialDsUsed) {
    ...
    def onUpdateCustomer_byFunc(c_id: Int, c_d_id: Int, c_w_id: Int, updateFunc:((String, String, String, String, String, String, String, String, String, Date, String, Double, Double, Double, Double, Int, Int, String)) => (String, String, String, String, String, String, String, String, String, Date, String, Double, Double, Double, Double, Int, Int, String)) = {
