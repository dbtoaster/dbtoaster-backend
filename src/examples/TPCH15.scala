...
class TPCH15 extends Actor {
  ...
  def onAddLINEITEM(LINEITEM_ORDERKEY:Long, LINEITEM_PARTKEY:Long, LINEITEM_SUPPKEY:Long, LINEITEM_LINENUMBER:Long, LINEITEM_QUANTITY:Double, LINEITEM_EXTENDEDPRICE:Double, LINEITEM_DISCOUNT:Double, LINEITEM_TAX:Double, LINEITEM_RETURNFLAG:String, LINEITEM_LINESTATUS:String, LINEITEM_SHIPDATE:Date, LINEITEM_COMMITDATE:Date, LINEITEM_RECEIPTDATE:Date, LINEITEM_SHIPINSTRUCT:String, LINEITEM_SHIPMODE:String, LINEITEM_COMMENT:String) {
    COUNT_mLINEITEM1.foreach { case (k1,v1) =>
      ...
      ; {
        ...
        var ex2:Long = 0L
        ex2 |= ((((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE))) + ((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY))))!=0;
        var ex3:Long = 0L
        ex3 |= ((((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE))) + ((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY))))!=0;
        var ex4:Long = 0L
        ...
        var ex7:Long = 0L
        ex7 |= ((((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE))) + ((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY))))!=0;
        var ex8:Long = 0L
        ...
        var ex10:Long = 0L
        ; {
          val R2_SUPPKEY = LINEITEM_SUPPKEY;
          ex10 |= (((R2_SUPPKEY * ((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE)))) + ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY))))!=0;
          val R2_TOTAL_REVENUE = ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY));
        ...
        ; {
          val R2_SUPPKEY = LINEITEM_SUPPKEY;
          ex12 |= (((R2_SUPPKEY * ((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE)))) + ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY))))!=0;
          val R2_TOTAL_REVENUE = ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY));
        ...
        ; {
          val R2_SUPPKEY = LINEITEM_SUPPKEY;
          ex13 |= (((R2_SUPPKEY * ((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE)))) + ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY))))!=0;
          val R2_TOTAL_REVENUE = (((R2_SUPPKEY == (LINEITEM_SUPPKEY)) * ((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE)))) + ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY)));
        ...
        var ex14:Long = 0L
        ex14 |= ((((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE))) + ((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY))))!=0;
        var ex15:Long = 0L
        ...
        var ex19:Long = 0L
        ex19 |= ((((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE))) + ((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY))))!=0;
        ...
        ; {
          val R2_SUPPKEY = LINEITEM_SUPPKEY;
          ex21 |= (((R2_SUPPKEY * ((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE)))) + ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY))))!=0;
          val R2_TOTAL_REVENUE = ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY));
        ...
        ; {
          val R2_SUPPKEY = LINEITEM_SUPPKEY;
          ex23 |= (((R2_SUPPKEY * ((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE)))) + ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY))))!=0;
          val R2_TOTAL_REVENUE = ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY));
        ...
        ; {
          val R2_SUPPKEY = LINEITEM_SUPPKEY;
          ex24 |= (((R2_SUPPKEY * ((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE)))) + ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY))))!=0;
          val R2_TOTAL_REVENUE = (((R2_SUPPKEY == (LINEITEM_SUPPKEY)) * ((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE)))) + ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY)));
        ...
        ; {
          val R2_SUPPKEY = LINEITEM_SUPPKEY;
          ex29 |= (((R2_SUPPKEY * ((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE)))) + ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY))))!=0;
          val R2_TOTAL_REVENUE = ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY));
        ...
        ; {
          val R2_SUPPKEY = LINEITEM_SUPPKEY;
          ex31 |= (((R2_SUPPKEY * ((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE)))) + ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY))))!=0;
          val R2_TOTAL_REVENUE = ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY));
        ...
        ; {
          val R2_SUPPKEY = LINEITEM_SUPPKEY;
          ex32 |= (((R2_SUPPKEY * ((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE)))) + ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY))))!=0;
          val R2_TOTAL_REVENUE = (((R2_SUPPKEY == (LINEITEM_SUPPKEY)) * ((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE)))) + ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY)));
        ...
        COUNT.add((S_SUPPKEY,S_NAME,S_ADDRESS,S_PHONE,R1_TOTAL_REVENUE),(v1 * (((S_SUPPKEY == (LINEITEM_SUPPKEY)) * ((((R1_TOTAL_REVENUE * ((ex1 * 2L) + ex2)) + (((S_SUPPKEY == (LINEITEM_SUPPKEY)) * ((ex3 * ((R1_TOTAL_REVENUE == ((((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE))) + ((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY))))) + (R1_TOTAL_REVENUE == (((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY)))))) + (ex4 * ((R1_TOTAL_REVENUE == (((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY)))) + (R1_TOTAL_REVENUE == ((((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE))) + ((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY))))))))) + ((R1_TOTAL_REVENUE == ((((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE))) + ((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY))))) * ex5))) * agg1) + (((ex7 * ((R1_TOTAL_REVENUE == (((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY)))) + ((S_SUPPKEY == (LINEITEM_SUPPKEY)) * (R1_TOTAL_REVENUE == ((((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE))) + ((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY)))))))) + (ex8 * ((R1_TOTAL_REVENUE == ((((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE))) + ((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY))))) + ((S_SUPPKEY == (LINEITEM_SUPPKEY)) * (R1_TOTAL_REVENUE == (((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY)))))))) * agg3))) + (((((S_SUPPKEY == (LINEITEM_SUPPKEY)) * ((((ex14 * ((R1_TOTAL_REVENUE == (((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY)))) + ((S_SUPPKEY == (LINEITEM_SUPPKEY)) * ((R1_TOTAL_REVENUE == (((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY)))) + (R1_TOTAL_REVENUE == ((((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE))) + ((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY))))))))) + (ex15 * (((R1_TOTAL_REVENUE == (((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY)))) * 2L) + (((S_SUPPKEY == (LINEITEM_SUPPKEY)) * ((R1_TOTAL_REVENUE == ((((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE))) + ((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY))))) + (R1_TOTAL_REVENUE == (((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY)))))) + (R1_TOTAL_REVENUE == ((((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE))) + ((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY))))))))) * agg9) + ((((R1_TOTAL_REVENUE == (((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY)))) * (ex17 * 2L)) + ((S_SUPPKEY == (LINEITEM_SUPPKEY)) * (((R1_TOTAL_REVENUE == ((((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (((-1L * LINEITEM_DISCOUNT) + 1L) * LINEITEM_EXTENDEDPRICE))) + ((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY))))) * ex18) + ((R1_TOTAL_REVENUE == (((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY)))) * ex19)))) * agg11))) + ((R1_TOTAL_REVENUE == (((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY)))) * (ex25 * agg17))) * -1L) + ((R1_TOTAL_REVENUE == (((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY)))) * (ex27 * agg19)))).toLong));
      }
    }
    COUNT_mLINEITEM1_L2_1.add(LINEITEM_SUPPKEY,((LINEITEM_SHIPDATE >= c2) * ((c1 > LINEITEM_SHIPDATE) * (LINEITEM_DISCOUNT * LINEITEM_EXTENDEDPRICE))));
    COUNT_mLINEITEM1_L2_3.add(LINEITEM_SUPPKEY,((LINEITEM_SHIPDATE >= c2) * ((c1 > LINEITEM_SHIPDATE) * LINEITEM_EXTENDEDPRICE)));
    COUNT_mLINEITEM1_L3_1_E1_1.add(LINEITEM_SUPPKEY,((LINEITEM_SHIPDATE >= c2) * ((c1 > LINEITEM_SHIPDATE) * (LINEITEM_DISCOUNT * LINEITEM_EXTENDEDPRICE))));
    COUNT_mLINEITEM1_L3_1_E1_3.add(LINEITEM_SUPPKEY,((LINEITEM_SHIPDATE >= c2) * ((c1 > LINEITEM_SHIPDATE) * LINEITEM_EXTENDEDPRICE)));
  }
  ...
  def onDelLINEITEM(LINEITEM_ORDERKEY:Long, LINEITEM_PARTKEY:Long, LINEITEM_SUPPKEY:Long, LINEITEM_LINENUMBER:Long, LINEITEM_QUANTITY:Double, LINEITEM_EXTENDEDPRICE:Double, LINEITEM_DISCOUNT:Double, LINEITEM_TAX:Double, LINEITEM_RETURNFLAG:String, LINEITEM_LINESTATUS:String, LINEITEM_SHIPDATE:Date, LINEITEM_COMMITDATE:Date, LINEITEM_RECEIPTDATE:Date, LINEITEM_SHIPINSTRUCT:String, LINEITEM_SHIPMODE:String, LINEITEM_COMMENT:String) {
    COUNT_mLINEITEM1.foreach { case (k11,v11) =>
      ...
      var ex33:Long = 0L
      ex33 |= ((((S_SUPPKEY == (LINEITEM_SUPPKEY)) * ((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (LINEITEM_EXTENDEDPRICE * (-1L + LINEITEM_DISCOUNT))))) + ((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY))))!=0;
      ; {
        val R1_TOTAL_REVENUE = (((S_SUPPKEY == (LINEITEM_SUPPKEY)) * ((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (LINEITEM_EXTENDEDPRICE * (-1L + LINEITEM_DISCOUNT))))) + ((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY)));
        ...
        ; {
          ...
          ; {
            val R2_SUPPKEY = LINEITEM_SUPPKEY;
            ex36 |= (((R2_SUPPKEY * ((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (LINEITEM_EXTENDEDPRICE * (-1L + LINEITEM_DISCOUNT))))) + ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY))))!=0;
            val R2_TOTAL_REVENUE = ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY));
          ...
          ; {
            val R2_SUPPKEY = LINEITEM_SUPPKEY;
            ex38 |= (((R2_SUPPKEY * ((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (LINEITEM_EXTENDEDPRICE * (-1L + LINEITEM_DISCOUNT))))) + ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY))))!=0;
            val R2_TOTAL_REVENUE = ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY));
          ...
          ; {
            val R2_SUPPKEY = LINEITEM_SUPPKEY;
            ex39 |= (((R2_SUPPKEY * ((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (LINEITEM_EXTENDEDPRICE * (-1L + LINEITEM_DISCOUNT))))) + ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY))))!=0;
            val R2_TOTAL_REVENUE = (((R2_SUPPKEY == (LINEITEM_SUPPKEY)) * ((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (LINEITEM_EXTENDEDPRICE * (-1L + LINEITEM_DISCOUNT))))) + ((COUNT_mLINEITEM1_L3_1_E1_1.get(R2_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY)));
        ...
        var ex41:Long = 0L
        ex41 |= ((((S_SUPPKEY == (LINEITEM_SUPPKEY)) * ((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (LINEITEM_EXTENDEDPRICE * (-1L + LINEITEM_DISCOUNT))))) + ((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY))))!=0;
        var ex42:Long = 0L
        ...
        COUNT.add((S_SUPPKEY,S_NAME,S_ADDRESS,S_PHONE,R1_TOTAL_REVENUE),(v11 * ((ex33 * ((R1_TOTAL_REVENUE * (agg25 + agg27)) + ((R1_TOTAL_REVENUE == (((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY)))) * agg33))) + (((ex41 * ((R1_TOTAL_REVENUE == (((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY)))) + (R1_TOTAL_REVENUE == ((((S_SUPPKEY == (LINEITEM_SUPPKEY)) * ((c1 > LINEITEM_SHIPDATE) * ((LINEITEM_SHIPDATE >= c2) * (LINEITEM_EXTENDEDPRICE * (-1L + LINEITEM_DISCOUNT))))) + ((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY))))))) + ((R1_TOTAL_REVENUE == (((COUNT_mLINEITEM1_L2_1.get(S_SUPPKEY) * -1L) + COUNT_mLINEITEM1_L2_3.get(S_SUPPKEY)))) * ex42)) * (agg35 * -1L))).toLong));
      }
    }
    COUNT_mLINEITEM1_L2_1.add(LINEITEM_SUPPKEY,((LINEITEM_SHIPDATE >= c2) * ((c1 > LINEITEM_SHIPDATE) * (-1L * (LINEITEM_DISCOUNT * LINEITEM_EXTENDEDPRICE)))));
    COUNT_mLINEITEM1_L2_3.add(LINEITEM_SUPPKEY,((LINEITEM_SHIPDATE >= c2) * ((c1 > LINEITEM_SHIPDATE) * (-1L * LINEITEM_EXTENDEDPRICE))));
    COUNT_mLINEITEM1_L3_1_E1_1.add(LINEITEM_SUPPKEY,((LINEITEM_SHIPDATE >= c2) * ((c1 > LINEITEM_SHIPDATE) * (-1L * (LINEITEM_DISCOUNT * LINEITEM_EXTENDEDPRICE)))));
    COUNT_mLINEITEM1_L3_1_E1_3.add(LINEITEM_SUPPKEY,((LINEITEM_SHIPDATE >= c2) * ((c1 > LINEITEM_SHIPDATE) * (-1L * LINEITEM_EXTENDEDPRICE))));
  }
...
((S_SUPPKEY ^= S_SUPPKEY) *
(R1_TOTAL_REVENUE ^=
  ((COUNT_mLINEITEM1_L2_1[][S_SUPPKEY] * -1) +
    COUNT_mLINEITEM1_L2_3[][S_SUPPKEY])) *
EXISTS(
  ((COUNT_mLINEITEM1_L2_1[][S_SUPPKEY] * -1) +
    COUNT_mLINEITEM1_L2_3[][S_SUPPKEY])) *
AggSum([], 
  ((__domain_1 ^=
     AggSum([], 
       (EXISTS(
          ((COUNT_mLINEITEM1_L3_1_E1_1[][R2_SUPPKEY] * -1) +
            COUNT_mLINEITEM1_L3_1_E1_3[][R2_SUPPKEY])) *
         (R2_TOTAL_REVENUE ^=
           ((COUNT_mLINEITEM1_L3_1_E1_1[][R2_SUPPKEY] * -1) +
             COUNT_mLINEITEM1_L3_1_E1_3[][R2_SUPPKEY])) *
...
*/  
    ...
    COUNT_mLINEITEM1_L3_1_E1_1.foreach { case (k17,v17) =>
      val R2_SUPPKEY = k17;
      val v3 = COUNT_mLINEITEM1_L3_1_E1_3.get(R2_SUPPKEY);
      if (v3!=0) {
        val R2_TOTAL_REVENUE = v3 - v17;
  
        if ( R2_TOTAL_REVENUE!=0 ) {
           agg37 += ((R2_TOTAL_REVENUE > R1_TOTAL_REVENUE) == 0L);
        }
      }
    }
    COUNT.add((S_SUPPKEY,S_NAME,S_ADDRESS,S_PHONE,R1_TOTAL_REVENUE),(agg37).toLong);
    COUNT_mLINEITEM1.add((S_NAME,S_ADDRESS,S_PHONE,S_SUPPKEY),1L);
