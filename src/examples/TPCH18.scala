...
class TPCH18QueryNew() extends DBTQuery {
  ...
  val QUERY18 = K3Map.make[(String,Long,Long,Date,Double), Double](0.0)
  val mORDERS2 = K3Map.make[(String,Long), Long](0L,List((x:(String,Long))=>x._2)) // 0=List(1)
  val mCUSTOMER1 = K3Map.make[(Long,Long,Date,Double), Double](0.0,List((x:(Long,Long,Date,Double))=>x._2)) // 0=List(1)
  val mCUSTOMER1_mLINEITEM1 = K3Map.make[(Long,Long,Date,Double), Long](0L,List(
    (x:(Long,Long,Date,Double))=>x._1, // 0=List(0)
    (x:(Long,Long,Date,Double))=>x._2  // 1=List(1)
  ))
  val mLINEITEM1 = K3Map.make[(Long,String,Long,Date,Double), Double](0.0)
  val mLINEITEM1_mLINEITEM1 = K3Map.make[(Long,String,Long,Date,Double), Long](0L,List((x:(Long,String,Long,Date,Double))=>x._1)) // 0=List(0)
  val mLINEITEM1_E1_1_L1_1 = K3Map.make[Long,Double](0.0)
  ...
  def onInsertLINEITEM(L_ORDERKEY: Long,L_PARTKEY: Long,L_SUPPKEY: Long,L_LINENUMBER: Long,L_QUANTITY: Double,L_EXTENDEDPRICE: Double,L_DISCOUNT: Double,L_TAX: Double,L_RETURNFLAG: String,L_LINESTATUS: String,L_SHIPDATE: Date,L_COMMITDATE: Date,L_RECEIPTDATE: Date,L_SHIPINSTRUCT: String,L_SHIPMODE: String,L_COMMENT: String) = {
    ...
    QUERY18.foreach { case (k,v) => QUERY18.set(k,0.0) /*remove(k)*/ };
