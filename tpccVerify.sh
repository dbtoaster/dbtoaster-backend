...
#CPP
sbt "DDBToaster/runMain sc.tpcc.TpccXactGenerator_SC  $opt -lang ccpp -ware 5"
rm -f tpcc.out
g++ -std=c++11 -O3 -DNUMWARE=5 -DNUMTHREADS=1 -DNUMPROG=1000  -DVERIFY_TPCC=1 -DPROJECT_ROOT=\"/home/sachin/TStore/\" runtime/tpcc/pardisgen/TpccGenSC.cpp -I ddbtoaster/srccpp/lib/ -I ddbtoaster/srccpp/lib/mmap/  -L ddbtoaster/srccpp/lib/  -ldbtoaster -o tpcc.out -pthread
./tpcc.out
