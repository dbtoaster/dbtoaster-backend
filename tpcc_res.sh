...
object HelloWorld extends App {
  val optsMap = List("" -> " ", "Entry" -> "E", "TmpVar" -> "V" , "TmpMap" -> "M", "CmpMult" -> "T", "FixedRange" -> "G" , "Online" -> "O", "Inline" -> "N" , "DeadIdx" -> "D", "Fusion full" -> "F", "CodeMotion" -> "C", "RegexHoister" -> "X", "RefCnt" -> "R" , "Index" -> "I", "SliceInline" -> "S", "Fusion"->"P", "MultiResSplitter" -> "U", "InitialStoreSize" -> "Z", , "SliceNoUpdate" -> "L").toMap
