...
do
    ...
    sbt "DBToaster/runMain  ddbt.UnitTest -x -p 2 -w 0 -s 1 -t 60000  -l cpp -d $dataset $opt -opt profilestore -q $queries"
    ...
    sbt "DBToaster/runMain  ddbt.UnitTest -x -p 2 -w 0 -s $numExec -t 60000  -csv r$cnt.csv -dump r$cnt.txt  -l cpp -d $dataset $opt -q $queries"
...
#sbt "DBToaster/runMain  ddbt.UnitTest -x -p 2 -w 0 -s $numExec -t 60000  -csv rcpp.csv -dump rcpp.txt  -l cpp -d $dataset $opt -q $queries"
#sbt "DBToaster/runMain  ddbt.UnitTest -x -p 2 -w 0 -s $numExec -t 60000  -csv rvcpp.csv -dump rvcpp.txt  -l vcpp -d $dataset $opt -q $queries"

sbt "DBToaster/runMain  ddbt.UnitTest -x -p 2 -w 0 -s $numExec -t 60000  -csv r0.csv -dump r0.txt  -l cpp -d $dataset $opt -opt initsize -q $queries"
sbt "DBToaster/runMain  ddbt.UnitTest -x -p 2 -w 0 -s $numExec -t 60000  -l cpp -d $dataset $opt -opt initsize -opt profilestore -q $queries"
mv ddbtoaster/target/tmp/*.hpp $exec/e0/hppProf/
mv ddbtoaster/profile*.csv $exec/e0/profile/

sbt "DBToaster/runMain  ddbt.UnitTest -x -p 2 -w 0 -s $numExec -t 60000  -csv r0i.csv -dump r0i.txt  -l cpp -d $dataset $opt -opt initsize -q $queries"
mv ddbtoaster/target/tmp/*.hpp $exec/e0/hpp/

#sbt "DBToaster/runMain  ddbt.UnitTest -x -xsc -xvm -p 2 -w 3 -s $numExec -t 60000  -csv r0iscala.csv -dump r0iscala.txt  -l scala -d $dataset $opt -opt initsize -q $queries"
#sbt "DBToaster/runMain  ddbt.UnitTest -x -xsc -xvm -p 2 -w 3 -s $numExec -t 60000  -csv r0iscala.csv -dump r0iscala.txt  -l scala -d $dataset $opt -opt initsize -q $queries"
