...
sbt "DDBToaster/runMain  ddbt.UnitTest -x -p 2 -w 0 -s 5 -t 60000  -csv r0.csv -dump r0.txt  -l vcpp  -d big_del $opt -q  .*tpch.*"
...
#if [ $cnt == 7 ] || [ $cnt == 9 ]
#then
sbt "DDBToaster/runMain  ddbt.UnitTest -x -p 2 -w 0 -s 5 -t 60000  -csv r$cnt.csv -dump r$cnt.txt  -l cpp -d big_del $opt -q  .*tpch.*"
